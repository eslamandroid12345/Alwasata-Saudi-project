...
class JobApplicationController extends Controller
{
    public function index()
    {
        ...
        $data['types']=JobApplicationType::get();

    //    $data['data']=JobApplication::orderBy('id', 'DESC')->get();
       return view('Admin.JobApplication.index',$data);
    }
    //----------------------------------------------------------------------------------------
    ...
    {     
       ...
       return DataTables::of($data)->addColumn('name', function ($data) {
                ...
                return view('Admin.JobApplication.datatable.extra',$info);
                ...
                return view('Admin.JobApplication.datatable.action', compact('data'));
            })
            ->rawColumns(['actions'])
            ->make(true);
    }
    ...
    public function show($id)
    {
     // return $id;
      ...
      return view('Admin.JobApplication.show',$data);
    }
    //----------------------------------------------------------------------------------------
