...
{{-- For Search style   --}}
<div class="topRow" >
    <form name="filter" id="filter" method="get"  @if ($manager_role == 7 || $manager_role == 4) action="{{ route('qualityTaskChartR') }}" @elseif ($manager_role == 1) action="{{ route('sales.manager.qualityTaskChartRForSalesManager') }}" @endif >
