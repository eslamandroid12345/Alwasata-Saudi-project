...
@section('customer')
    ...
    <div class="addUser my-4">
        <div class="userBlock d-flex align-items-center justify-content-between flex-wrap">
            <h3>{{ MyHelpers::admin_trans(auth()->user()->id,'Requests') }}:</h3>
        </div>
    </div>
    ...
    <div class="main-content">
        <div class="section_content section_content--p30">
            ...
            <div class="container-fluid">
                ...
                <br>
                @if($data_for_class_chart != null)
                    @include('Charts.requestChart-table-class')
                    @include('Charts.requestChart-chart-class')
                @endif


                <br>

                @if($data_for_basket_chart != null)

                    @include('Charts.requestChart-table-basket')
                    @include('Charts.requestChart-chart-basket')
