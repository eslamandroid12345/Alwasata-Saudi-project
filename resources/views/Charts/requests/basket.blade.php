    ...
    <div class="col-12">
        ...
        <div class="row">
           <span class="button-checkbox">
                <button type="button" class="btn btn-sm" data-color="primary">مكتملة</button>
                <input type="checkbox" value="2" class="hidden fields" checked name="fields"/>
            </span>
            <span class="button-checkbox">
                <button type="button" class="btn btn-sm" data-color="primary">مؤرشفة</button>
                <input type="checkbox" value="3" class="hidden fields" checked name="fields"/>
            </span>
            <span class="button-checkbox">
                <button type="button" class="btn btn-sm" data-color="primary">متابعة</button>
                <input type="checkbox" value="4" class="hidden fields" checked name="fields"/>
            </span>
            <span class="button-checkbox">
                <button type="button" class="btn btn-sm" data-color="primary">مميزة</button>
                <input type="checkbox" value="5" class="hidden fields" checked name="fields"/>
            </span>
            <span class="button-checkbox">
                <button type="button" class="btn btn-sm" data-color="primary">مستلمة</button>
   ...
   {{-- <button onclick="myFun(5)">ClickMe</button>--}}
    ...
    <div class="topRow">
        <div class="row align-items-center text-center text-md-left">
            <div class="col-lg-9">
                {{--   <a href="{{route("requests.report.basket")}}" class="btn btn-primary p-2">
                ...
                <button disabled href="{{route("charts.requests.basket")}}" class="btn btn-sm btn-outline-dark">
                    <i class="fa fa-shopping-basket"></i>
                    تقرير سلال الطلب
                </button>

                <a href="{{route("charts.requests.status")}}" class="btn btn-sm btn-dark">
...
<script>
    ...
    var dt = $('.data-table').DataTable({
        ...
        serverSide: true,
        ajax: ({
           'url': "{{ route('requests.report.basket')  }}",
           'method': 'GET',
           'data':function (data) {
