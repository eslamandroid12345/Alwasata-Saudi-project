...
<div class="tableBar">
    ...
    <div class="topRow">
        <div class="row align-items-center text-center text-md-left">
            <div class="col-lg-9">
                <a href="{{route("charts.requests.classification")}}" class="btn btn-dark btn-sm">
                    <i class="fa fa-clipboard"></i>
                    تقرير تصنيفات الطلب
                </a>
                <a href="{{route("charts.requests.basket")}}" class="btn btn-sm btn-dark">
                    <i class="fa fa-shopping-basket"></i>
                    تقرير سلال الطلب
                </a>

                <button disabled href="{{route("charts.requests.status")}}" class="btn btn-sm btn-outline-dark">
        ...
        <table id="pendingReqs-table" class="table table-bordred table-striped data-table">
            ...
            <tfoot>
                <tr id="tfoot">
                    <th>#</th>
                    <th>مجموع النتائج</th>
                    <th id="new_status"><i class="fa fa-spinner fa-spin"></i></th>
                    <th id="open_status"><i class="fa fa-spinner fa-spin"></i></th>
                    <th id="archive_status"><i class="fa fa-spinner fa-spin"></i></th>
                    <th id="waiting_sm_status"><i class="fa fa-spinner fa-spin"></i></th>
                    <th id="rejected_sm_status"><i class="fa fa-spinner fa-spin"></i></th>
                    <th id="waiting_fm_status"><i class="fa fa-spinner fa-spin"></i></th>
                    <th id="rejected_fm_status"><i class="fa fa-spinner fa-spin"></i></th>
                    <th id="waiting_mm_status"><i class="fa fa-spinner fa-spin"></i></th>
                    <th id="rejected_mm_status"><i class="fa fa-spinner fa-spin"></i></th>
                    <th id="waiting_gm_status"><i class="fa fa-spinner fa-spin"></i></th>
                    <th id="rejected_gm_status"><i class="fa fa-spinner fa-spin"></i></th>
                    <th id="canceled_status"><i class="fa fa-spinner fa-spin"></i></th>
                    <th id="completed_status"><i class="fa fa-spinner fa-spin"></i></th>
                    <th id="funding_report_status"><i class="fa fa-spinner fa-spin"></i></th>
                    <th id="mortgage_report_status"><i class="fa fa-spinner fa-spin"></i></th>
                    <th>#</th>
                </tr>
            </tfoot>
        </table>
...
<script>
   ...
   var dt = $('.data-table').DataTable({
        ...
        serverSide: true,
        ajax: ({
            'url': "{{ route('requests.report.status')  }}",
            'method': 'GET',
            'data':function (data) {
