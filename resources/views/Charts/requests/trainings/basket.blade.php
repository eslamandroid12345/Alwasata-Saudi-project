    ...
    <div class="topRow">
        <div class="row align-items-center text-center text-md-left">
            <div class="col-lg-9">
                ...
                <a href="{{route("training.charts.requests.classification")}}" class="btn btn-dark btn-sm">
                    <i class="fa fa-clipboard"></i>
                    تقرير تصنيفات الطلب
                </a>
                <button disabled href="{{route("training.charts.requests.basket")}}" class="btn btn-sm btn-outline-dark">
...
<script>
    ...
    var dt = $('.data-table').DataTable({
        ...
        serverSide: true,
        ajax: ({
           'url': "{{ route('requests.report.basket')  }}?training_id={{auth()->id()}}",
           'method': 'GET',
           'data':function (data) {
