   ...
   {{-- <button onclick="myFun(5)">ClickMe</button>--}}
    ...
    <div class="topRow">
        <div class="row align-items-center text-center text-md-left">
            <div class="col-lg-9">
                <button disabled href="{{route("agent.charts.requests.classification")}}" class="btn btn-outline-dark btn-sm">
                ...
                <a href="{{route("agent.charts.requests.status")}}" class="btn btn-sm btn-dark">
...
<script>
    ...
    var dt = $('.data-table').DataTable({
        ...
        serverSide: true,
        ajax: ({
           'url': "{{ route('requests.report.classification')  }}?agent_id={{auth()->id()}}",
           'method': 'GET',
           'data':function (data) {
