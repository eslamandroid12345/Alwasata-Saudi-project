    ...
    <div class="topRow">
        <div class="row align-items-center text-center text-md-left">
            <div class="col-lg-9">
                ...
                <a  href="{{route("sales.manager.charts.sales.requests.basket")}}" class="btn btn-sm btn-dark">
                    <i class="fa fa-shopping-basket"></i>
                    تقرير سلال الطلب
                </a>

                <button disabled href="{{route("sales.manager.charts.sales.requests.status")}}" class="btn btn-sm btn-outline-dark">
...
<script>
   ...
   var dt = $('.data-table').DataTable({
        ...
        serverSide: true,
        ajax: ({
            'url': "{{ route('requests.report.status')  }}?sales_id={{auth()->id()}}",
            'method': 'GET',
            'data':function (data) {
