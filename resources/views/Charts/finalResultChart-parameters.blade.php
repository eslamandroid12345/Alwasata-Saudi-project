...
{{-- For Search style   --}}
<div class="topRow" >
    <form name="filter" id="filter" method="get"  @if ($manager_role == 7 || $manager_role == 4) action="{{ route('finalResultChartR') }}" @elseif ($manager_role == 1) action="{{ route('sales.manager.finalResultChartForSalesManager') }}" @else action="{{ route('agent.finalResultChartForAgent') }}" @endif >
        <div class="row align-items-center text-center text-md-left">
            ...
            @if ($manager_role != 1 && $manager_role != 0)
                <div class="col-12">
