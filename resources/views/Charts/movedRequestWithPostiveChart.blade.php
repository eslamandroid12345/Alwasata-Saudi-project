...
@section('title')
{{ MyHelpers::admin_trans(auth()->user()->id,'Charts') }} - طلبات (مرفوع ، مكتمل)
@endsection
...
<div class="main-content">
    <div class="section_content section_content--p30">
        ...
        <div class="container-fluid">
            ...
            @include('Charts.movedRequestWithPostiveChart-table')
            @include('Charts.movedRequestWithPostiveChart-chart')
