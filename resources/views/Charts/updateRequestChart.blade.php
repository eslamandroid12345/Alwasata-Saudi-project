...
@section('title')
{{ MyHelpers::admin_trans(auth()->user()->id,'Charts') }} - {{ MyHelpers::admin_trans(auth()->user()->id,'req time line') }}
@endsection
...
@include('Charts.updateRequestChart-parameters')
...
<div class="main-content">
    <div class="section_content section_content--p30">
        ...
        <div class="container-fluid">
            ...
            @include('Charts.updateRequestChart-table')
            @include('Charts.updateRequestChart-chart')
