...
<div class="container">
    ...
    <table id="customers" class=" w3-round-xlarge" style="direction: rtl">
       {{-- <tr class="form-group">
        ...
        <tr class="form-group">
            <td class="head" width="35%"> الإستطلاعات</td>
       ...
       {{-- <tr class="form-group">
            <td class="head" width="35%">طلبات مكتملة</td>
            <td style="text-align: center">{{$user->performances()->whereBetween('today_date', [$start, $end])->sum("completed_request")}} </td>
        </tr>--}}
        <tr class="form-group">
            <td class="head" width="35%" {{auth()->user()->role == 1 ?"colspan='3'" : ""}}>طلبات غير مكتملة</td>
        ...
        <tr class="form-group">
            <td class="head" width="35%">مهام مرسلة</td>
