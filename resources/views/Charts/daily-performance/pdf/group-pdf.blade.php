...
<div class="container">
    ...
    <table id="customers" class=" w3-round-xlarge" style="direction: rtl">
        <tr class="form-group">
            <td class="head" width="35%">المجموع</td>
            <td style="text-align: center">{{$user->performances()->whereBetween('today_date', [$start, $end])->sum("total_recived_request")}} </td>
        ...
        <tr class="form-group">
            ...
            <td class="head" width="35%">تذكيرات فائتة</td>
            <td style="text-align: center">{{$user->performances()->whereBetween('today_date', [$start, $end])->sum("missed_reminders")}} </td>
        </tr>
        <tr class="form-group">
