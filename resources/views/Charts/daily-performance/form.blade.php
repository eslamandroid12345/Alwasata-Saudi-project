    ...
    <form method="POST" id="frm-update">
        ...
        <div class="row align-items-center text-center text-md-left">
            <div class="col-4">
                ...
                <input class="form-control" type="date" min="2022-04-02" name="startdate" id="startdate" value="{{date('Y-m-d') }}">

            </div>
            <div class="col-4">

                <label class="label">{{ MyHelpers::admin_trans(auth()->user()->id,'To Date') }}</label>
                <input class="form-control" type="date" min="2022-04-02" name="enddate" id="enddate" value="{{date('Y-m-d') }}">
            ...
            @if(auth()->user()->role == 7 || auth()->user()->role == 5)
            <div class="col-12">
