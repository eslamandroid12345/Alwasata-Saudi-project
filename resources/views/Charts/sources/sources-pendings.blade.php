...
<div class="addUser my-4">
    <div class="userBlock d-flex align-items-center justify-content-between flex-wrap">
        <h3> مصادر المعاملات معلقة:</h3>
    </div>
    <div class="alert alert-info mt-3">
        <b>تنبيه </b>
        تقرير مصادر المعاملات للطلبات المعلقة بالتاريخ (يعمل التقرير بشكل سريع لمدة 30 يوم ماضية)
    </div>
</div>
   ...
   {{-- <button onclick="myFun(5)">ClickMe</button>--}}
    <div class="dashTable row" style="overflow: hidden">
        ...
        <div class="col-lg-8 pl-0 pr-5">
            <input type="text" max="30" class="form-control ml-3" id="count" placeholder="عدد الأيام">
...
<script>
    ...
    var dt = $('.data-table').DataTable({
        ...
        serverSide: true,
        ajax: ({
           'url': "{{ route('report.sources.pending')  }}",
           'method': 'GET',
           'data':function (data) {
