...
@section('title')
{{ MyHelpers::admin_trans(auth()->user()->id,'pur-pre') }}
@endsection
...
<script>
    $(document).ready(function() {
        var dt = $('.data-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ url('mortgageManager/prepaymentreqs-datatable') }}",
            columns: [
            ...
            createdRow: function(row, data, index) {
                ...
                $('td', row).eq(6).attr('title', data.mm_comment); // to show other text of comment
