<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true" id="myModal1">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="{{ route('mortgage.manager.editCoulmn')}}" method="POST" id="frm-update_coulmn">
                <div class="modal-body">
                    ...
                    <div class="form-group col-3 col-md-3">
                            <input type="checkbox" id="mortgage_cost" name="mortgage_cost" value=0 @if($editCoulmns->where('coulmnName','mortgage_cost')->count() > 0 || $editCoulmns->count() == 0 ) checked @endif>
                            <label for="mortgage_cost" class="control-label mb-1"> {{ MyHelpers::admin_trans(auth()->user()->id,'mortgage cost') }}</label>
                        </div>


                        <div class="form-group col-3 col-md-3">
                            <input type="checkbox" id="profit_cost" name="profit_cost" value=1 @if($editCoulmns->where('coulmnName','profit_cost')->count() > 0 || $editCoulmns->count() == 0 ) checked @endif>
                        ...
                        <div class="form-group col-3 col-md-3">
                            <input type="checkbox" id="real_cost" name="real_cost" value=8 @if($editCoulmns->where('coulmnName','real_cost')->count() > 0 || $editCoulmns->count() == 0 ) checked @endif>
                            <label for="real_cost" class="control-label mb-1">{{ MyHelpers::admin_trans(auth()->user()->id,'real estate cost') }} </label>
                        </div>

                        <div class="form-group col-3 col-md-3">
                            <input type="checkbox" id="Sales_Agent" name="Sales_Agent" value=9 @if($editCoulmns->where('coulmnName','Sales_Agent')->count() > 0 || $editCoulmns->count() == 0 ) checked @endif>
                            <label for="Sales_Agent" class="control-label mb-1">{{ MyHelpers::admin_trans(auth()->user()->id,'Sales_Agent') }}</label>
                        </div>

                        <div class="form-group col-3 col-md-3">
                            <input type="checkbox" id="req_source" name="req_source" value=10 @if($editCoulmns->where('coulmnName','req_source')->count() > 0 || $editCoulmns->count() == 0 ) checked @endif>
                            <label for="req_source" class="control-label mb-1"> {{ MyHelpers::admin_trans(auth()->user()->id,'req_source') }}</label>
                        </div>

                        <div class="form-group col-3 col-md-3">
                            <input type="checkbox" id="type" name="type" value=11 @if($editCoulmns->where('coulmnName','type')->count() > 0 || $editCoulmns->count() == 0 ) checked @endif>
                            <label for="type" class="control-label mb-1"> {{ MyHelpers::admin_trans(auth()->user()->id,'type') }}</label>
                        </div>

                        <div class="form-group col-3 col-md-3">
                            <input type="checkbox" id="funding_source" name="funding_source" value=12 @if($editCoulmns->where('coulmnName','funding_source')->count() > 0 || $editCoulmns->count() == 0 ) checked @endif>
                            <label for="funding_source" class="control-label mb-1"> {{ MyHelpers::admin_trans(auth()->user()->id,'funding source') }}</label>
                        </div>

                        <div class="form-group col-3 col-md-3">
                            <input type="checkbox" id="bank_employee" name="bank_employee" value=13 @if($editCoulmns->where('coulmnName','bank_employee')->count() > 0 || $editCoulmns->count() == 0 ) checked @endif>
                            <label for="bank_employee" class="control-label mb-1"> {{ MyHelpers::admin_trans(auth()->user()->id,'bank_employee') }}</label>
                        </div>

                        <div class="form-group col-3 col-md-3">
                            <input type="checkbox" id="bank_order_num" name="bank_order_num" value=14 @if($editCoulmns->where('coulmnName','bank_order_num')->count() > 0 || $editCoulmns->count() == 0 ) checked @endif>
                        ...
                        <div class="form-group col-3 col-md-3">
                            <input type="checkbox" id="salary_source" name="salary_source" value=18 @if($editCoulmns->where('coulmnName','salary_source')->count() > 0 || $editCoulmns->count() == 0 ) checked @endif>
