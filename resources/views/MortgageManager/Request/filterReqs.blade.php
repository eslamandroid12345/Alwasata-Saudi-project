        ...
        <div class="modal-content">
            ...
            <form action="#" method="POST" id="frm-update">
                <div class="modal-body row">
                    ...
                    <div class="form-group col-6 col-md-6">
                        <label for="sex" class="control-label mb-1">{{ MyHelpers::admin_trans(auth()->user()->id,'customer_name') }}</label>
                        <select class="tokenizeable form-control" id="customer_ids" multiple>
                    ...
                    <div class="form-group col-12 col-md-12" style="display:none;">
                    ...
                    <div class="form-group col-12 col-md-4">
                        <label for="name" class="control-label mb-1">{{ MyHelpers::admin_trans(auth()->user()->id,'bank employee') }}</label>
                        <input name="name" type="text" class="form-control" autocomplete="employee" id="bank-employee" autofocus >
                    </div>
