...
@section('updateModel')
@include('MortgageManager.Request.confirmRestMsg')
    ...
    function archiveAllReqs(array) {
        ...
        modalConfirm(function(confirm) {
          ...
          //  console.log(array);
                ...
                $.post("{{ route('mortgage.manager.restReqArray')}}", {
                    array: array,
                    _token: "{{csrf_token()}}",
                }, function(data) {
                    console.log(data);
                    var url = '{{ route("mortgage.manager.archRequests") }}';
    ...
    */
    ...
    $(document).ready(function() {
        var dt = $('.data-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                'url': "{{ url('mortgageManager/archreqs-datatable') }}",
                'data': function(data) {
