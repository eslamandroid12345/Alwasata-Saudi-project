        ...
        modalConfirm(function(confirm) {
            if (confirm) {
                ...
                $.post("{{ route('mortgage.manager.archReqArray')}}", {
                    ...
                    var url = '{{ route("mortgage.manager.recivedRequests") }}';
    ...
    */
    ...
    $(document).ready(function() {
        var dt = $('.data-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                'url': "{{ url('mortgageManager/recivedreqs-datatable') }}",
                'data': function(data) {
            ...
            createdRow: function(row, data, index) {
                ...
                $('td', row).eq(8).attr('title', data.mm_comment); // to show other text of comment
