...
<form action="{{ route('mortgage.manager.updatePrepayment')}}" method="post" novalidate="novalidate">
    @csrf
            ...
            <span>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <button type="button" id="reject" data-id="{{$id}}" class="btn btn-block btn-danger"><i class="fa fa-ban"></i> Reject Payment</button>
                    ...
                    <div class="col-4">
                        <button type="button" id="approve" data-id="{{$id}}" class="btn btn-info btn-block"><i class="fa fa-check"></i>Approve</button>
                    </div>
        ...
        <label class="fnnn" style="width: 100%; display: block;background: #fff;color: #999;border-bottom: 2px solid #f0f0f0;" for="tab1">
            <span>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <a href="{{ route('mortgage.manager.fundingRequest',$id)}}">
                    ...
                    <div class="col-4">
                        <a href="{{ route('mortgage.manager.morPurRequest',$id)}}">
                            <button type="button" class="btn btn-block btn-outline-primary"><i class="fa fa-credit-card"></i>View Request</button>
                        </a>
                    </div>
            ...
            <span>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        ...
                        <button disabled type="button" id="reject" data-id="{{$payment->req_id}}" class="btn btn-block btn-danger"><i class="fa fa-ban"></i> Reject Payment</button>
                    ...
                    <div class="col-4">
                        <button disabled type="button" id="approve" data-id="{{$payment->req_id}}" class="btn btn-info btn-block"><i class="fa fa-check"></i>Approve</button>
                    </div>
...
@section('confirmMSG')
@include('MortgageManager.prepayement.confirmRejectMsg')
@include('MortgageManager.prepayement.confirmSendingMsg')
@endsection
        ...
        modalConfirm(function(confirm) {
            if (confirm) {
                ...
                $.get("{{ route('mortgage.manager.appPrepayment')}}", {
                    ...
                    var url = '{{ route("mortgage.manager.updatePrepaymentPage", ":reqID") }}';
