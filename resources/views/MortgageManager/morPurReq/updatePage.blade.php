                        ...
                        <div class="tableUserOption flex-wrap justify-content-md-end  justify-content-center downOrder text-center" style="display: block">
                            <div class="addBtn  mt-lg-0 mt-3 orderBtns text-center">
                                ...
                                @if ($purchaseCustomer->is_approved_by_salesManager == 1)
                                    <small class="undoApprove" data-id="{{$id}}" style="font-size: medium; padding:5px;" title="التراجع عن التعميد" id="undoTsaheelApprove"><i class="fa fa-history i-20"></i></small>
                                @endif
                    ...
                    <div class="row tableAdminOption" id="tableAdminOption">
                        ...
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input id="realo" name="realo" type="number" min="0" onblur="debtcalculate()" class="form-control" value="{{ old('realo',$payment->realLo) }}" autocomplete="realo">
                        ...
                        <div class="col-3">
                            <div class="form-group">
                                ...
                                <input id="morpre" name="morpre" min="0" max="100" type="number" class="form-control" value="{{ old('morpre',$payment->mortPre) }}" onblur="mortcalculate()" autocomplete="morpre" autofocus>
                        ...
                        <div class="col-9">
                            <div class="form-group">
                                ...
                                <input id="morcos" name="morcos" type="number" min="0" class="form-control" value="{{ old('morcos',$payment->mortCost) }}" autocomplete="morcos" autofocus readonly>
