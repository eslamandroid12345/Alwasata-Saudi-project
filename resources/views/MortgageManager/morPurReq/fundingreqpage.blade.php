...
<form action="{{ route('mortgage.manager.updateFunding')}}" method="post" novalidate="novalidate">
    @csrf
            ...
            @if ($reqStatus != 23 && $reqStatus != 25 && $reqStatus != 26 && $reqStatus != 27)
                <div class="row align-items-center text-center text-md-left">
                    ...
                    <div class="col-lg-9">
                        <div class="tableUserOption   flex-wrap justify-content-md-end  justify-content-center downOrder">
                            <div class="addBtn  mt-lg-0 mt-3 orderBtns">
                                @if ($reqStatus == 17 || $reqStatus == 20 )
                                    <button id="cancel" class="mr-3 warning item" role="button" type="button">
                                        <a href="{{ route('mortgage.manager.cancelMorPur',$id)}}"  class="text-white" style="text-decoration: none">
                                ...
                                @if ($purchaseCustomer->isUnderProcMor == 1 && $purchaseCustomer->is_start_in_MM == 1)
                                    <button class="green item" type="button" id="complete" data-id="{{$id}}">
                                        <i class="fas fa-check"></i>
                                        {{ MyHelpers::admin_trans(auth()->user()->id,'Completed') }}
                                    </button>
                                @elseif($purchaseCustomer->is_start_in_MM == 0)
                                    <button class="green item" type="button" data-id="{{$id}}">
                                        <a href="{{ route('mortgage.manager.createMorPur_after',$id)}}" class="text-white" style="text-decoration: none">
                                            <i class="fas fa-check mr-2"></i>
                                            {{ MyHelpers::admin_trans(auth()->user()->id,'Complete Successfully') }}
                                        </a>
                ...
                <div class="row align-items-center text-center text-md-left">
                    ...
                    <div class="col-lg-9">
                        <div class="tableUserOption   flex-wrap justify-content-md-end  justify-content-center downOrder">
                            <div class="addBtn  mt-lg-0 mt-3 orderBtns">
                                @if ($reqStatus == 17 || $reqStatus == 20 )
                                    <button disabled style="cursor: not-allowed"  id="cancel" class="mr-3 warning item" role="button" type="button">
                                        <a href="{{ route('mortgage.manager.cancelMorPur',$id)}}"  class="text-white" style="text-decoration: none">
                                            <i class="fas fa-trash mr-2"></i>
                                            {{ MyHelpers::admin_trans(auth()->user()->id,'Cancel Request') }}
                                        </a>
                                ...
                                @if ($purchaseCustomer->isUnderProcMor == 1 && $purchaseCustomer->is_start_in_MM == 1)
                                    <button  disabled style="cursor: not-allowed"  class="green item" type="button" id="complete" data-id="{{$id}}">
                                        <i class="fas fa-check"></i>
                                        {{ MyHelpers::admin_trans(auth()->user()->id,'Completed') }}
                                    </button>
                                @elseif($purchaseCustomer->is_start_in_MM == 0)
                                    <button disabled style="cursor: not-allowed"  class="green item" type="button" data-id="{{$id}}">
                                        <a href="{{ route('mortgage.manager.createMorPur_after',$id)}}" class="text-white" style="text-decoration: none">
                                            <i class="fas fa-check mr-2"></i>
                                            {{ MyHelpers::admin_trans(auth()->user()->id,'Completed') }}
                                        </a>
                                ...
                                <button disabled style="cursor: not-allowed"  class="green item" type="submit" id="update"  data-id="{{$id}}" title="{{ MyHelpers::admin_trans(auth()->user()->id,'Update') }}">
                                    <i class="fas fa-edit"></i>
                                    {{ MyHelpers::admin_trans(auth()->user()->id,'Update') }}
                                </button>
    ...
    <section class="new-content">
        <div class="container-fluid">
            ...
            <div>
                ...
                <span>
                     @include('MortgageManager.morPurReq.fundingReqInfo')
                </span>
                </label>
...
@section('updateModel')
    @include('MortgageManager.morPurReq.req_records')
    @include('MortgageManager.morPurReq.documentModel')
@endsection

@section('confirmMSG')
    @include('MortgageManager.morPurReq.confirmationMsg')
    @include('MortgageManager.morPurReq.confirmationCompleteMsg')
    @include('MortgageManager.morPurReq.confirmSendingMsg')
    @include('MortgageManager.morPurReq.confirmRejectMsg')
@endsection
