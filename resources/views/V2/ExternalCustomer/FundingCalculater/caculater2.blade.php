                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-group">
                            ...
                            <input id="salary_caculater" name="salary_caculater" type="number" class="form-control" value="{{ old('salary_caculater') }}" autocomplete="salary">
                    ...
                    <div class="col-12" id="askary_caculater" style="display:none;">
                        <div class="form-group">
                            <label for="rank" class="control-label mb-1">{{ MyHelpers::guest_trans('miliarty rank') }}</label>
                    ...
                    <div class="col-md-4 mb-3 ">
                        <div class="form-group ">
                            ...
                            <input id="basic_salary_caculater" name="basic_salary_caculater" type="number" class="form-control" value="{{ old('basic_salary_caculater') }}" autocomplete="basic_salary">
                           {{--                            <span class="text-danger" id="basic_salary_caculaterError" role="alert"> </span>--}}
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-group">
                            ...
                            {{--                            <span class="text-danger" id="job_tenure_caculaterError" role="alert"> </span>--}}
                            <span class="text-danger" role="alert">  حسبة برنامج ممتد تتطلب هذا الحقل</span> 
                        </div>
                    </div>
                </div>
...
<div class="row">
    <div class="col-md-4 my-3">
        <div class="form-check form-check-inline">
            <input class="form-check-input toggleMine" id="toggleMine" name="residential_support_caculater" type="checkbox" onchange="valueChanged()" value='1'>
...
<div class="detectionInput" style="display: none;">
...
<div class="row">
    ...
    <div class="col-md-4 mb-3">
        <div class="form-group">
            ...
            <input type="number" class="form-control" id="property_amount_caculater" value="{{ old('property_amount_caculater') }}" name="property_amount_caculater">
...
<div class="save mt-3">
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="form-group">
                <label>صافي الراتب</label>
                <input id="joint_salary_caculater" name="joint_salary_caculater" value="{{ old('joint_salary_caculater') }}" type="number" class="form-control" autocomplete="salary">
    ...
    <div class="row">
        ...
        <div class="col-md-4 my-3 jointToggle" style="display:none;">
    ...
    <div class="row">
        <div class="col-md-12 mb-3 jointearly" style="display: none;">
            <div class="form-group">
                <label>قسط بنك التسليف</label>
                <input type="number" class="form-control jointearly_input" value="{{ old('joint_credit_installment_caculater') }}" name="joint_credit_installment_caculater" id="joint_credit_installment_calculater">
                <span class="text-danger" id="joint_credit_installment_caculaterError" role="alert"> </span>
            </div>
        </div>
    </div>

    <div class="row">
        <div class="col-md-6 mb-3 jointearly" style="display: none;">
            <div class="form-group">
                <label>قسط الإلتزامات</label>
                <input type="number" class="form-control jointearly_input" value="{{ old('joint_obligations_installment_caculater') }}" name="joint_obligations_installment_caculater" id="joint_obligations_installment_calculater">
                <span class="text-danger" id="joint_obligations_installment_caculaterError" role="alert"> </span>
            </div>
        </div>
        <div class="col-md-6 mb-3 jointearly" style="display: none;">
            <div class="form-group">
                <label>أشهر الإلتزامات المتبقية</label>
                <input type="number" class="form-control jointearly_input" value="{{ old('joint_remaining_obligations_months_caculater') }}" name="joint_remaining_obligations_months_caculater" id="joint_remaining_obligations_months_calculater">
                <span class="text-danger" id="joint_remaining_obligations_months_caculaterError" role="alert"> </span>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 mb-3 jointearly" style="display: none;">
            <div class="form-group">
                <label>مبلغ السداد المبكر</label>
                <input type="number" class="form-control jointearly_input" value="{{ old('joint_early_repayment_caculater') }}" name="joint_early_repayment_caculater" id="joint_early_repayment_caculater">
    ...
    <div class="row">
        ...
        <div class="col-md-4 mb-3">
            <div class="form-group">
                <label>بدل السكن </label>
                <input type="number" class="form-control" id="joint_housing_allowance_caculater" value="{{ old('joint_housing_allowance_caculater') }}" name="joint_housing_allowance_caculater">
        ...
        <div class="col-md-4 mb-3">
            <div class="form-group">
                <label>بدل النقل </label>
                <input type="number" class="form-control" id="joint_transfer_allowance_caculater" value="{{ old('joint_transfer_allowance_caculater') }}" name="joint_transfer_allowance_caculater">
        ...
        <div class="col-md-4 mb-3">
            <div class="form-group">
                <label>بدلات أخرى </label>
                <input type="number" class="form-control" id="joint_other_allowance_caculater" value="{{ old('joint_other_allowance_caculater') }}" name="joint_other_allowance_caculater">
    ...
    <div class="row">
        <div class="col-md-6 mb-3">
            <div class="form-group">
                <label>دخل إضافي (التقاعد)</label>
                <input type="number" class="form-control" id="joint_retirement_income_caculater" value="{{ old('joint_retirement_income_caculater') }}" name="joint_retirement_income_caculater">
