            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <small style="color:#e60000" class="d-none realname_missedFileds missedFileds">الحقل مطلوب</small>
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <br>
                        <select id="realcity" onfocus='this.size=3;' onblur='this.size=1;' onchange='this.size=1; this.blur(); 'class="form-control realcity_missedFiledInput FiledInput select2-request @error('realcity') is-invalid @enderror" name="realcity" >
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <select id="realtype" onfocus='this.size=3;' onblur='this.size=1;' onchange='this.size=1; this.blur(); ' class="form-control realtype_missedFiledInput FiledInput select2-request @error('realtype') is-invalid @enderror" name="realtype" >
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input id="realcost" name="realcost" type="number" class="form-control realcost_m @error('realcost') is-invalid @enderror" onblur="setCheckCost()" value="{{ old('realcost',$purchaseReal->cost) }}" autocomplete="realcost" autofocus>
                        @error('realcost')
                        <small class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </small>
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <select id="owning_property" onfocus='this.size=3;' onblur='this.size=1;' onchange='this.size=1; this.blur(); ' class="form-control owning_property_missedFiledInput FiledInput @error('owning_property') is-invalid @enderror" name="owning_property" >
                ...
                <div class="col-4">
                    <div class="form-group">
                        <span class="item pointer span-20" id="record" data-id="realCity" type="button" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                            <i class="fa fa-history i-20" style="font-size: medium;"></i></span>
                        <label for="realcity" class="control-label mb-1">{{ MyHelpers::admin_trans(auth()->user()->id,'city') }}</label>
                        <select disabled id="realcity"  class="form-control select2-request @error('realcity') is-invalid @enderror" name="realcity">
                ...
                <div class="col-4">
                    <div class="form-group">
                        <span class="item pointer span-20" id="record" data-id="residence_type" type="button" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                            <i class="fa fa-history i-20" style="font-size: medium;"></i></span>
                        <label for="residence_type" class="control-label mb-1">المسكن</label>
                        <select disabled id="residence_type" onfocus='this.size=3;' onblur='this.size=1;' onchange='this.size=1; this.blur(); ' class="form-control @error('residence_type') is-invalid @enderror" name="residence_type">
