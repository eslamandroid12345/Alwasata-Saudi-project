            ...
            <div id="tableAdminOption" class=" row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="hiring_date" style="text-align: right" name="hiring_date" type="date" class="form-control @error('hiring_date') is-invalid @enderror" value="{{ $purchaseCustomer->customer->hiring_date }}" autocomplete="hiring_date" >
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <span id="record" role="button" type="button" class="item span-20" data-id="hiring_date" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                            <i class="fa fa-history i-20"></i></span>
                            <label for="hiring_date" class="control-label mb-1">تاريخ التعيين</label>
                        <input  readonly id="hiring_date" style="text-align: right" name="hiring_date" type="date" class="form-control @error('hiring_date') is-invalid @enderror" value="{{ $purchaseCustomer->customer->hiring_date }}" autocomplete="hiring_date" >
                    </div>
                </div>
                @if(($purchaseCustomer->customer->work == 2 ))
