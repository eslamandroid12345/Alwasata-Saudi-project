        ...
        <div class="dashTable">
            <table class="table table-bordred table-striped data-table" id="myreqs-table">
                ...
                <tr>
                    ...
                    <th>{{ MyHelpers::admin_trans(auth()->user()->id,'bank_user_notes') }}</th>
                    <th>ملاحظة الوساطة</th>
    ...
    <script>
        ...
        $(document).ready(function () {
            var dt = $('.data-table').DataTable({
                ...
                serverSide: true,
                ajax: ({
                    'url': "{{ url('V2/BankDelegate/requests/datatable?sended=1') }}",
                    'method': 'GET',
                    'data': function (data) {
                ...
                createdRow: function (row, data, index) {
                    ...
                    $('td', row).eq(5).attr('title', data.statusReq); // to show other text of comment
