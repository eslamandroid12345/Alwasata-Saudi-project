<div class="userFormsInfo  ">
    ...
    <div class="userFormsContainer mb-3">
            ...
            <div id="tableAdminOption" class="row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input id="name" name="name" type="text" class="form-control @error('name') is-invalid @enderror" value="{{  old('name', $purchaseCustomer->name) }}" autocomplete="name">
                        @error('name')
                ...
                <div class="col-6">
                    <div class="form-group">
                        <span class="item pointer span-20" id="record" data-id="customerName" type="button" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                            <i class="fa fa-history i-20" style="font-size: medium;"></i></span>
                        <label for="Customer" class="control-label mb-1">رقم الهوية</label>
                        <input id="id_number" name="id_number" type="text" class="form-control @error('id_number') is-invalid @enderror" value="{{  old('id_number', $purchaseCustomer->id_number) }}" autocomplete="id_number">
                        @error('id_number')
                        <small class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </small>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input id="mobile" name="mobile" type="tel" class="form-control @error('mobile') is-invalid @enderror" value="{{ old('id_number', $purchaseCustomer->mobile) }}" onchange="changeMobile()" autocomplete="mobile" autofocus placeholder="05xxxxxxxx">
                        @error('mobile')
                        <small class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </small>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input id="birth" style="text-align: right" name="birth" type="date" class="form-control @error('birth') is-invalid @enderror" value="{{ date('Y-m-d',strtotime($purchaseCustomer->birth_date)) }}" autocomplete="birth" onblur="calculate()" autofocus>
                        @error('birth')
                        <small class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </small>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <select id="work"  class="form-control select2-request @error('work') is-invalid @enderror" name="work">
                ...
                <div class="col-6" id="madany_work">
                    <div class="form-group">
                        ...
                        <select id="madany_work_id"  class="form-control select2-request @error('madany_work') is-invalid @enderror" name="madany_work">
                            <option value="">---</option>
                ...
                <div class="col-6" id="job_title">
                    <div class="form-group" >
                        ...
                        <input id="job_title_id" name="job_title" type="text" class="form-control @error('job_title') is-invalid @enderror" value="{{ old('job_title',$purchaseCustomer->job_title) }}" autocomplete="job_title">
                ...
                <div class="col-6" id="askary_work">
                    <div class="form-group">
                        ...
                        <select id="askary_work_id"  class="form-control select2-request @error('askary_work') is-invalid @enderror" name="askary_work">
                            <option value="">---</option>
                ...
                <div class="col-6" id="military_rank">
                    <div class="form-group">
                        ...
                        <select id="military_rank_id"  class="form-control select2-request @error('rank') is-invalid @enderror" name="rank">
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input id="salary" name="salary" type="number" class="form-control @error('salary') is-invalid @enderror" value="{{ old('salary',$purchaseCustomer->salary) }}" autocomplete="salary">
                        @error('salary')
                        <small class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </small>
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <select id="is_support" name="is_support" onfocus='this.size=3;' onblur='this.size=1;' onchange='this.size=1;' class="form-control @error('is_support') is-invalid @enderror">
                            <option value="">---</option>
                            <option value="1" @if($purchaseCustomer->is_supported == 1) selected="selected" @endif>نعم</option>
                            <option value="0" @if($purchaseCustomer->is_supported == 0) selected="selected" @endif>لا</option>
                        </select>
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        <input id="basic_salary" name="basic_salary" type="number" class="form-control @error('basic_salary') is-invalid @enderror" value="{{ old('basic_salary',$purchaseCustomer->basic_salary) }}" autocomplete="basic_salary">
                        @error('basic_salary')
                        <small class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </small>
                ...
                <div class="col-4">
                    <div class="form-group">
                        ...
                        @error('add_support_installment_to_salary')
                            <small class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </small>
                        @enderror
                ...
                <div class="col-4">
                    <div class="form-group">
                        <span class="item pointer span-20" id="record" data-id="duration_of_obligations" type="button" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                            <i class="fa fa-history i-20" style="font-size: medium;"></i></span>
                        <label for="duration_of_obligations" class="control-label mb-1">المدة المتبقية للالتزامات</label>
                        <input id="duration_of_obligations" name="duration_of_obligations" type="number" class="form-control" @if (old('has_obligations')=='no' || $purchaseCustomer->has_obligations == 'no' || $purchaseCustomer->has_obligations == null ) readonly @endif value="{{ old('duration_of_obligations',$purchaseCustomer->duration_of_obligations) }}" autocomplete="obligations_value" >
                        @error('duration_of_obligations')
                        <small class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </small>
                        @enderror
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        @error('financial_distress_value')
                        <small class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </small>
                        @enderror
                ...
                <div class="col-12">
                    <div class="form-group">
                        <span class="item pointer span-20" id="record" data-id="notes" type="button" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                            <i class="fa fa-history i-20" style="font-size: medium;"></i></span>
                        <label for="notes" class="control-label mb-1">{{ MyHelpers::admin_trans(auth()->user()->id,'external customer notes') }} </label>
                        <textarea id="notes" rows="6" name="notes" class="form-control" autocomplete="notes" >{{ old('notes',$purchaseCustomer->notes) }} </textarea>
                        @error('notes')
                        <small class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </small>
        ...
        {{-- @include('V2.ExternalCustomer.fundingReq.fundingJoint') --}}
    </div>
</div>
...
<script>
        ...
        $(document).ready(function(){
            ...
            if($('#work').val() == 1){
                ...
                $('#madany_work_id').attr('required',false);
                $('#job_title_id').attr('required',false);
                ...
                $('#askary_work_id').attr('required',false);
                $('#military_rank_id').attr('required',false);

                $('#askary_work_id').val("");
                $('#military_rank_id').val("");
