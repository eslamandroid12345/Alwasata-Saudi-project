        ...
        <div class="row align-items-center text-center text-md-left">
            ...
            <div class="col-lg-10 ">
                <div class="tableUserOption  flex-wrap ">
                    ...
                    {{--
                    <div class="addBtn col-md-4 mt-lg-0 mt-3">
                            <button disabled id="archAll" onclick="getReqests1()" style="cursor: not-allowed" >
                ...
                <div class="addBtn col-md-4 mt-lg-0 mt-3">
                    <button disabled id="followAll" class="mov" onclick="getReqests3()" style="cursor: not-allowed">
                        <i class="fas fa-reply"></i>
                        {{ MyHelpers::admin_trans(auth()->user()->id,'Add To Follow Request') }}
                    </button>
                </div>
                <div class="addBtn col-md-4 mt-lg-0 mt-3">
                    <button disabled id="starAll" class="green" onclick="getReqests2()" style="cursor: not-allowed">
