            ...
            <div class="row align-items-center text-center text-md-left">
                ...
                <div class="col-lg-10 mt-lg-0 mt-3">
                    <div class="tableUserOption  flex-wrap ">
                        <div class="addBtn mt-lg-0 mt-3">
                            <button disabled  id="restoreAll" class="mov" onclick="getReqests1()" style="cursor: not-allowed">
    ...
    function restoreAllReqs(array) {
        ...
        modalConfirm(function(confirm) {
            if (confirm) {
                ...
                $.post("{{ route('agent.restReqArray')}}", {
                    array: array,
                    _token: "{{csrf_token()}}",
                }, function(data) {

                    var url = '{{ route("agent.archRequests") }}';
                    ...
                    if (data > 0) {
                        ...
                        $('#msg2').addClass("alert-danger").removeAttr("style").html("<button type='button' class='close' data-dismiss='alert'>&times;</button>لابد من تغيير التصنيف إلى إيجابي حتى يتم استرجاعه");
                    } else
    ...
    */
    ...
    $(document).ready(function() {
        var dt = $('.data-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                'url': "{{ url('agent/archreqs-datatable') }}",
                'data': function(data) {
