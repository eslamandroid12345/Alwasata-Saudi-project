            ...
            <div class="row align-items-center text-center text-md-left">
                ...
                {{--
                    ...
                    <div class="tableUserOption  flex-wrap ">
                        <div class="addBtn col-md-7 mt-lg-0 mt-3">
                            <button disabled id="archAll" onclick="getReqests2()" style="cursor: not-allowed">
...
modalConfirm(function(confirm) {
    if (confirm) {
        ...
        $.post("{{ route('agent.archReqArray')}}", {
            ...
            var url = '{{ route("agent.staredRequests") }}';
    ...
    */
    ...
    $(document).ready(function() {
        var dt = $('.data-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                'url': "{{ url('agent/staredreqs-datatable') }}",
                'data': function(data) {
