...
<form action="{{ route('agent.updatePrepayment')}}" method="post" novalidate="novalidate">
    @csrf
        ...
        <label class="fnnn" style="width: 100%; display: block;background: #fff;color: #999;border-bottom: 2px solid #f0f0f0;" for="tab1">
            <span>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <a href="{{ route('agent.fundingRequest',$id)}}">
                    ...
                    <div class="col-4">
                        <a href="{{ route('agent.morPurRequest',$id)}}">
                            <button type="button" class="btn btn-block btn-outline-primary"><i class="fa fa-credit-card"></i>View Request</button>
                        </a>
                    </div>
...
@section('confirmMSG')
@include('Agent.prepayement.confirmSendingMsg')
@endsection
        ...
        modalConfirm(function(confirm) {
            if (confirm) {
                ...
                $.get("{{ route('agent.sendPrepayment')}}", {
                    ...
                    var url = '{{ route("agent.updatePrepaymentPage", ":reqID") }}';
