        ...
        <div class="container-fluid">
            ...
            <div>
                <label style="width: 100%; display: block;" for="tab1">
                    <span>
                         @include('Agent.morPurReq.fundingReqInfo')
                    </span>
                </label>
...
@section('updateModel')
@include('Agent.morPurReq.req_records')
@include('Agent.morPurReq.documentModel')
@include('Helpers.addPhone')
@endsection

@section('confirmMSG')
@include('Agent.morPurReq.confirmationMsg')
@include('Agent.morPurReq.confirmSendingMsg')
@include('Agent.morPurReq.confirmRejectMsg')
@endsection
