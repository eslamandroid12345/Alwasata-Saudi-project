            ...
            <div class="card-body">
                <table id="pendingReqs-table" class="table table-bordred table-striped data-table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <td class="{{$data->from_year != $main['from_year'] ? 'boldRed' : ''}}">السنوات من </td>
                            <td> {{$main['from_year']}} </td>
                            <td> {{$data->from_year_api}} </td>
                            <td> {{$data->from_year}} </td>
                        </tr>
                        <tr>
                            <td class="{{$data->to_year != $main['to_year'] ? 'boldRed' : ''}}">السنوات إلى</td>
                            <td> {{$main['to_year']}} </td>
                            <td> {{$data->to_year_api}} </td>
                            <td> {{$data->to_year}} </td>
                        </tr>
                        <tr>
                            <td class="{{$data->personal_to_string != $main['personal_to_string'] ? 'boldRed' : ''}}">شخصي </td>
                            <td> {{$main['personal_to_string']}} </td>
                            <td> {{$data->personal_to_string_api}} </td>
                            <td> {{$data->personal_to_string}} </td>
                        </tr>
                    </tbody>
