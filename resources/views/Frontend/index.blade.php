                    ...
                    <div class="sirviceBlk">
                        ...
                        <figure>
                            ...
                            <a href="#" title="">
                                ...
                                <img src="{{asset('website_style/frontend/images/img_villa1.jpg')}}" alt="">

                                <figcaption>

                                    <strong>{{ MyHelpers::guest_trans('Villa') }}</strong>
                        ...
                        <div class="txt">
                            ...
                            <h3><a href="#" title="">{{ MyHelpers::guest_trans('Villa') }}</a></h3>

                            <span class="loc">{{ MyHelpers::guest_trans('Riyadh') }}</span>
                        ...
                        <div class="btmList">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <img src="{{asset('website_style/frontend/images/img_bed.png')}}" alt="">
                                ...
                                <li>
                                    ...
                                    <img src="{{asset('website_style/frontend/images/img_wash.png')}}" alt="">
                                ...
                                <li>
                                    ...
                                    <img src="{{asset('website_style/frontend/images/img_home.png')}}" alt="">

                                    <span>{{ MyHelpers::guest_trans('meter') }} 2624</span>
                    ...
                    <div class="sirviceBlk">
                        ...
                        <figure>
                            ...
                            <a href="#" title="">
                                ...
                                <img src="{{asset('website_style/frontend/images/img_villa2.jpg')}}" alt="">
                    ...
                    <div class="sirviceBlk">
                        ...
                        <figure>
                            ...
                            <a href="#" title="">
                                ...
                                <img src="{{asset('website_style/frontend/images/img_villa3.jpg')}}" alt="">
