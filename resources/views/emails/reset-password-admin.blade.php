...
<div class="preheader" style="display: none; max-width: 0; max-height: 0; overflow: hidden; font-size: 1px; line-height: 1px; color: #fff; opacity: 0;">
   شركة الوساطة العقارية , إعادة تعيين كلمة المرور
</div>
<!-- end preheader -->
            ...
            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                <tr>
                    <td align="center" bgcolor="#ffffff" style="padding: 36px 24px 0; font-family: 'Cairo', Helvetica, Arial, sans-serif; border-top: 3px solid #d4dadf;">
                        <h1 style="margin: 0; font-size: 32px; font-weight: 700; letter-spacing: -1px; line-height: 48px;text-align: center">إعادة تعيين كلمة المرور</h1>
                    </td>
                </tr>
            </table>
            <!--[if (gte mso 9)|(IE)]>
                ...
                <tr>
                    <td align="center" bgcolor="#ffffff" style="padding: 24px; font-family: 'Cairo', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                        ...
                        <p style="margin: 0;text-align: center">
                            هل طلبت إعادة تعيين كلمة المرور الخاصة بك , من فضلك إذا كنت طلبت ذلك إضغط على الرابط التالى سيصبح هذا الرابط متاح خلال 60 دقيقة فقط
                        </p>
                    </td>
                </tr>
                <!-- end copy -->
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td align="center" bgcolor="#1a82e2" style="border-radius: 6px;text-align: center">
                                                <a href="{{$url}}" target="_blank" style="display: inline-block; padding: 16px 36px; font-family: 'Cairo', Helvetica, Arial, sans-serif; font-size: 16px; color: #ffffff; text-decoration: none; border-radius: 6px;">إسترجاع كلمة المرور</a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                ...
                <tr>
                    <td align="center" bgcolor="#ffffff" style="padding: 24px; font-family: 'Cairo', Helvetica, Arial, sans-serif; font-size: 16px; line-height: 24px;">
                        <p style="margin: 0;font-size: 12px;text-align: center">
                            إذا واجهتك اى مشكلة فى الضغط  قم بنسخ هذا الرابط والصقه فى متصفحك </p>
                        <p style="margin: 0;text-align: center"><a href="{{$url}}" target="_blank">{{$url}}</a></p>
                    </td>
                </tr>
                <!-- end copy -->
