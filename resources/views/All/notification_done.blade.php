...
@section('title')
{{ MyHelpers::admin_trans(auth()->user()->id,'Notifications') }} - تمت المعالجة
@endsection
...
<div class="addUser my-4">
    <div class="userBlock d-flex align-items-center justify-content-between flex-wrap">
        <h3>{{ MyHelpers::admin_trans(auth()->user()->id,'Notifications') }} - تمت المعالجة:</h3>
...
<script>
    $(document).ready(function() {
        var dt = $('.data-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ url('all/notifiys-datatable_done') }}",
            columns: [{
                    "targets": 0,
                    "data": "id",
