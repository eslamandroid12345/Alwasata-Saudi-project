            ...
            <form action="{{ route('funding.manager.editCoulmn')}}" method="POST" id="frm-update_coulmn">
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-3 col-md-3">
                            <input type="checkbox" id="mortgage_cost" name="mortgage_cost" value=1 @if($editCoulmns->where('coulmnName','mortgage_cost')->count() > 0 || $editCoulmns->count() == 0 ) checked @endif>
