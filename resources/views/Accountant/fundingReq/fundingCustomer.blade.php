            ...
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-6">
                        <div id="madany2" class="form-group">
                            <button class="item" id="record" data-id="madanyWork" type="button" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                                <i class="fa fa-history" style="font-size: medium;"></i></button>
                ...
                <div class="row">
                    ...
                    <div class="col-6" id="askary2">
                        ...
                        <div class="form-group">
                            <button class="item" id="record" data-id="askaryWork" type="button" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                                <i class="fa fa-history" style="font-size: medium;"></i></button>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <div class="form-group">
                            <button class="item" id="record" data-id="salary_source" type="button" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                                <i class="fa fa-history" style="font-size: medium;"></i></button>
                ...
                @include('Accountant.fundingReq.fundingJoint')
