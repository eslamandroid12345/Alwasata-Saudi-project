    ...
    <div class="col-lg-12 mx-auto">
        <div class="card">
            ...
            <div class="card-body">
                ...
                @if ($purchaseCustomer->is_approved_by_fundingManager == 1 && $purchaseCustomer->is_approved_by_mortgageManager == 1 && $purchaseCustomer->is_approved_by_generalManager == 1 )
                ...
                @include('Accountant.fundingReq.prepayment')
