                    ...
                    <div class="col-lg-9">
                        <div class="tableUserOption  flex-wrap ">
                            ...
                            <div class="addBtn col-md-5 mt-lg-0 mt-3">
                                <a href="{{route('admin.getAddNewProfitPercentagePage')}}">
    ...
    <script>
        $(document).ready(function() {
            var dt = $('.data-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ url('admin/profit-percentage-datatable') }}",
                columns: [
                    {
                        data: 'id',
                        name: 'id'
                    ...
                    {
                        data: 'personal_to_string',
                        name: 'personal_to_string'
                    },
                    {
                    ...
                    {
                        data: 'from_year_to_string',
                        name: 'from_year_to_string'
                    },
                    {
                        data: 'to_year_to_string',
                        name: 'to_year_to_string'
                    },
                    {
                        data: 'from_salary',
                        name: 'from_salary'
        ...
        $(document).on('click','#remove', function (){
            ...
            $('#ok_button').click(function (){
                $.ajax({
                    url: "{{ url('/admin/profit-percentage-index/remove/') }}",
                    type: "POST",
