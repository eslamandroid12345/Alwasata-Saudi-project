                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-body card-block">
                                ...
                                @else
                                @endif
                                <form action="{{route('admin.saveNewProfitPercentage')}}" method="post" class="">
                                    @csrf
                                    <div class="row">
                                        ...
                                        <div class="form-group col-6 mt-4">
                                            ...
                                            <input type="text" name="from_year" class="form-control" value="{{ old('from_year') }}">
                                        </div>
                                        <div class="form-group col-6 mt-4">
                                            <label for="profit_percentage" class="control-label mb-1"> السنة ( إلي ) </label>
                                            <input type="text" name="to_year" class="form-control" value="{{ old('to_year') }}">
                                        </div>
                                        <div class="form-group col-6 mt-4">
