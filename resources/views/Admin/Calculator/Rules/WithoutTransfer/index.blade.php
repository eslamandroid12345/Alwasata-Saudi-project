...
@section('title')
    {{ MyHelpers::admin_trans(auth()->user()->id,'rules_without_transfer') }}
@endsection
@section('css_style')
...
@section('customer')
    ...
    <div class="addUser my-4">
        <div class="userBlock d-flex align-items-center justify-content-between flex-wrap">
            <h3> {{ MyHelpers::admin_trans(auth()->user()->id,'rules_without_transfer') }}</h3>
        </div>
    </div>
    <br>
    @if ($rules > 0)
                    ...
                    <div class="col-lg-9">
                        <div class="tableUserOption  flex-wrap ">
                            ...
                            <div class="addBtn col-md-5 mt-lg-0 mt-3">
                                <a href="{{route('admin.addNewWithoutTransferRuleItem')}}">
    ...
    <script>
        $(document).ready(function() {
            var dt = $('.data-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ url('admin/without-transfer-datatable') }}",
                columns: [
                    {
                        data: 'id',
                        name: 'id'
        ...
        $(document).on('click','#remove', function (){
            ...
            $('#ok_button').click(function (){
                $.ajax({
                    url: "{{ url('/admin/without-transfer-remove/') }}",
                    type: "POST",
