                    ...
                    <div class="col-lg-9">
                        <div class="tableUserOption  flex-wrap ">
                            ...
                            <div class="addBtn col-md-5 mt-lg-0 mt-3">
                                <a href="{{route('admin.addNewJobPosition')}}">
    ...
    <script>
        $(document).ready(function() {
            var dt = $('.data-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ url('admin/job-positions-datatable') }}",
                columns: [
                    {
                        data: 'id',
                        name: 'id'
                    ...
                    {
                        data: 'retirement_to_string',
                        name: 'retirement_to_string'
                    },
                    {
                        data: 'retirement_age',
                        name: 'retirement_age'
                    ...
                    {
                        data: 'retirement_calc_number',
                        name: 'retirement_calc_number'
                    },
                    {
                        data: 'sort_order',
                        name: 'sort_order'
        ...
        $(document).on('click','#remove', function (){
            ...
            $('#ok_button').click(function (){
                $.ajax({
                    url: "{{ url('/admin/job-position/remove/') }}",
                    type: "POST",
