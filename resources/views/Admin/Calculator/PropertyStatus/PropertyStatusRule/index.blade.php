...
@section('title')
    {{ MyHelpers::admin_trans(auth()->user()->id,'property_status_rule_index') }}
@endsection
@section('css_style')
...
@section('customer')
    ...
    <div class="addUser my-4">
        <div class="userBlock d-flex align-items-center justify-content-between flex-wrap">
            <h3> {{ MyHelpers::admin_trans(auth()->user()->id,'property_status_rule_index') }}</h3>
        </div>
    </div>
    <br>
    @if ($Properties > 0)
                    ...
                    <div class="col-lg-9">
                        <div class="tableUserOption  flex-wrap ">
                            ...
                            <div class="addBtn col-md-5 mt-lg-0 mt-3">
                                <a href="{{route('admin.addNewPropertyStatusRuleItem')}}">
    ...
    <script>
        $(document).ready(function() {
            var dt = $('.data-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ url('admin/property-status-rule-datatable') }}",
                columns: [
                    {
                        data: 'id',
                        name: 'id'
                    ...
                    {
                        data: 'property_completed_to_string',
                        name: 'property_completed_to_string'
                    },
                    {
                        data: 'action',
                        name: 'action'
        ...
        $(document).on('click','#remove', function (){
            ...
            $('#ok_button').click(function (){
                $.ajax({
                    url: "{{ url('/admin/property-status-rule-remove/') }}",
                    type: "POST",
