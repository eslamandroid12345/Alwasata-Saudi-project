...
@section('title')
    {{ MyHelpers::admin_trans(auth()->user()->id,'kinds_of_product') }}
@endsection
@section('css_style')
...
@section('customer')
    ...
    <div class="addUser my-4">
        <div class="userBlock d-flex align-items-center justify-content-between flex-wrap">
            <h3> {{ MyHelpers::admin_trans(auth()->user()->id,'kinds_of_product') }}</h3>
        </div>
    </div>
    <br>
    @if ($ProductType > 0)
                    ...
                    <div class="col-lg-9">
                        <div class="tableUserOption  flex-wrap ">
                            ...
                            <div class="addBtn col-md-5 mt-lg-0 mt-3">
                                <a href="{{route('admin.addNewProductTypeItem')}}">
    ...
    <script>
        $(document).ready(function() {
            var dt = $('.data-table').DataTable({
                ...
                processing: true,
                serverSide: true,
                ajax: "{{ url('admin/product-type-datatable') }}",
                columns: [
                    {
                        data: 'id',
                        name: 'id'
                    ...
                    {
                        data: 'property_status_to_string',
                        name: 'property_status_to_string'
                    },
                    {
                        data: 'active_to_string',
                        name: 'active_to_string'
                    },
                    {
                        data: 'action',
                        name: 'action'
        ...
        $(document).on('click','#remove', function (){
            ...
            $('#ok_button').click(function (){
                $.ajax({
                    url: "{{ url('/admin/product-type-remove/') }}",
                    type: "POST",
