            ...
            <div class="col-lg-10">
                ...
                <div class="tableUserOption   flex-wrap justify-content-md-end">
                    <div class="addBtn  mt-lg-0 mt-3 orderBtns spansBtn">
                        ...
                        <button class="mr-2 Pink" style="cursor: not-allowed" disabled id="moveNeesActionAll" onclick="getReqests2()">
...
<script>
        ...
        if (salesAgent != '') {
            ...
            $.get(url, {
                ...
                if (data.updatereq == 1) {
                    ...
                    $('#starreqs-table').DataTable().ajax.reload();
    ...
    $(document).on('click', '#submitMove3', function(e) {
        ...
        var url = "{{ route('admin.moveReqToAnotherArrayAgent')}}";
...
<script>
    ...
    $(document).ready(function() {
        var dt = $('#starreqs-table').DataTable({
            "language": {
            ...
            serverSide: true,
            ajax: {
                'url': "{{ url('admin/staredreqs-datatable') }}",
                'method': 'Get',
                'data': function(data) {
            ...
            createdRow: function(row, data, index) {
                ...
                */
                ...
                $('td', row).eq(4).attr('title', data.cust_name); // to show other text of comment


                $('td', row).eq(1).addClass('reqDate'); // 6 is index of column
                $('td', row).eq(11).addClass('reqDate'); // 6 is index of column
