            ...
            <form action="#" method="POST" id="frm-update">
                <div class="modal-body row">
                    ...
                    <div class="form-group col-6 col-md-6">
                        ...
                        <div class="" style="float:left">
                            <input type="checkbox" class="form-check-input" name="allow-recived-sales-agents" id="allow-recived-sales-agents" style="height: 15px;">  نشط
                        </div>
                    ...
                    <div class="form-group col-6 col-md-6">
                        <label for="status_of_request" class="control-label mb-1">الحاله</label>
                        <select class="form-control" id="status_of_request">
