                ...
                <div id="tableAdminOption" class="row">
                    <div class="col-md-4 mb-3">
                        <div class="form-group">
                            <span id="record" role="button" type="button" class="item span-20"  data-id="reqtyp" data-toggle="modal" data-target="#myModal" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                                <i class="fa fa-history i-20"></i></span>
                            <label for="reqtyp" >{{ MyHelpers::admin_trans(auth()->user()->id,'type') }}</label>
                            <select id="reqtyp" class="form-control @error('reqtyp') is-invalid @enderror" name="reqtyp">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <span class="item pointer span-20" id="record" data-id="reqSource" type="button" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                            ...
                            <select id="reqsour" onchange='checkCollaborator(this);' class="form-control select2-request @error('reqsour') is-invalid @enderror" name="reqsour">
                    ...
                    <div class="col-md-4 mb-3" id="collaboratorDiv">
                        ...
                        <span class="item pointer span-20" id="record" data-id="collaborator_name" type="button" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                            ...
                            <select id="collaborator" class="form-control select2-request @error('collaborator') is-invalid @enderror" name="collaborator">
                                <option value="">---</option>
                    ...
                    <div class="col-md-4 mb-3" id="collaboratorDiv2">
                        ...
                        <span class="item pointer span-20" id="record" data-id="collaborator_name" type="button" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                                <i class="fa fa-history i-20" style="font-size: medium;"></i></span>
                            <label for="collaborator" >{{ MyHelpers::admin_trans(auth()->user()->id,'collaborator name') }}</label>
                            <select id="collaborator2"  class="form-control select2-request @error('collaborator') is-invalid @enderror" name="collaborator">
                                <option value="">---</option>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-group">
                            <span id="record" role="button" type="button" class="item span-20"  data-id="class_agent" data-toggle="modal" data-target="#myModal" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                                <i class="fa fa-history i-20"></i></span>
                            <label for="reqclass" >{{ MyHelpers::admin_trans(auth()->user()->id,'req classification agent') }}</label>
                            <select id="reqclass"  onchange="check_rejection(this);" class="form-control select2-request @error('reqclass') is-invalid @enderror" name="reqclass">
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-group">
                            <span id="record" role="button" type="button" class="item span-20"  data-id="class_id_sm" data-toggle="modal" data-target="#myModal" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                                <i class="fa fa-history i-20"></i></span>
                            <label for="reqclass" >{{ MyHelpers::admin_trans(auth()->user()->id,'req classification SM') }}</label>
                            <select id="reqclass_m" class="form-control select2-request @error('reqclass_m') is-invalid @enderror" name="reqclass_m">
                                <option value="">---</option>
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-group">
                            <span id="record" role="button" type="button" class="item span-20"  data-id="class_id_fm" data-toggle="modal" data-target="#myModal" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                                <i class="fa fa-history i-20"></i></span>
                            <label for="reqclass" >{{ MyHelpers::admin_trans(auth()->user()->id,'req classification FM') }}</label>
                            <select id="reqclass_fm" class="form-control select2-request @error('reqclass_fm') is-invalid @enderror" name="reqclass_fm">
                                <option value="">---</option>
                                @foreach ($classifcations3 as $classifcation )
                                    @if ($purchaseClass3->class_id_fm == $classifcation->id || (old('reqclass_fm') == $classifcation->id))
                                        <option value="{{$classifcation->id}}" selected>{{$classifcation->value}}</option>
                                    @else
                                        <option value="{{$classifcation->id}}">{{$classifcation->value}}</option>
                                    @endif
                    ...
                    <div class="{{$purchaseCustomer->source == 2 ? "col-6" :"col-12"}} mb-3">
                        <div class="form-group">
                            <span id="record" role="button" type="button" class="item span-20"  data-id="comment" data-toggle="modal" data-target="#myModal" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                                <i class="fa fa-history i-20"></i></span>
                            <label for="reqcomm" >{{ MyHelpers::admin_trans(auth()->user()->id,'comment') }}</label>
                            <textarea id="reqcomm" name="reqcomm" rows="3" cols="50" class="form-control @error('reqcomm') is-invalid @enderror" autocomplete="reqcomm" autofocus placeholder="">{{ old('reqcomm', $purchaseCustomer->comment) }}</textarea>
                            @error('reqcomm')
                            <strong class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </strong>
                        ...
                        <div class="{{$purchaseCustomer->source == 2 ? "col-6" : ""}}">
                            <div class="form-group {{$purchaseCustomer->source == 2 ? "d-block" :"d-none"}}">
                                ...
                                <textarea  rows="3" cols="50" class="form-control @error('collaborator_notes') is-invalid @enderror" autocomplete="collaborator_notes" autofocus placeholder="">
...
{{--                        <div class="form-group">--}}
{{--                            <span id="record" role="button" type="button" class="item span-20"  data-id="commentWeb" data-toggle="modal" data-target="#myModal" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">--}}
{{--                                <i class="fa fa-history i-20"></i></span>--}}
