            ...
            <form action="{{ route('admin.moveReqToAnother')}}" method="get" id="frm-update2">
                <div class="modal-body">
                    ...
                    <div id="salesagentDiv" class="form-group">
                        <label for="salesagent" class="control-label mb-1">@lang('language.Sales Agent')</label>
                        <select id="salesagent" style="width:100%;" name="salesagents" onfocus='this.size=3;' onblur='this.size=1;' class="form-control select2">
                            <option value="">---</option>
