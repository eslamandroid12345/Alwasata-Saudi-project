...
<!-- +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++ -->
    ...
    <div class="tableBar">
        <div class="topRow">
            <div class=" tableUserOption  flex-wrap  row align-items-center text-center text-md-left">
                <div class="col-lg-3 mb-3">
                    <select class="form-control py-2" name="job" id="job_title"
                ...
                <div class="col-lg-3 mb-3">
                    <select class="form-control py-2" name="nationality" id="nationality_id"
                        style="border-top-left-radius: 50px; border-bottom-left-radius: 50px;">
                ...
                <div class="col-lg-2 mb-3">
                    <select class="form-control py-2"  name="duration" id="duration_type"
                    style="border-top-left-radius: 50px; border-bottom-left-radius: 50px;">
                ...
                <div class="col-lg-2 mb-3">
                    ...
                    <input type="range" class="custom-range" min="20000" max="1000000" step="1000" id="myRange" name="myRange" value="500000" style="width: 100%">
                </div>
                <div class="col-lg-2 mb-3">
                    <button id="many" class="btn btn-info">
                        بحث
                    </button>
                </div>
            </div>
    ...
    <div class="col-lg-4">
        <div class="tableUserOption  flex-wrap ">
            <div class="input-group col-md-7 mt-lg-0 mt-3">
                <select class="form-control py-2" id="select_filter" onchange="javascript:select_filter(this.value)"
                style="border-top-left-radius: 50px; border-bottom-left-radius: 50px;">
                    <option value="0">البحث عن </option>
                    <option value="job">المسمى الوظيفى</option>
                    <option value="duration">طبيعه الدوام</option>
                    <option value="nationality"> الجنسيه</option>
                    <option value="salary">الراتب المتوقع</option>
                </select>
            </div>
        </div>
    </div>

    <div class="col-lg-4" id="job" style="display:none;">
        <div class="tableUserOption  flex-wrap ">
            <div class="input-group col-md-7 mt-lg-0 mt-3">
                <select class="form-control py-2" name="job" id="job_title"
                style="border-top-left-radius: 50px; border-bottom-left-radius: 50px;">
    ...
    <div class="col-lg-4" id="nationality" style="display:none;">
        <div class="tableUserOption  flex-wrap ">
            <div class="input-group col-md-7 mt-lg-0 mt-3">
                <select class="form-control py-2" name="nationality" id="nationality_id"
                style="border-top-left-radius: 50px; border-bottom-left-radius: 50px;">
    ...
    <div class="col-lg-4" id="duration" style="display:none;">
        <div class="tableUserOption  flex-wrap ">
            <div class="input-group col-md-7 mt-lg-0 mt-3">
                <select class="form-control py-2"  name="duration" id="duration_type"
                style="border-top-left-radius: 50px; border-bottom-left-radius: 50px;">
     ...
     <div class="col-lg-4" id="salary" style="display:none;">
     ...
     <div class="col-lg-3" id="filter" style="display:none;">
        <button id="many" class="btn btn-info">
            بحث
        </button>
    </div>
...
@endsection
@section('updateModel')
    @include('Admin.JobApplication.filter_page')
@endsection
@section('scripts')
<script>  
    $(document).ready(function() {
            ...
            // "pageLength": 50,
                ...
                serverSide: true,
                ajax: {
                   url: "{{ url('admin/job_applications_datatable') }}",
                   data:function(data){
