        ...
        <div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-4">
                    ...
                    <form action="{{ route('admin.importExealForTwoCloumns') }}" method="post" enctype="multipart/form-data">
                        @csrf
                        ...
                        <button class="btn btn-info btn-block" id="upload" type="submit" style="padding: 2%;">
                            ...
                            {{--
                                <span style="color:maroon;">*تأكد من أسماء الأعمدة (mobile,name).</span>
                            --}}
