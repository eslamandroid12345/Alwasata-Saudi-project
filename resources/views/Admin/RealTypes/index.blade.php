            ...
            <div class="col-lg-9">
                <div class="tableUserOption  flex-wrap ">
                    ...
                    <div class="addBtn col-md-5 mt-lg-0 mt-3">
                        <a href="{{ route('real_types.create')}}">
...
<div class="middle-screen">
    <h2 style=" text-align: center;font-size: 20pt;">لايوجد أي انواع</h2>
</div>
...
<script>
    $(document).ready(function() {
        var dt = $('.data-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ url('admin/real_types_datatable') }}",
            columns: [
