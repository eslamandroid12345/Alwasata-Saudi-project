            ...
            <div id="tableAdminOption" class="row">
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                        <span id="record" role="button" type="button" class="item span-20"  data-id="realName" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                            <i class="fa fa-history i-20"></i></span>
                        <label for="realname">{{ MyHelpers::admin_trans(auth()->user()->id,'owner name') }}</label>
                        <input {{$reqStatus == 26 ? 'readonly' : ''}} id="realname" name="realname" type="text" class="form-control @error('realname') is-invalid @enderror" value="{{ old('realname',$purchaseReal->name) }}" autocomplete="realname" autofocus placeholder="">
                        @error('realname')
                ...
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                        ...
                        <input {{$reqStatus == 26 ? 'readonly' : ''}} id="realmobile" name="realmobile" type="tel" class="form-control @error('realmobile') is-invalid @enderror" value="{{ old('realmobile',$purchaseReal->mobile) }}" pattern="(05)[0-9]{8}" maxlength="10" autofocus placeholder="05xxxxxxxx">
                        @error('realmobile')
                        <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                        ...
                        <select {{$reqStatus == 26 ? 'disabled' : ''}} id="realcity" class="form-control select2-request @error('realcity') is-invalid @enderror" name="realcity">
                ...
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                        ...
                        <input {{$reqStatus == 26 ? 'readonly' : ''}} id="realregion" name="realregion" type="text" class="form-control @error('realregion') is-invalid @enderror" value="{{ old('realregion',$purchaseReal->region) }}">
                        @error('realregion')
                        <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                        ...
                        <input {{$reqStatus == 26 ? 'readonly' : ''}} id="realpursuit" name="realpursuit" type="number" class="form-control @error('realpursuit') is-invalid @enderror" value="{{ old('realpursuit',$purchaseReal->pursuit) }}">
                        @error('realpursuit')
                        <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                        ...
                        <select {{$reqStatus == 26 ? 'disabled' : ''}} id="realstatus" onfocus='this.size=3;' onblur='this.size=1;' onchange='this.size=1; this.blur(); ' class="form-control @error('realstatus') is-invalid @enderror" name="realstatus">
                            <option value="">---</option>
                ...
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                        ...
                        <input {{$reqStatus == 26 ? 'readonly' : ''}} id="realage" name="realage" type="number" class="form-control @error('realage') is-invalid @enderror" value="{{ old('realage',$purchaseReal->age) }}" autocomplete="realage" autofocus>
                        @error('realage')
                        <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                        ...
                        <select {{$reqStatus == 26 ? 'disabled' : ''}} id="realtype"  class="form-control select2-request @error('realtype') is-invalid @enderror" name="realtype">
                ...
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                        ...
                        <input {{$reqStatus == 26 ? 'readonly' : ''}} id="realcost" name="realcost" type="number" class="form-control @error('realcost') is-invalid @enderror" onblur="setCheckCost()" value="{{ old('realcost',$purchaseReal->cost) }}" autocomplete="realcost" autofocus>
                        @error('realcost')
                        <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="row" style="padding-top: 10px">
                            @if ($purchaseReal->has_property == 'نعم' || (old('realhasprop')) == 'نعم' || $purchaseReal->has_property == 'yes' || (old('realhasprop')) == 'yes')
                                <div class="col-6">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input {{$reqStatus == 26 ? 'disabled' : ''}} type="radio" class="custom-control-input" value="yes" id="hasyes" name="realhasprop" checked>
                                        <label class="custom-control-label" for="hasyes">نعم</label>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input {{$reqStatus == 26 ? 'disabled' : ''}} type="radio" class="custom-control-input" value="no" id="hasno" name="realhasprop">
                            ...
                            @elseif ($purchaseReal->has_property == 'لا' || (old('realhasprop')) == 'لا' || $purchaseReal->has_property == 'no' || (old('realhasprop')) == 'no')
                                <div class="col-6">
                                    ...
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input  {{$reqStatus == 26 ? 'disabled' : ''}} type="radio" class="custom-control-input" value="yes" id="hasyes" name="realhasprop">
                                        <label class="custom-control-label" for="hasyes">نعم</label>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input {{$reqStatus == 26 ? 'disabled' : ''}} type="radio" class="custom-control-input" value="no" id="hasno" name="realhasprop" checked>
                                        <label class="custom-control-label" for="hasno">لا</label>
                                    </div>
                                </div>
                            @else
                    ...
                    <div class="form-group">
                        ...
                        <div class="row" style="padding-top: 10px">
                            @if ($purchaseReal->evaluated == 'نعم' || (old('realeva')) == 'نعم' )
                                <div class="col-6">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input {{$reqStatus == 26 ? 'disabled' : ''}} type="radio" class="custom-control-input" value="نعم" id="evayes" name="realeva" checked>
                                        <label class="custom-control-label" for="evayes">نعم</label>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input {{$reqStatus == 26 ? 'disabled' : ''}} type="radio" class="custom-control-input" value="لا" id="evano" name="realeva">
                            ...
                            @elseif ($purchaseReal->evaluated == 'لا' || (old('realeva')) == 'لا' )
                                <div class="col-6">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input {{$reqStatus == 26 ? 'disabled' : ''}} type="radio" class="custom-control-input" value="نعم" id="evayes" name="realeva">
                                        <label class="custom-control-label" for="evayes">نعم</label>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input {{$reqStatus == 26 ? 'disabled' : ''}} type="radio" class="custom-control-input" value="لا" id="evano" name="realeva" checked>
                                        <label class="custom-control-label" for="evano">لا</label>
                                    </div>
                                </div>
                            @else
                    ...
                    <div class="form-group">
                        ...
                        <div class="row" style="padding-top: 10px">
                            @if ($purchaseReal->tenant == 'نعم' || (old('realten')) == 'نعم')
                                <div class="col-6">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input {{$reqStatus == 26 ? 'disabled' : ''}} type="radio" class="custom-control-input" value="نعم" id="tenyes" name="realten" checked>
                                        <label class="custom-control-label" for="tenyes">نعم</label>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input {{$reqStatus == 26 ? 'disabled' : ''}} type="radio" class="custom-control-input" value="لا" id="tenno" name="realten">
                            ...
                            @elseif ($purchaseReal->tenant == 'لا' || (old('realten')) == 'لا')
                                <div class="col-6">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input {{$reqStatus == 26 ? 'disabled' : ''}} type="radio" class="custom-control-input" value="نعم" id="tenyes" name="realten">
                                        <label class="custom-control-label" for="tenyes">نعم</label>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input {{$reqStatus == 26 ? 'disabled' : ''}} type="radio" class="custom-control-input" value="لا" id="tenno" name="realten" checked>
                                        <label class="custom-control-label" for="tenno">لا</label>
                                    </div>
                                </div>
                            @else
                    ...
                    <div class="form-group">
                        ...
                        <div class="row" style="padding-top: 10px">
                            ...
                            @if ($purchaseReal->mortgage == 'نعم' || (old('realmor')) == 'نعم')
                                <div class="col-6">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input {{$reqStatus == 26 ? 'disabled' : ''}} type="radio" class="custom-control-input" value="نعم" id="moryes" name="realmor" checked>
                                        <label class="custom-control-label" for="moryes">نعم</label>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input {{$reqStatus == 26 ? 'disabled' : ''}} type="radio" class="custom-control-input" value="لا" id="morno" name="realmor">
                            ...
                            @elseif ($purchaseReal->mortgage == 'لا' || (old('realmor')) == 'لا')
                                <div class="col-6">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input {{$reqStatus == 26 ? 'disabled' : ''}} type="radio" class="custom-control-input" value="نعم" id="moryes" name="realmor">
                                        <label class="custom-control-label" for="moryes">نعم</label>
                                    </div>
                                </div>
                                <div class="col-6">
                                    <div class="custom-control custom-radio custom-control-inline">
                                        <input  {{$reqStatus == 26 ? 'disabled' : ''}} type="radio" class="custom-control-input" value="لا" id="morno" name="realmor" checked>
                                        <label class="custom-control-label" for="morno">لا</label>
                                    </div>
                                </div>
                            @else
