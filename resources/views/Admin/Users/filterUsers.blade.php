<div class="modal fade" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true" id="myModal1">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form action="#" method="POST" id="frm-update1">
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-primary" id="filter-search-users">{{ MyHelpers::admin_trans(auth()->user()->id,'Search') }}</button>
                </div>
            </form>
        </div>
