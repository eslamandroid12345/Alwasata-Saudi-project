...
@section('customer')
    ...
    <div class="afnan">
        <div class="container text-center" style="text-align:center;">
            ...
            @endif--}}
            @if ($helpDesk->msg_type)

                <span class="badge badge-success"> {{MyHelpers::TechniqalMsgType($helpDesk->msg_type)}}</span>
            @endif
        </div>
                ...
                <div class="row">
                    @foreach ($helpDesk->Image()->get() as $f)
                       {{-- @php
                        ...
                        @endphp--}}
                        <div class="col-md-4"><a  href="{{url($f->image_path)}}" target="_blank"><i class="fa fa-file" aria-hidden="true" style=font-size:54px;></i>
                            </a></div>
                    @endforeach
                </div>
    ...
    @if (/*$helpDesk->replay == null && */($helpDesk->status==0 || $helpDesk->status==1))
        <form action="{{route('admin.postReplayHelpDesk')}}" method="post" class="">
            @csrf
                    ...
                    <div class="card text-center">
                        ...
                        <div class="card-footer">
                            <div class="row">
                                ...
                                <div class="col-1">
                                    @if($helpDesk->status==0 || $helpDesk->status==1 )
                                        <a href="{{route('admin.completeHelpDesk',$helpDesk->id)}}">
                                            <button type="button" class="btn btn-outline-success">
                                                مكتمل
                                            </button>
                                        </a>
                                    @else
                                        <button style="cursor: not-allowed" disabled type="button" class="btn btn-outline-success">
                                            مكتمل
                                        </button>
