<div class="cd-timeline-block">
    ...
    <div class="cd-timeline-content cd-timeline-content-2-{{$left_item->id}}" style=" background: rgb(86, 115, 148,0.6);float:left;">
        <h2>{{@$helpDesk->name}}</h2>
        ...
        <span class="cd-date" style="text-align:center; right: auto; left: 92%;">
    ...
    <style>
        .cd-timeline-content-2-{{$left_item->id}}::before {
            top: 24px;
            left: 100%;
            }
    </style>
