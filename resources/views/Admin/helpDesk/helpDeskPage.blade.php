...
<style>
    ...
    .active-filter , .active-filter-employee{
...
{{-- <div class="addUser my-4">
    <div class="userBlock d-flex align-items-center  flex-wrap">
        <h3>حالة الطلب :</h3>
        <div class="form-check form-check-inline mx-4">
            <input class="form-check-input" type="radio" name="status_of_helpdesk" id="inlineRadio1" value="0">
            <label class="form-check-label" for="inlineRadio1">جديد</label>
        </div>

        <div class="form-check form-check-inline mx-4">
            <input class="form-check-input" type="radio" name="status_of_helpdesk" id="inlineRadio2" value="1">
            <label class="form-check-label" for="inlineRadio2"> تم فتحه  </label>
        </div>

        <div class="form-check form-check-inline mx-4">
            <input class="form-check-input" type="radio" name="status_of_helpdesk" id="inlineRadio3" value="2">
            <label class="form-check-label" for="inlineRadio3"> مكتمل</label>
        </div>

        <div class="form-check form-check-inline mx-4">
            <input class="form-check-input" type="radio" name="status_of_helpdesk" id="inlineRadio3" value="3">
            <label class="form-check-label" for="inlineRadio3"> ملغي</label>
        </div>
    ...
    <div class="col-lg-6">
        <nav>
            <div class="nav nav-tabs" id="nav-tab" role="tablist">
              <button class="nav-link buttons-tabs-filter-employee mx-1" value=""  data-bs-toggle="tab"  type="button" role="tab" >الكل</button>
              <button class="nav-link buttons-tabs-filter-employee mx-1" value="1"  data-bs-toggle="tab"  type="button" role="tab" >العملاء</button>
              <button class="nav-link buttons-tabs-filter-employee mx-1" value="2"  data-bs-toggle="tab"  type="button" role="tab" >الموظفين</button>
            </div>
        </nav>
    </div>
    ...
    <div class="col-lg-6">
        <nav>
            <div class="nav nav-tabs float-right" id="nav-tab" role="tablist">
              <button class="nav-link buttons-tabs-filter mx-1" value="0"  data-bs-toggle="tab"  type="button" role="tab" >جديد</button>
              <button class="nav-link buttons-tabs-filter mx-1" value="1"  data-bs-toggle="tab"  type="button" role="tab" >تم فتحه</button>
              <button class="nav-link buttons-tabs-filter mx-1" value="2"  data-bs-toggle="tab"  type="button" role="tab" >مكتمل</button>
              <button class="nav-link buttons-tabs-filter mx-1" value="3"  data-bs-toggle="tab"  type="button" role="tab" >ملغي</button>
            </div>
        </nav>
    </div>
</div>
        ...
        var dt = $('#helpDesk-table').DataTable({
            ...
            ajax: {
                ...
                data:function(d){
                    ...
                    // d.status_of_helpdesk=$('input[name="status_of_helpdesk"]:checked').val()
                    if($('.buttons-tabs-filter').hasClass('active-filter')){
                        d.status_of_helpdesk=$('.active-filter').val()
                    }

                    if($('.buttons-tabs-filter-employee').hasClass('active-filter-employee')){
                        d.type_of_helpdesk=$('.active-filter-employee').val()
                    }
                }
            },
            columns: [
            ...
            initComplete: function() {
                ...
                $(document).on('click','.buttons-tabs-filter-employee',function(){
                    $('.buttons-tabs-filter-employee').each(function(){
                        $(this).removeClass('active-filter-employee')
                    })

                    $(this).addClass('active-filter-employee')
                    dt.draw();
                })
