...
@include('SalesManager.Request.confirmRestMsg')
@endsection
@section('js')
    ...
    function archiveAllReqs(array) {
        ...
        modalConfirm(function(confirm) {
          ...
          //  console.log(array);
                ...
                $.post("{{ route('sales.manager.restReqArray')}}", {
                    array: array,
                    _token: "{{csrf_token()}}",
                }, function(data) {
                    console.log(data);
                    var url = '{{ route("sales.manager.archRequests") }}';
    ...
    */
    ...
    $(document).ready(function() {
        var dt = $('.data-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                'url': "{{ url('salesManager/archreqs-datatable') }}",
                'data': function(data) {
