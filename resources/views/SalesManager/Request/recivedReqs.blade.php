    ...
    function archiveAllReqs(array) {
        ...
        modalConfirm(function(confirm) {
            if (confirm) {
                ...
                $.post("{{ route('sales.manager.archReqArray')}}", {
                    array: array,
                    _token: "{{csrf_token()}}",
                }, function(data) {

                    var url = '{{ route("sales.manager.recivedRequests") }}';
...
<script>
    ...
    $(document).ready(function() {
        var dt = $('.data-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                'url': "{{ url('salesManager/recivedreqs-datatable') }}",
                'data': function(data) {
            ...
            createdRow: function(row, data, index) {
                ...
                $('td', row).eq(8).attr('title', data.sm_comment); // to show other text of comment
                ...
                $('td', row).eq(10).attr('title', data.quacomment); // to show other text of comment
