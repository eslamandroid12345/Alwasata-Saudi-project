            ...
            <div class="userFormsDetails  mt-3">
                @if ($purchaseCustomer-> is_canceled == 0 && ($reqStatus == 3 ||$reqStatus == 5   || $reqStatus == 7 || $reqStatus == 10 ))
                    <div id="tableAdminOption" class="row">
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                <span class="item pointer span-20" id="record" data-id="class_id_sm" type="button" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                                ...
                                <select id="reqclass" onfocus='this.size=3;' onblur='this.size=1;' onchange='this.size=1; this.blur(); ' class="form-control select2-request @error('reqclass') is-invalid @enderror" name="reqclass">
                                    ...
                                    @foreach ($classifcations as $classifcation )
                                        ...
                                        @if ($purchaseClass->class_id_sm == $classifcation->id || (old('reqclass') == $classifcation->id))
