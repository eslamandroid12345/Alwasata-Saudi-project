    ...
    <div class="addUser my-4 topRow ">
        <div class="userBlock d-flex align-items-center justify-content-center flex-wrap">
            ...
            <div class="addBtn">
                ...
                <span id="approveAqar" data-id="{{$id}}" title="اعتماد تقرير إفراغ العقار" class="iconCircle"><i class="fa fa-check"></i></span>

                @if ($purchaseCustomer->is_aqar_approved_by_salesManager == 0)
                    <span class="undoApprove" data-id="{{$id}}" style="font-size: medium; padding:5px;" title="التراجع عن التعميد" id="undoApprove"></span>
                @endif

                @if ($purchaseCustomer->is_aqar_approved_by_salesManager == 1)
                    <span class="undoApprove" data-id="{{$id}}" style="font-size: medium; padding:5px;" title="التراجع عن التعميد" id="undoApprove"><i class="fa fa-history i-20"></i></span>
                @endif

                <span style="padding:15pt;font-weight: normal;" id="approveAqarMsg"></span>
            </div>
        </div>
    </div>
    ...
    <div class="userFormsContainer mb-3">
        <div class="userFormsDetails topRow">
            ...
            <div id="tableAdminOption" class="row">
                ...
                <div class="col-4">
                    <div class="form-group">
                            <span class="item pointer span-20" id="record" data-id="mortValue" type="button" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                                <i class="fa fa-history i-20" style="font-size: medium;"></i></span>
                        <label for="mortgage_value" class="control-label mb-1">{{ MyHelpers::admin_trans(auth()->user()->id,'Mortgage') }}</label>
                        ...
                        <div class="col-4">
                            <div class="form-group">
                                <span class="item pointer span-20" id="record" data-id="mortValue" type="button" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                                    <i class="fa fa-history i-20" style="font-size: medium;"></i></span>
                                <label for="mortgage_value" class="control-label mb-1">{{ MyHelpers::admin_trans(auth()->user()->id,'Mortgage') }}</label>
                                <input id="mortgage_value" name="mortgage_value" type="number" class="form-control @error('mortgage_value') is-invalid @enderror" value="{{ old('mortgage_value',$purchaseReal->mortgage_value) }}" readonly>
                                @error('mortgage_value')
                                <small class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </small>
