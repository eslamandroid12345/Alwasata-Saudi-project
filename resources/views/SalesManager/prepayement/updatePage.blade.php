...
<form action="{{ route('sales.manager.updatePrepayment')}}" method="post" novalidate="novalidate">
    @csrf
        ...
        <label class="fnnn" style="width: 100%; display: block;background: #fff;color: #999;border-bottom: 2px solid #f0f0f0;" for="tab1">
            <span>
                ...
                <div class="row">
                    ...
                    <div class="col-4">
                        <a href="{{ route('sales.manager.fundingRequest',$id)}}">
                    ...
                    <div class="col-4">
                        <a href="{{ route('sales.manager.morPurRequest',$id)}}">
                            <button type="button" class="btn btn-block btn-outline-primary"><i class="fa fa-credit-card"></i>View Request</button>
                        </a>
                    </div>
...
@section('confirmMSG')
@include('SalesManager.prepayement.confirmSendingMsg')
@include('SalesManager.prepayement.confirmRejectMsg')
@include('SalesManager.prepayement.SendingModel')
@endsection
...
<script>
    ...
    $(document).ready(function() {
        ...
        if (status == 3) { //rejected payment
            document.getElementById('rejectWarning1').innerHTML = " <button type='button' class='close' data-dismiss='alert'>&times;</button> The prepayment has rejected and back to funding manager";
        ...
        if (status == 6) {
            document.getElementById('rejectWarning').innerHTML = " <button type='button' class='close' data-dismiss='alert'>&times;</button> The prepayment rejected from mortgage manager";
        ...
        modalConfirm(function(confirm) {
            if (confirm) {
                ...
                $.get("{{ route('sales.manager.rejectPrepayment')}}", {
                    ...
                    var url = '{{ route("sales.manager.updatePrepaymentPage", ":reqID") }}';
