    ...
    <div class="userFormsInfo">
        ...
        <div class="userFormsContainer mb-3">
                    ...
                    <div  id="tableAdminOption" class="row">
                        ...
                        <div class="col-12">
                            ...
                            <i class="fa fa-history i-20"></i></span>
                                ...
                                <input id="mobile" readonly name="mobile" type="tel" class="form-control @error('mobile') is-invalid @enderror" value="{{ $purchaseCustomer->mobile }}" onchange="changeMobile()" autocomplete="mobile" autofocus placeholder="05xxxxxxxx">
                                @error('mobile')
                                <small class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </small>
            ...
            @include('SalesManager.morPurReq.fundingJoint')
        </div>
    </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        /* if (status == 24) { //canceled
             document.getElementById('archiveWarning').innerHTML = " <button type='button' class='close' data-dismiss='alert'>&times;</button>  The request canceled.. <a href='{{ route('mortgage.manager.restMorPur',$id)}}'> Recancel?</a>";
             document.getElementById('archiveWarning').style.display = "block";
         }
    ...
    $(document).on('click', '#reject', function(e) {
        ...
        modalConfirm(function(confirm) {
            if (confirm) {
                ...
                $.post("{{ route('sales.manager.rejectMorPur')}}", {
                    id: id,
                    comment: comment
                }, function(data) {
                    var url = '{{ route("sales.manager.morPurRequest", ":reqID") }}';
