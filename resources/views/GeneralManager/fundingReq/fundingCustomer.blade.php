<div class="userFormsInfo  ">
    ...
    <div class="userFormsContainer mb-3">
            ...
            @if ($reqStatus == 12 || $reqStatus == 23 || $reqStatus == 32)
                <div  id="tableAdminOption" class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            <span class="item pointer span-20" id="record" data-id="regionip" type="button" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                                <i class="fa fa-history i-20" style="font-size: medium;"></i></span>
                            <label for="regionip" class="control-label mb-1">منطقة العميل</label>

                            <select id="regionip" onchange="this.size=1; this.blur();" onfocus='this.size=3;' onblur='this.size=1;' class="form-control @error('regionip') is-invalid @enderror" name="regionip">
                            ...
                            <div class="col-6" id="askary3">
                                ...
                                <div class="form-group">
                                    ...
                                    <select id="rank" onfocus='this.size=3;' onblur='this.size=1;' onchange='this.size=1; this.blur(); ' class="form-control select2-request @error('rank') is-invalid @enderror" name="rank">
                                        ...
                                        <option value="">---</option>
                                        <option value="جندي" @if (old('rank')=='جندي' ) selected="selected" @elseif ($purchaseCustomer->military_rank == 'جندي') selected="selected" @endif>جندي</option>
                                        <option value="رقيب" @if (old('rank')=='رقيب' ) selected="selected" @elseif ($purchaseCustomer->military_rank == 'رقيب') selected="selected" @endif>رقيب</option>
                ...
                <div  id="tableAdminOption" class="row">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <select disabled id="work" onchange="this.size=1; this.blur(); checkWork(this);" onfocus='this.size=3;' onblur='this.size=1;' class="form-control select2-request @error('work') is-invalid @enderror" name="work">
                    ...
                    <div class="col-6">
                        ...
                        <div class="form-group">
                            ...
                            <select disabled id="regionip" onchange="this.size=1; this.blur();" onfocus='this.size=3;' onblur='this.size=1;' class="form-control @error('regionip') is-invalid @enderror" name="regionip">
        ...
        @include('GeneralManager.fundingReq.fundingJoint')
    </div>
 ...
 function checkObligation(that) {
    ...
    $('#file-form').submit(function(event) {
        ...
        $.ajax({
            ...
            url: "{{ route('general.manager.uploadFile')}}",
            data: formData,
            type: 'post',
            async: false,
            processData: false,
            ...
            success: function(response) {
                ...
                $.each(response, function(i, value) { //for loop , I put data as value
                    ...
                    var url = '{{ route("general.manager.openFile", ":docID") }}';
                    url = url.replace(':docID', docID);
                    var url2 = '{{ route("general.manager.downFile", ":docID") }}';
    ...
    $(document).on('click', '#delete', function(e) {
        ...
        modalConfirm(function(confirm) {
            if (confirm) {
                ...
                $.post("{{ route('general.manager.deleFile') }}", {
                    id: id
    ...
    $(document).on('click', '#approve', function(e) {
        ...
        modalConfirm(function(confirm) {
            if (confirm) {
                ...
                $.post("{{ route('general.manager.approveFunding')}}", {
                    id: id,
                    comment: comment
                }, function(data) {

                    var url = '{{ route("general.manager.fundingRequest", ":reqID") }}';
    ...
    $(document).on('click', '#cancel', function(e) {
        ...
        modalConfirm(function(confirm) {
            if (confirm) {
                $.post("{{ route('general.manager.cancelFunding')}}", {
                    id: id
                }, function(data) {
    ...
    $(document).on('click', '#reject', function(e) {
        ...
        modalConfirm(function(confirm) {
            if (confirm) {
                ...
                $.post("{{ route('general.manager.rejectRequest')}}", {
                    id: id,
                    comment: comment
                }, function(data) {
                    var url = '{{ route("general.manager.fundingRequest", ":reqID") }}';
    ...
    $(document).on('click', '#approveTsaheel', function(e) {


        var id = $(this).attr('data-id');

        document.getElementById('approveMsg').innerHTML = "";
        document.getElementById('approveMsg').display = "none";


        $('#approveTsaheel').attr("disabled", true);
        document.getElementById('approveTsaheel').innerHTML = "<i class='fa fa-spinner fa-spin'></i>";
        document.getElementById('approveTsaheel').classList.remove('iconCircle');
        document.getElementById('approveTsaheel').classList.add('iconCircle2');



        $.get("{{ route('general.manager.aprroveTsaheel') }}", {
            id: id
        }, function(data) {
            ...
            if (data.status != 0) {
                ...
                document.getElementById('approveMsg').innerHTML = data.message + '!';
                document.getElementById('approveMsg').style.color = "green";
                document.getElementById('approveMsg').display = "block";
                document.getElementById('approveTsaheel').innerHTML = "<i class='fa fa-check'></i>";
                document.getElementById('undoTsaheelApprove').innerHTML = "<i class='fa fa-history'></i>";
                $('#approveTsaheel').attr("disabled", false);
                document.getElementById('approveTsaheel').classList.remove('iconCircle2');
                document.getElementById('approveTsaheel').classList.add('iconCircle');



            } else {
                document.getElementById('approveMsg').innerHTML = data.message + '!';
                document.getElementById('approveMsg').style.color = "red";
                document.getElementById('approveTsaheel').classList.remove('iconCircle2');
                document.getElementById('approveTsaheel').classList.add('iconCircle');
                document.getElementById('approveTsaheel').innerHTML = "<i class='fa fa-check'></i>";
                $('#approveTsaheel').attr("disabled", false);
            ...
            document.getElementById('approveMsg').innerHTML = "{{MyHelpers::admin_trans(auth()->user()->id, 'Try Again')}}";
    ...
    $(document).on('click', '#undoTsaheelApprove', function(e) {
        ...
        $('#undoTsaheelApprove').attr("disabled", true);
        document.getElementById('undoTsaheelApprove').innerHTML = "<i class='fa fa-spinner fa-spin'></i>";



        $.get("{{ route('general.manager.undoaprroveTsaheel') }}", {
            id: id
        }, function(data) {
            ...
            if (data.status != 0) {
                ...
                document.getElementById('approveMsg').style.color = "green";
                document.getElementById('approveMsg').display = "block";
                document.getElementById('undoTsaheelApprove').innerHTML = "";
                ...
                document.getElementById('undoTsaheelApprove').innerHTML = "<i class='fa fa-history'></i>";
                $('#undoTsaheelApprove').attr("disabled", false);
            }
    ...
    $(document).on('click', '#approveAqar', function(e) {
        ...
        $.get("{{ route('general.manager.aprroveAqar') }}", {
            id: id
        }, function(data) {
            ...
            if (data.status != 0) {
                ...
                document.getElementById('undoApprove').innerHTML = "<i class='fa fa-history'></i>";
                document.getElementById('approveAqar').classList.remove('iconCircle2');
                document.getElementById('approveAqar').classList.add('iconCircle');
    ...
    $(document).on('click', '#undoApprove', function(e) {
        ...
        $.get("{{ route('general.manager.undoAqarApprove') }}", {
            id: id
        }, function(data) {
