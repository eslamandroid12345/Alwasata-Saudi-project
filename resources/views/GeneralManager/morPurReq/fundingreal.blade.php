    ...
    <div class="addUser my-4 topRow ">
        <div class="userBlock d-flex align-items-center justify-content-center flex-wrap">
            <div class="addBtn">
                ...
                <small id="approveAqar" data-id="{{$id}}" title="اعتماد تقرير إفراغ العقار" class="iconCircle"><i class="fa fa-check"></i></small>

                @if ($purchaseCustomer->is_aqar_approved_by_generalManager == 0)
                    <small class="undoApprove" data-id="{{$id}}" style="font-size: medium; padding:5px;" title="التراجع عن التعميد" id="undoApprove"></small>
                @endif

                @if ($purchaseCustomer->is_aqar_approved_by_generalManager == 1)
                    <small class="undoApprove" data-id="{{$id}}" style="font-size: medium; padding:5px;" title="التراجع عن التعميد" id="undoApprove"><i class="fa fa-history"></i></small>
                @endif


                <small style="padding:15pt;font-weight: normal;" id="approveAqarMsg"></small>
            </div>
        </div>
    </div>
    <div class="userFormsContainer mb-3">
        <div class="userFormsDetails topRow">
        @if ($reqStatus == 23) <!-- Status mor pur of funding manager-->
