    ...
    <div class="myOrders">
        <div class="container">
            ...
            <div>
                ...
                <div class="row">
                    <div class="col-lg-9">
                        <form method="POST" action="{{ route('customer.password.sms') }}">
                            @csrf
                            ...
                            <div class="form-group row">
                                <div class="col-xs-12 col-sm-6 col-md-6 col-lg-12">
                                    ...
                                    <input id="inputmobileError" name="mobile" class="form-control" type="number" autocomplete="mobile" value="{{old('mobile')}}" placeholder="5xxxxxxxxx">
                    ...
                    <div class="col-lg-8">
                        <b>
                            <h4 style="font-width: bold;">ملاحظات :</h4>
                        </b>
                        <hr>
                        <ul>
                            {{--

                                <li>لديك كود صالح <a href="{{route('customer.sms.verify')}}">إضغط هنا</a></li>
