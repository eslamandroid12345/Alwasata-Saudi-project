            ...
            <div class="userFormsDetails topRow">
                ...
                <div class="row">
                    <div class="col-md-4 mb-3">
                        <div class="form-group">
                            <label>تاريخ الميلاد</label>
                            <input type='text' name="birth_hijri_caculater" value="" style="text-align: right;" class="form-control" placeholder="يوم/شهر/سنة" id="hijri_date_caculater" />
                    ...
                    <div class="col-md-4 mb-3">
                        <div class="form-group">
                            <label>صافي الراتب</label>
                            <input id="salary_caculater" name="salary_caculater" class="form-control  numberWithComma " value="" autocomplete="salary">
