...
<script type="text/javascript">
    ...
    function valueChanged2() {
        if ($('.detectionChecked').is(":checked"))
            ...
            document.getElementById('personal_salary_deduction_caculater').value = "";
            document.getElementById('personal_funding_months_calculater').value = "";

            document.getElementById('salary_deduction_calculater').value = "";
            document.getElementById('funding_months_calculater').value = "";
            $(".early").fadeOut();
        }
    ...
    function valueSave() {
        if ($('#save').is(":checked"))
            ...
            $(".save").slideUp();
            document.getElementById('joint_hijri_date_caculater').value = "";
            document.getElementById('joint_salary_caculater').value = "";
            document.getElementById('joint_work_caculater').value = "";
            document.getElementById('joint_rank_caculater').value = "";
            document.getElementById('joint_salary_source_caculater').value = "";

            $('#jointToggleMine').prop('checked', false);
            $('#jointInlineearlly').prop('checked', false);
            $('#joint_add_support_installment_to_salary_caculater').prop('checked', false);
            document.getElementById('joint_early_repayment_caculater').value = "";
...
<script>
    ...
    function hideLodingDiv() {
        ...
        $(".loading").fadeToggle().addClass("d-grid");
    ...
    function showLodingDiv() {
        ...
        $(".loading").fadeToggle().removeClass("d-grid");
...
<script>
    $(document).on('click', '#calculateSubmit', function(e) {
        ...
        document.querySelector('#calculateSubmit').innerHTML = "<i class='fa fa-spinner fa-spin'></i>{{ MyHelpers::guest_trans('Loading') }}";
        ...
        $.ajax({
            ...
            type: "POST",
            url: "{{route('all.calculaterApi2')}}",
            data: dataObj,
            success: function(data) {
                console.log(data);

                if (data.calcResult.length != 0) {
                    calculaterResultList(data.calcResult, result,data.flexibleSettings,data.personalSettings,data.propertySettings,data.extendedSettings);
                    showCalculaterResult();
                } else {
                    hideCalculaterResult();
                    swal({
                        text: "لاتوجد عروض تمويل",
                        icon: 'info',
    ...
    function emptyErrorsMsg() {
        ...
        $('#first_batch_mode_caculaterError').addClass("d-none");
    ...
    function calculaterResultList(data, dataOfInput,flexibleSettings,personalSettings,propertySettings,extendedSettings) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            if (data[i]['programs']['personalProgram'] != null && data[i]['programs']['personalProgram'] != '') {
                ...
                var div11 = $(' <div class="contREsult"></div>');
            ...
            if (data[i]['programs']['propertyProgram'] != null && data[i]['programs']['propertyProgram'] != '') {
            ...
            if (data[i]['programs']['flexibleProgram'] != null && data[i]['programs']['flexibleProgram'] != '') {
                ...
                var dataFlixable = data[i]['programs']['flexibleProgram']['raw'];
                    ...
                    var div15 = $(' <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" ><div class = "singleTypeResult" ><p> ' + dataFlixable['purchase_tax']['text'] + ': <span> ' + dataProperty['purchase_tax']['value'] + ' </span></p></div> </div> </div>');
            ...
            if (data[i]['programs']['extendedProgram'] != null && data[i]['programs']['extendedProgram'] != '') {
            ...
            if (data[i]['joint_programs'] != null && data[i]['joint_programs'] != '') {
                ...
                if (data[i]['joint_programs']['extendedProgram'] != null && data[i]['joint_programs']['extendedProgram'] != '') {
                    ...
                    var dataExtended = data[i]['joint_programs']['extendedProgram']['raw'];
                    //Flixable DETAILS
                    var div7 = $(' <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" ><div class = "singleTypeResult" ><p> ' + dataExtended['net_loan_total']['text'] + ': <span> ' + dataExtended['net_loan_total']['value'] + ' </span></p></div> </div> </div>');
                    var div8 = $('  <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" ><div class = "singleTypeResult" > <p> ' + dataExtended['personal_net_loan_total']['text'] + ': <span>' + dataExtended['personal_net_loan_total']['value'] + ' </span></p></div> </div> </div>');
                    var div9 = $('  <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" ><div class = "singleTypeResult" ><p> ' + dataExtended['flexible_loan_total']['text'] + ': <span> ' + dataExtended['flexible_loan_total']['value'] + ' </span></p></div> </div> </div>');
                    var div10 = $('  <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" ><div class = "singleTypeResult" ><p> ' + dataExtended['installment']['text'] + ': <span> ' + dataExtended['installment']['value'] + ' </span></p></div> </div> </div>');
                    var div11 = $('  <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" ><div class = "singleTypeResult" ><p> ' + dataExtended['installment_after_support']['text'] + ': <span> ' + dataExtended['installment_after_support']['value'] + ' </span></p></div> </div></div>');
                    // var div13 = $('  <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" ><div class = "singleTypeResult" ><p> ' + dataExtended['salary_deduction']['text'] + ': <span> ' + dataExtended['salary_deduction']['value'] + ' </span></p> </div> </div> </div>');
                    var div14 = $('  <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" ><div class = "singleTypeResult" ><p> ' + dataExtended['funding_years']['text'] + ': <span>' + dataExtended['funding_years']['value'] + ' </span></p></div> </div> </div>');
                    var div15 = $('  <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" > <div class = "singleTypeResult" > <p> ' + dataExtended['first_batch']['text'] + ': <span> ' + dataExtended['first_batch']['value'] + ' </span></p></div> </div> </div>');
                    //var div16 = $('  <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" > <div class = "singleTypeResult" > <p> ' + dataExtended['flexible_salary_deduction']['text'] + ': <span> ' + dataExtended['flexible_salary_deduction']['value'] + ' </span></p></div> </div> </div>');
                    var div17 = $('  <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" > <div class = "singleTypeResult" > <p> ' + dataExtended['vat']['text'] + ': <span> ' + dataExtended['vat']['value'] + ' </span></p></div> </div> </div>');
                    var div18 = $('  <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" > <div class = "singleTypeResult" > <p> ' + dataExtended['net_check_total']['text'] + ': <span> ' + dataExtended['net_check_total']['value'] + ' </span></p></div> </div> </div>');
                    var div19 = $('  <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" ><div class = "singleTypeResult" > <p> ' + dataExtended['personal_profit']['text'] + ': <span> ' + dataExtended['personal_profit']['value'] + ' </span></p></div> </div> </div>');
                    var div20 = $('  <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" > <div class = "singleTypeResult" > <p> ' + dataExtended['personal_profit_margin']['text'] + ': <span> ' + dataExtended['personal_profit_margin']['value'] + ' </span></p></div> </div> </div>');
                    var div21 = $('  <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" > <div class = "singleTypeResult" > <p> ' + dataExtended['profit']['text'] + ': <span> ' + dataExtended['profit']['value'] + ' </span></p></div> </div> </div>');
                    var div22 = $('  <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" > <div class = "singleTypeResult" > <p> ' + dataExtended['profit_margin']['text'] + ': <span> ' + dataExtended['profit_margin']['value'] + ' </span></p></div> </div> </div>');
                    var div23 = $('  <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" > <div class = "singleTypeResult" > <p> ' + dataExtended['quest']['text'] + ': <span> ' + dataExtended['quest']['value'] + ' </span></p></div> </div> </div>');
                    var div24 = $('  <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" > <div class = "singleTypeResult" > <p> ' + dataExtended['quest_amount']['text'] + ': <span> ' + dataExtended['quest_amount']['value'] + ' </span></p></div> </div> </div>');
                    var div25 = $('  <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" > <div class = "singleTypeResult" > <p> ' + dataExtended['quest_amount_with_vat']['text'] + ': <span> ' + dataExtended['quest_amount_with_vat']['value'] + ' </span></p></div> </div> </div>');
                    var div26 = $('  <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" > <div class = "singleTypeResult" > <p> ' + dataExtended['quest_check']['text'] + ': <span> ' + dataExtended['quest_check']['value'] + ' </span></p></div> </div> </div>');
                    var div27 = $('  <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" ><div class = "singleTypeResult" ><p> ' + dataExtended['check_total']['text'] + ': <span> ' + dataExtended['check_total']['value'] + ' </span></p></div> </div> </div>');
                    var div28 = $('  <div class=" col-lg-4 col-md-6 "> <div class = "BankMineResult" ><div class = "singleTypeResult" ><p> ' + dataExtended['min_net_loan_total']['text'] + ': <span> ' + dataExtended['min_net_loan_total']['value'] + ' </span></p></div> </div> </div>');

                    var div29 = $(' <div class="contREsult"></div>');
