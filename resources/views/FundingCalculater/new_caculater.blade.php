<div class="userFormsInfo">
        ...
        <div class="userBlock d-flex align-items-center justify-content-center flex-wrap">
            ...
            <div class="addBtn">
                <button class="print text-white Cloud" type="button">
                    <a href="{{ route('calculater.calculaterHistory',['id'=>$id])}}" class="text-white" target="_blank" style="text-decoration: none">
    ...
    @if(auth()->user()->role==0)
    @if ($reqStatus == 0 || $reqStatus == 1 || $reqStatus == 2 || $reqStatus == 4 || $reqStatus == 31 || (!empty ($payment) && $purchaseCustomer-> type == 'شراء-دفعة' && ($reqStatus == 6 || $reqStatus == 8 || $reqStatus == 13)) )
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                        ...
                        <select id="work_caculater" onchange="this.size=1; this.blur(); checkWork_caculater(this);" onfocus='this.size=3;' onblur='this.size=1;' data-live-search="true" class="selectpicker form-control @error('work') is-invalid @enderror" name="work_caculater">
                ...
                <div class="col-md-4 mb-3">
                    <div class="form-group">
                        ...
                        <select id="salary_source_caculater" onfocus='this.size=3;' onblur='this.size=1;' onchange='this.size=1; this.blur();' data-live-search="true" class="selectpicker form-control @error('salary_bank_id') is-invalid @enderror" name="salary_bank_id_caculater">
...
<!--        <div class="sahal_section" style="display: none;">
        ...
        <div class="col-md-12 mb-3 early">
            <div class="form-group">
                <label>مبلغ السداد المبكر</label>
                <input class="form-control  numberWithComma " placeholder="مبلغ السداد المبكر" value="{{ old('early_repayment_caculater') }}" name="early_repayment_caculater" id="early_repayment_calculater">
                <span class="text-danger" id="early_repayment_caculaterError" role="alert"> </span>
            </div>
        </div>
...
@include('FundingCalculater.caculaterResult')
