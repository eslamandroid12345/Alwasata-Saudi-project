...
@section('title')
{{ MyHelpers::admin_trans(auth()->user()->id,'Financial Reports') }}
@endsection
...
<div class="addUser my-4">
    <div class="userBlock d-flex align-items-center justify-content-between flex-wrap">
        <h3>{{ MyHelpers::admin_trans(auth()->user()->id,'Financial Reports') }}:</h3>
    </div>
</div>
<br>
            ...
            <div class="dashTable">
                <table class="table table-bordred table-striped data-table">
                    ...
                    <tr>
                        ...
                        <th style=" font-weight: 400; font-size:medium">{{ MyHelpers::admin_trans(auth()->user()->id,'profit cost') }}</th>
                        ...
                        <th style=" font-weight: 400; font-size:medium;text-align:center">{{ MyHelpers::admin_trans(auth()->user()->id,'comment') }}</th>
...
@section('updateModel')
@include('FundingManager.Request.filterReqs')
@include('FundingManager.Request.editCoulmn')
@endsection
...
<script>
    ...
    function saveit(reqID) {
        ...
        $.ajax({
            url: "{{ URL('fundingManager/updatebank') }}",
            type: "POST",
            data: {
                "_token": "{{csrf_token()}}",
                id: id,
    ...
    function savecost(reqID) {
        ...
        var reqprof = $("#reqprof" + reqID).text();
        ...
        $.ajax({
            url: "{{ URL('fundingManager/updatecost') }}",
            type: "POST",
            data: {
                "_token": "{{csrf_token()}}",
                id: id,
    ...
    function saveclass(data, reqID) {
        ...
        $.ajax({
            url: "{{ URL('fundingManager/updateclass') }}",
            type: "POST",
            data: {
                "_token": "{{csrf_token()}}",
                id: id,
    ...
    function savefunSour(data, reqID) {
        ...
        $.ajax({
            url: "{{ URL('fundingManager/updatefunsour') }}",
            type: "POST",
            data: {
                "_token": "{{csrf_token()}}",
                id: id,
    ...
    function saverealcity(data, reqID) {
        ...
        $.ajax({
            url: "{{ URL('fundingManager/updaterealcity') }}",
            type: "POST",
            data: {
                "_token": "{{csrf_token()}}",
                id: id,
    ...
    function saverealType(data, reqID) {
        ...
        $.ajax({
            url: "{{ URL('fundingManager/updaterealType') }}",
            type: "POST",
            data: {
                "_token": "{{csrf_token()}}",
                id: id,
    ...
    function savereal(reqID) {
        ...
        $.ajax({
            url: "{{ URL('fundingManager/updatereal') }}",
            type: "POST",
            data: {
                "_token": "{{csrf_token()}}",
                id: id,
    ...
    function savecomm(reqID) {
        ...
        $.ajax({
            url: "{{ URL('fundingManager/updatecomm') }}",
            type: "POST",
            data: {
                "_token": "{{csrf_token()}}",
                id: id,
    ...
    $(document).ready(function() {
        ...
        var dt = $('.data-table').DataTable({
            ...
            */
            ...
            serverSide: true,
            ajax: ({
                'url': "{{ url('fundingManager/underpage-datatable') }}",
                'method': 'POST',
                'headers': {
            ...
            columns: [
                ...
                },
                {
                    ...
                    className: "data-table-coulmn" ,
                    visible:{{($editCoulmns->where('coulmnName', 'mortgage_value')->count() > 0 || $editCoulmns-> count() == 0) ? 'true': 'false' }}
                ...
                },
                {
                    ...
                    className: "data-table-coulmn" ,
                    visible:{{($editCoulmns->where('coulmnName', 'salary_source')->count() > 0 || $editCoulmns-> count() == 0) ? 'true': 'false' }}
                ...
                {
                    data: 'recived_date_report',
                    name: 'recived_date_report',
                    className: "data-table-coulmn" ,
                ...
                },
                {
                    ...
                    className: "data-table-coulmn" ,
                    visible:{{($editCoulmns->where('coulmnName', 'real_cost')->count() > 0) ? 'true': 'false' }}
