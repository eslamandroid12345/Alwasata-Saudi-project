...
@include('HumanResource.Reports.form')
<div class="tableBar">
...
<script>
    ...
    var dt = $('.data-table').DataTable({
        ...
        serverSide: true,
        ajax: ({
           'url': "{{ route('HumanResource.daily.report')  }}",
           'method': 'GET',
           'data':function (data) {
        ...
        columns: [
            {data: 'idn',name: 'idn'},
            {data: 'name',name: 'name' },
            {data: 'total_recived_request',name: 'total_recived_request'},
            {data: 'received_basket',name: 'received_basket'},
            {data: 'star_basket',name: 'star_basket'},
            {data: 'followed_basket',name: 'followed_basket'},
            {data: 'archived_basket',name: 'archived_basket'},
            {data: 'sent_basket',name: 'sent_basket'},
            {data: 'completed_request',name: 'completed_request' },
            {data: 'updated_request',name: 'updated_request'},
            {data: 'opened_request',name: 'opened_request'},
            {data: 'received_task',name: 'received_task'},
            {data: 'replayed_task',name: 'replayed_task'},
            {data: 'move_request_from',name: 'move_request_from'},
            {data: 'move_request_to',name: 'move_request_to'},
            {data: 'action',name: 'action',orderable: !1,searchable: !1,sortable: !1,}
        ],
    ...
    function sum() {
        $.ajax({
            url: "{{ route('HumanResource.daily.report.sum') }}",
            type: "GET",
            data: {
