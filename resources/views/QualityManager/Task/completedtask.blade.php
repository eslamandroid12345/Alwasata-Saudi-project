...
@section('title')
{{ MyHelpers::admin_trans(auth()->user()->id,'completed Task') }}
@endsection
...
<div class="addUser my-4">
    <div class="userBlock d-flex align-items-center justify-content-between flex-wrap">
        <h3>{{ MyHelpers::admin_trans(auth()->user()->id,'completed Task') }}:</h3>
    </div>
</div>
    ...
    <div class="middle-screen">
        <h2 style=" text-align: center;font-size: 20pt;">{{ MyHelpers::admin_trans(auth()->user()->id,'No tasks') }}</h2>
    </div>
...
<script>
    ...
    $(document).ready(function() {
        var dt = $('.data-table').DataTable({
            ...
            serverSide: true,
            ajax: {
                'url': "{{ url('qualityManager/completetask_datatable') }}",
                'data': function(data) {
            ...
            columns: [
                ...
                {
                    data: 'content',
                    name: 'task_contents.content'
                },
                {
                    data: 'user_note',
                    name: 'task_contents.user_note'
                },
                {
                    data: 'action',
                    name: 'action'
