...
<div class="userFormsInfo  ">
    ...
    <div class="userFormsContainer mb-3">
        ...
        @if ($reqStatus == 23 )<!-- Status mor pur of gneral-->
            <div  id="tableAdminOption" class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input id="fundingpersonal" name="fundingpersonal" type="number" class="form-control @error('fundingpersonal') is-invalid @enderror" value="{{ $purchaseFun->personalFun_cost }}" autocomplete="fundingpersonal">
                ...
                <div class="col-5">
                    <div class="form-group">
                        ...
                        <input id="monthIn" name="monthIn" type="number" class="form-control" value="{{ $purchaseFun->monthly_in }}" autocomplete="monthIn" readonly>
                    </div>
