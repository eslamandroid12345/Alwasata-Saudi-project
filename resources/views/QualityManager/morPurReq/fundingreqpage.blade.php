...
@section('customer')
    ...
    @include('QualityManager.fundingReq.progress')
    <br>
    ...
    <form action="{{ route('general.manager.updateFunding')}}" method="post" novalidate="novalidate">
                            ...
                            <div class="tableUserOption downOrder">
                                <div class="addBtn orderBtns text-center">
                                    ...
                                    <button id="cancel" class="mr-3 warning item" role="button" type="button">
                                        <a href="{{ route('general.manager.cancelMorPur',$id)}}" target="_blank" class="text-white" style="text-decoration: none">
        ...
        <section class="new-content">
            <div class="container-fluid">
                ...
                <span>
                     @include('QualityManager.morPurReq.fundingReqInfo')
                </span>
                    </label>
...
@section('updateModel')
    @include('QualityManager.morPurReq.req_records')
    @include('QualityManager.morPurReq.documentModel')
@endsection

@section('confirmMSG')
    @include('QualityManager.morPurReq.confirmationMsg')
    @include('QualityManager.morPurReq.confirmSendingMsg')
    @include('QualityManager.morPurReq.confirmRejectMsg')
@endsection
