...
<!--For Content-->
@if ($tasks->sentid == auth()->user()->id)
<form action="{{ route('all.update_task_content')}}" method="post" class="">
  @csrf
  ...
  <form action="{{ route('all.update_task_note')}}" method="post" class="">
    @csrf
        ...
        <div class="card text-center">
          ...
          <div class="card-footer">
            <div class="row">
              ...
              <div class="col-3">
                <a href="{{route('quality.manager.completeTask',$id)}}" class="btn-block btn-success">
              ...
              <div class="col-3">
                <a href="{{route('quality.manager.notcompleteTask',$id)}}" class="btn-block btn-danger">
                  <button type="button" class="btn" style="color:white;">
              ...
              <a href="{{route('quality.manager.canceleTask',$id)}}">
