                    ...
                    <div class="row col-12">
                        <div class="col-6">
                            ...
                            <span class="item pointer span-20" id="record" data-id="comment" type="button" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                                <i class="fa fa-history i-20" style="font-size: medium;"></i></span>
                                <label for="comment" class="control-label mb-1">ملاحظة استشاري المبيعات</label>
                                <input readonly style="padding: 30px 10px; " name="agent_note" type="text" class="form-control" value="{{ $purchaseCustomer->comment }}">
                            </div>
                        </div>
                        <input type="hidden" name="survey_id" value="{{ $servQuestion->serv_id ?? null }}">
                        <div class="col-6">
                            <div class="form-group">
                                <label for="comment" class="control-label mb-1">صحة ملاحظة الاستشاري</label>
                                <select class="form-control" name="agent_note_status">
                                    @if(!empty($servQuestion))
                                        <option value="">----</option>
                                        <option value="1" {{$servQuestion->answer == 1 ?  'selected' : '' }}>نعم</option>
                                        <option value="2" {{$servQuestion->answer == 2 ?  'selected' : '' }}>لا</option>
                                    @else
