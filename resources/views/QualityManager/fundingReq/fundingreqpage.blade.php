...
<form action="{{ route('quality.manager.updateFunding')}}" method="post" novalidate="novalidate" id="frm-update">
    @csrf
                ...
                <div class="col-lg-10">
                    <div class="tableUserOption   flex-wrap justify-content-md-end  justify-content-center  ">
                        <div class="addBtn  mt-lg-0 mt-3 orderBtns spansBtn">
                            ...
                            <a href="{{ route('quality.manager.add_needToBeTurnedReq',['id'=> $quID])}}" title="إضافة الطلب لسلة التحويل" class="text-white" style="text-decoration: none">
                                <button class="mr-3 Gold" type="button" role="button">
                                    <span class="toggle" data-toggle="tooltip" data-placement="top" title="إضافة الطلب لسلة التحويل">
                                        <i class="fa fa-retweet mr-2"></i>
                                        <span> إضافة الطلب لسلة التحويل</span>
                                    </span>
                                </button>
                            </a>
                            @endif
        ...
        <div class="topRow">
            <div class="row align-items-center text-center text-md-left">
                <div class="col-lg-2">
                    <div class="selectAll">
                        <div class="form-check pl-0">
                            <label class="form-check-label">ارتباطات الطلب</label>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-10">
                    <div class="tableUserOption   flex-wrap justify-content-md-end  justify-content-center  ">
                        <div class="addBtn  mt-lg-0 mt-3 orderBtns spansBtn">
                                ...
                                <button class="mr-3 Cloud" type="button" role="button" id="tasks" data-id="{{$quID}}">
                                    <span class="toggle" data-toggle="tooltip" data-placement="top" title="فتح المهام المرتبطة بالطلب">
                                        <i class="fa fa-comments mr-2"></i>
                                        <span> المهام</span>
                                    </span>
                                </button>

                                <button class="mr-3 Cloud" type="button" role="button" id="questions" data-id="{{$quID}}">
                                    <span class="toggle" data-toggle="tooltip" data-placement="top" title="فتح استبيانة الطلب">
        ...
        <div class="container-fluid">
                        ...
                        <div class="tab-body">
                            ...
                            <div class="row hdie-show display-flex" id="content4-cont">
                                <div class="col-lg-12   mb-md-0">
                                    @include('QualityManager.fundingReq.fundingCustomer')
                                </div>
                            </div>

                            <div class="row hdie-show display-none" id="content1-cont">
                                <div class="col-lg-12 mb-5 mb-md-0">
                                    @include('QualityManager.fundingReq.document')
                                </div>
                            </div>
                            ...
                            <div class="row hdie-show display-none" id="content2-cont">
                                <div class="col-lg-12 mb-5 mb-md-0">
                                    @include('QualityManager.fundingReq.fundingInfo')
                                </div>
                            </div>

                            <div class="row hdie-show display-none" id="content3-cont">
                                <div class="col-lg-12 mb-5 mb-md-0">
                                    @include('QualityManager.fundingReq.fundingreal')
                                </div>
                            </div>
                            ...
                            <div class="row hdie-show display-none" id="content5-cont">
                                <div class="col-lg-12   mb-md-0">
                                    @include('QualityManager.fundingReq.tsaheel')
                                </div>
                            </div>
                            @endif
                            ...
                            <div class="row hdie-show display-none" id="content5-cont">
                                <div class="col-lg-12   mb-md-0">
                                    @include('QualityManager.fundingReq.updatePage')
                                </div>
                            </div>
                            @endif
                        </div>
            ...
            <div>
                <label style="width: 100%; display: block;" for="tab1">
                    <span>
                        @include('QualityManager.fundingReq.fundingReqInfo')
                    </span>
                </label>
            </div>
...
@endsection
@section('updateModel')
@include('QualityManager.fundingReq.req_records')
@include('QualityManager.fundingReq.documentModel')
@endsection

@section('confirmMSG')
@include('QualityManager.fundingReq.confirmationMsg')
@include('QualityManager.fundingReq.confirmSendingMsg')
@include('QualityManager.fundingReq.confirmRejectMsg')
@endsection
