                    ...
                    <div class="col-12 mb-4">
                        <div class="tableUserOption flex-wrap justify-content-md-end  justify-content-center downOrder text-center" style="display: block">
                            <div class="addBtn  mt-lg-0 mt-3 orderBtns text-center">
                                <button class="upload text-center mr-3 green item" id="upload" type="button" data-toggle="modal" data-target="#myModal1">
                                    <i class="fas fa-cloud-upload-alt"></i>
                                    {{MyHelpers::admin_trans(auth()->user()->id, 'file')}}
                                </button>
                        
                                <small style="color:#e60000" class="d-none document_missedFileds missedFileds">الحقل مطلوب</small>
            ...
            @else
                <div class="row">
                    <div class="col-12 mb-4">
                        <div class="tableUserOption flex-wrap justify-content-md-end  justify-content-center downOrder text-center" style="display: block">
                            <div class="addBtn  mt-lg-0 mt-3 orderBtns text-center">
                                <button disabled style="cursor: not-allowed" class="upload text-center mr-3 green item" id="upload" type="button" data-toggle="modal" data-target="#myModal1">
                                    <i class="fas fa-cloud-upload-alt"></i>
                                    {{MyHelpers::admin_trans(auth()->user()->id, 'file')}}
                                </button>
                            </div>
                                    ...
                                    @foreach($documents as $document)
                                        ...
                                        <span class="item pointer"  data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'Open') }}">
                                            ...
                                            <a href="{{ route('agent.downFile',$document->id)}}" target="_blank"> <i class="fa fa-download"></i></a>
                                                    ...
                                                    <span disabled class="item pointer" id="delete" data-id="{{$document->id}}" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'Delete') }}">
                                            <i class="fa fa-trash"></i>
                                        </span>
                                                </div>
                                            </td>
