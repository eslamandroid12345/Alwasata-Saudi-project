            ...
            <div id="tableAdminOption" class=" row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        <span class="item pointer span-20" id="record" data-id="agent_identity_number" type="button" data-toggle="tooltip" data-placement="top" title="@lang('language.records')">
                            <i class="fa fa-history i-20" style="font-size: medium;"></i></span>
                        <label for="Customer" class="control-label mb-1">@lang('attributes.agent_identity_number')</label>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type='text' name="birth_hijri" value="{{ $purchaseCustomer->birth_date_higri }}" style="text-align: right;" class="form-control birth_hijri_missedFiledInput FiledInput" placeholder="يوم/شهر/سنة" id="hijri-date" />
                    </div>
                </div>
                <div class="col-6">
                    <div class="form-group">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input id="age_years" name="age_years" type="number" class="form-control age_years_missedFiledInput FiledInput @error('age_years') is-invalid @enderror" value="{{ old('age_years',$purchaseCustomer->age_years) }}" autocomplete="age_years" autofocus>
                        <small style="color:#e60000" class="d-none age_years_missedFileds missedFileds">الحقل مطلوب</small>
