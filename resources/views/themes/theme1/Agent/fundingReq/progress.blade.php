...
<ul class="progressbar">
    ...
    @if ($purchaseCustomer-> type == 'شراء' || $purchaseCustomer-> type == 'رهن') 
    ...
    @elseif ($purchaseCustomer-> type == 'رهن' || $purchaseCustomer-> type == 'تساهيل')
    ...
    @elseif (($purchaseCustomer-> statusReq == 30 || $purchaseCustomer-> statusReq == 31) && $purchaseCustomer-> type == 'تساهيل')
    <li class="active">{{ MyHelpers::admin_trans(auth()->user()->id,'Sales Agent') }}</li>
    ...
    @elseif (($purchaseCustomer-> statusReq == 32 || $purchaseCustomer-> statusReq == 33 || $purchaseCustomer-> statusReq == 34 || $purchaseCustomer-> statusReq == 35) && $purchaseCustomer-> type == 'تساهيل')
    <li class="active">{{ MyHelpers::admin_trans(auth()->user()->id,'Sales Agent') }}</li>
    <li class="active">{{ MyHelpers::admin_trans(auth()->user()->id,'Mortgage Manager') }}</li>
    <li class="active">{{ MyHelpers::admin_trans(auth()->user()->id,'General Manager') }}</li>
