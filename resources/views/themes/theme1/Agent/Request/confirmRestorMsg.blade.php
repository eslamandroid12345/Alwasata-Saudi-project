    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="mediumModalLabel">{{ MyHelpers::admin_trans(auth()->user()->id,'Are you sure want to restore it?') }}</h5>
            ...
            <div class="modal-footer">
                ...
                <button type="submit" id="modal-btn-si6" class="btn btn-info">{{ MyHelpers::admin_trans(auth()->user()->id,'Restore To Recived Reqs') }}</button>
            </div>
        </div>
    </div>
</div>
