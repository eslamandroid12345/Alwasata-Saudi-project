                ...
                <div class="col-12 mb-4">
                    <div class="tableUserOption flex-wrap justify-content-md-end  justify-content-center downOrder text-center" style="display: block">
                        <div class="addBtn  mt-lg-0 mt-3 orderBtns text-center">
                            <button {{($reqStatus == 19) ? '' : 'disabled' }} class="upload text-center mr-3 green item" id="upload" type="button" data-toggle="modal" data-target="#myModal1">
                                    ...
                                    <tr id="{{$document->id}}">
                                        ...
                                        <td>
                                            ...
                                            <span class="item pointer"  data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'Open') }}">
                                                ...
                                                <span {{($reqStatus == 19) ? '' : 'disabled' }} class="item pointer" id="delete" data-id="{{$document->id}}" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'Delete') }}">
