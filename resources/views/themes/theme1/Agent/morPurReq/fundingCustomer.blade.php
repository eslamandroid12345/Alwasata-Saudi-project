    ...
    <div class="userFormsContainer mb-3">
        <div class="userFormsDetails topRow">
            ...
            <div id="tableAdminOption" class=" row">
                ...
                <div class="col-6">
                    <span class="item pointer span-20" id="record" data-id="birth_date" type="button" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                        <i class="fa fa-history i-20" style="font-size: medium;"></i></span>
                ...
                <div class="col-6">
                    <span class="item pointer span-20" id="record" data-id="birth_hijri" type="button" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                        <i class="fa fa-history i-20" style="font-size: medium;"></i></span>
        ...
        @include('Agent.morPurReq.fundingJoint')
    </div>
</div>
