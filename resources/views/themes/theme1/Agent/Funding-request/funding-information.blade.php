 ...
 <div class="portlet">
    ...
    <div class="portlet__head">
      ...
      <div class="portlet__head-label">بيانات التمويل</div>
    </div>
    <!-- end::portlet__head  -->
    <!-- begin::portlet__body  -->
            ...
            <div id="tableAdminOption" class=" row">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="form-group">
                        <label for="product_code" class="control-label mb-1">
                            ...
                            نوع المنتج</label>
                        <select id="product_code" onfocus='this.size=3;' onblur='this.size=1;' onchange='this.size=1; this.blur();' class="form-control selectpicker @error('product_code') is-invalid @enderror" data-live-search="true" value="{{ old('product_code') }}" name="product_code">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="form-group">
                        <label for="funding_source" class="control-label mb-1">
                            ...
                            {{ MyHelpers::admin_trans(auth()->user()->id,'funding source') }}</label>
                        <select id="funding_source" onfocus='this.size=3;' onblur='this.size=1;' onchange='this.size=1; this.blur();' class="form-control funding_source_missedFiledInput FiledInput selectpicker @error('funding_source') is-invalid @enderror" data-live-search="true" value="{{ old('funding_source') }}" name="funding_source" >
                ...
                <div @if ($show_funding_source) class="col-lg-4 col-sm-6" @else class="col-lg-4 col-sm-6" @endif>
                    <div class="form-group">
                        <label for="fundingdur" class="control-label mb-1">
                            ...
                            {{ MyHelpers::admin_trans(auth()->user()->id,'funding duration') }}</label>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="form-group">
                        <label for="fundingpersonalp" class="control-label mb-1">
                            ...
                            {{ MyHelpers::admin_trans(auth()->user()->id,'presentage') }}</label>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="form-group">
                        <label for="fundingreal" class="control-label mb-1">
                            ...
                            {{ MyHelpers::admin_trans(auth()->user()->id,'cost real estate funding') }}</label>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="form-group">
                        <label for="fundingrealp" class="control-label mb-1">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="form-group">
                        <label for="flexiableFun_cost" class="control-label mb-1">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="form-group">
                        <label for="extendFund_cost" class="control-label mb-1">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="form-group">
                        <label for="personal_salary_deduction" class="control-label mb-1">
                            <span class="item pointer span-20" id="record" data-id="personal_salary_deduction" type="button" data-toggle="tooltip" data-placement="top" title="{{ MyHelpers::admin_trans(auth()->user()->id,'records')}}">
                             ...
                             (شخصي){{ MyHelpers::admin_trans(auth()->user()->id,'deduction presentage') }}</label>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="form-group">
                        <label for="personal_monthly_installment" class="control-label mb-1">
                            ...
                            (شخصي){{ MyHelpers::admin_trans(auth()->user()->id,'monthly installment') }}</label>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="form-group">
                        <label for="dedp" class="control-label mb-1">
                            ...
                            {{ MyHelpers::admin_trans(auth()->user()->id,'deduction presentage') }}</label>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="form-group">
                        <label for="monthIn" class="control-label mb-1">
                            ...
                            {{ MyHelpers::admin_trans(auth()->user()->id,'monthly installment') }}</label>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="form-group">
                        <label for="monthly_installment_after_support" class="control-label mb-1">
                            ...
                            {{ MyHelpers::admin_trans(auth()->user()->id,'monthly installment') }} بعد الدعم</label>
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="form-group">
                        <label for="product_code" class="control-label mb-1">
                            ...
                            نوع المنتج</label>
                        <select disabled id="product_code" onfocus='this.size=3;' onblur='this.size=1;' onchange='this.size=1; this.blur();' class="form-control selectpicker @error('product_code') is-invalid @enderror" data-live-search="true" value="{{ old('product_code') }}" name="product_code">
                ...
                <div class="col-lg-4 col-sm-6">
                    <div class="form-group">
                        <label for="funding_source" class="control-label mb-1">
                            ...
                            {{ MyHelpers::admin_trans(auth()->user()->id,'funding source') }}</label>
                        <select disabled id="funding_source" onfocus='this.size=3;' onblur='this.size=1;' onchange='this.size=1; this.blur();' class="form-control selectpicker @error('funding_source') is-invalid @enderror" data-live-search="true" value="{{ old('funding_source') }}" name="funding_source">
