  ...
  <div class="col-lg-7 offset-md-3">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form action="{{ route('admin.addCustomer')}}" method="post">
          @csrf
          ...
          <div id="SalesAgent" class="form-group" >
            <label for="SalesAgent" class="control-label mb-1"> {{ MyHelpers::admin_trans(auth()->user()->id,'Sales Agent') }}</label>
            <select id="SalesAgent" onfocus='this.size=3;' onblur='this.size=1;' onchange='this.size=1; this.blur();' class="form-control @error('SalesAgent') is-invalid @enderror" value="{{ old('SalesAgent') }}" name="SalesAgent">
