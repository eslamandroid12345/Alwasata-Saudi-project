                   ...
                   {{-- <div class="col-6">
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <textarea id="private_notes" name="private_notes"  rows="3" cols="50" class="form-control @error('private_notes') is-invalid @enderror" autocomplete="private_notes" autofocus placeholder=""
                            >{{ old('private_notes',$purchaseCustomer->private_notes) }}</textarea>
                            @error('private_notes')
                    ...
                    <div class="col-6">
                        <div class="form-group">
                            ...
                            <label for="collaborator_notes" class="control-label mb-1">ملاحظة الوساطة</label>
