...
<head>
    ...
    <script src="{{ url('interface_style/js/plugins/sweetalert2.js') }}"></script>
                ...
                <div class="row">
                    ...
                    <header class="header" style="font-weight:bold; font-size:large ;float:left;">
                        ...
                        <ul class="menu pull-right">
                            ...
                            <li><a href="{{route('allProperties')}}" title="{{ MyHelpers::guest_trans('properties') }}">{{ MyHelpers::guest_trans('properties') }}</a></li>
                            @if(auth()->guard('customer')->check())
                                <li><a href="{{route('customer.account')}}" title="{{ MyHelpers::guest_trans('my account') }}">{{ MyHelpers::guest_trans('my account') }} <i class="fa fa-user"></i> </a></li>
                            @else
{{--
                                <li><a href="{{route('customer.login')}}" title="{{ MyHelpers::guest_trans('login') }}">{{ MyHelpers::guest_trans('login') }}</a></li>
--}}
                            @endif
                        </ul>
        ...
        <!-- Footer -->
        @include('Proper.Frontend.includes.footer')
        <!-- End Footer -->
    </div>
