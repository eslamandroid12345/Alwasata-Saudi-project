            ...
            <div class="container-fluid">
                ...
                <div class="card">
                    <div class="card-header">
                        التعديل على صلاحية تخصيص نتائج البرامج 
                    </div>

                    <div class="card-body card-block">
                        <form action="{{route('admin.formula.results.agents')}}" id="formPost" method="post" class="">
                            @csrf
                            <div class="row d-flex">
                                ...
                                <div class="col-lg-2">
                                    ...
                                    <button type="submit" id="submit-btn" class="btn btn-success"><i id="updatePremtion" class="fas fa-save p-1 text-white"  style="font-size:15px;color:blue" title="حفظ التعديلات"></i>حفظ التعديلات</button>
                                </div>
                            </div>
                        </form>
                    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#submit-btn').click(function(e){
                e.preventDefault();
                $.ajax({
                    url: "{{route('admin.formula.results.agents')}}",
                    type: "POST",
        ...
        $("#agents").on("select2:unselect", function (evt) {
