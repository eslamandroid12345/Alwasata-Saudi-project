                ...
                <div class="col-lg-12">
                    <div class="card">
                        <div class="card-header">
                            {{ MyHelpers::admin_trans(auth()->user()->id,'Add New Question') }}
                        </div>
                        <div class="card-body card-block">
                            <form action="{{route('admin.settings.form.savequestions')}}" method="post" class="">
                                @csrf
                                <div id="stutusdiv" class="form-group">
                                    ...
                                    <input type="text" class="form-control"  name="question" id="" placeholder="اكتب السؤال">
