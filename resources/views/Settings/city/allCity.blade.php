...
@section('title')
{{ MyHelpers::admin_trans(auth()->user()->id,'Settings') }} {{ MyHelpers::admin_trans(auth()->user()->id,'Cities') }}
@endsection
...
<div class="addUser my-4">
    <div class="userBlock d-flex align-items-center justify-content-between flex-wrap">
        <h3> {{ MyHelpers::admin_trans(auth()->user()->id,'Settings') }} {{ MyHelpers::admin_trans(auth()->user()->id,'Cities') }} :</h3>
            ...
            <div class="col-lg-9">
                <div class="tableUserOption  flex-wrap ">
                    ...
                    <div class="addBtn col-md-5 mt-lg-0 mt-3">
                        <a href="{{route('admin.addcityPage')}}">
...
<div class="middle-screen">
    <h2 style=" text-align: center;font-size: 20pt;">{{ MyHelpers::admin_trans(auth()->user()->id,'No Cities') }}
        <br>
        <div class="addBtn col-md-5 mt-lg-0 mt-3">
            <a href="{{route('admin.addcityPage')}}">
                <button class="mr-2 Cloud">
...
@section('updateModel')
@include('Settings.city.updateCity')
@include('Settings.city.confirmDeleteMsg')
@endsection
...
<script>
    $(document).ready(function() {
        var dt = $('.data-table').DataTable({
            ...
            processing: true,
            serverSide: true,
            ajax: "{{ url('admin/settingCity-datatable') }}",
            columns: [
    ...
    $(document).on('click', '#edit', function(e) {
        ...
        $.get("{{route('admin.getcity')}}", {
            ...
            if (data.status != 0) {
                ...
                $('#frm-update').find('#id').val(data.city.id);
                $('#frm-update').find('#city').val(data.city.value);
