(function (n, t) {
    ...
    function fu(n, t) {
        for (var i in t) pt(t, i) && (n[i] = t[i]);
        return pt(t, "toString") && (n.toString = t.toString), pt(t, "valueOf") && (n.valueOf = t.valueOf), n
    }

    function ki(n, t, i, r) {
        return hs(n, t, i, r, !0).utc()
    }
    ...
    function o(n) {
        return n._pf == null && (n._pf = il()), n._pf
    }
    ...
    function eu(n) {
        var t = ki(NaN);
        return n != null ? fu(o(t), n) : o(t).userInvalidated = !0, t
    }
    ...
    function vf(n, t) {
        var u, i, r;
        if (y(t._isAMomentObject) || (n._isAMomentObject = t._isAMomentObject), y(t._i) || (n._i = t._i), y(t._f) || (n._f = t._f), y(t._l) || (n._l = t._l), y(t._strict) || (n._strict = t._strict), y(t._tzm) || (n._tzm = t._tzm), y(t._isUTC) || (n._isUTC = t._isUTC), y(t._offset) || (n._offset = t._offset), y(t._pf) || (n._pf = o(t)), y(t._locale) || (n._locale = t._locale), af.length > 0) for (u in af) i = af[u], r = t[i], y(r) || (n[i] = r);
        return n
    }
    ...
    function ni(n) {
        return n instanceof or || n != null && n._isAMomentObject != null
    }
    ...
    function sr(n, t) {
        var i;
        return n && (i = y(t) ? hi(n) : oo(n, t), i && (ou = i)), ou._abbr
    }

    function oo(n, t) {
        return t !== null ? (t.abbr = n, si[n] = si[n] || new uo, si[n].set(t), sr(n), si[n]) : (delete si[n], null)
    }
    ...
    function b(n) {
        return typeof n == "string" ? hr[n] || hr[n.toLowerCase()] : undefined
    }
    ...
    function di(n, t) {
        return function (i) {
            return i != null ? (ho(this, n, i), r.updateOffset(this, t), this) : su(this, n)
        }
    }
    ...
    function co(n, t) {
        var i;
        if (typeof n == "object") for (i in n) this.set(i, n[i]); else if (n = b(n), wt(this[n])) return this[n](t);
        return this
    }
    ...
    function fl(n) {
        for (var i = n.match(lo), t = 0, r = i.length; t < r; t++) i[t] = gi[i[t]] ? gi[i[t]] : ul(i[t]);
        return function (u) {
            var f = "";
    ...
    function wf(n, t) {
        return n.isValid() ? (t = ao(t, n.localeData()), pf[t] = pf[t] || fl(t), pf[t](n)) : n.localeData().invalidDate()
    }
    ...
    function i(n, t, i) {
        df[n] = wt(t) ? t : function (n) {
            return n && i ? i : t
        }
    }

    function ol(n, t) {
        return pt(df, n) ? df[n](t._strict, t._locale) : new RegExp(sl(n))
    }

    function sl(n) {
        return pu(n.replace("\\", "").replace(/\\(\[)|\\(\])|\[([^\]\[]*)\]|\\(.)/g, function (n, t, i, r, u) {
            return t || i || r || u
        }))
    }
    ...
    function hl(n, t, i) {
        t != null && pt(gf, n) && gf[n](t, i._a, i, n)
    }
    ...
    function al(n, t) {
        return oi(this._months) ? this._months[n.month()] : this._months[te.test(t) ? "format" : "standalone"][n.month()]
    }

    function vl(n, t) {
        return oi(this._monthsShort) ? this._monthsShort[n.month()] : this._monthsShort[te.test(t) ? "format" : "standalone"][n.month()]
    }

    function yl(n, t, i) {
        var r, u, f;
        for (this._monthsParse || (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = []), r = 0; r < 12; r++) if ((u = ki([2e3, r]), i && !this._longMonthsParse[r] && (this._longMonthsParse[r] = new RegExp("^" + this.months(u, "").replace(".", "") + "$", "i"), this._shortMonthsParse[r] = new RegExp("^" + this.monthsShort(u, "").replace(".", "") + "$", "i")), i || this._monthsParse[r] || (f = "^" + this.months(u, "") + "|^" + this.monthsShort(u, ""), this._monthsParse[r] = new RegExp(f.replace(".", ""), "i")), i && t === "MMMM" && this._longMonthsParse[r].test(n)) || i && t === "MMM" && this._shortMonthsParse[r].test(n) || !i && this._monthsParse[r].test(n)) return r
    }

    function go(n, t) {
        var i;
        return n.isValid() ? typeof t == "string" && (t = n.localeData().monthsParse(t), typeof t != "number") ? n : (i = Math.min(n.date(), ne(n.year(), t)), n._d["set" + (n._isUTC ? "UTC" : "") + "Month"](t, i), n) : n
    }

    function ns(n) {
        return n != null ? (go(this, n), r.updateOffset(this, !0), this) : su(this, "Month")
    }
    ...
    function wl(n) {
        return this._monthsParseExact ? (pt(this, "_monthsRegex") || rs.call(this), n ? this._monthsShortStrictRegex : this._monthsShortRegex) : this._monthsShortStrictRegex && n ? this._monthsShortStrictRegex : this._monthsShortRegex
    }

    function bl(n) {
        return this._monthsParseExact ? (pt(this, "_monthsRegex") || rs.call(this), n ? this._monthsStrictRegex : this._monthsRegex) : this._monthsStrictRegex && n ? this._monthsStrictRegex : this._monthsRegex
    }
    ...
    function ie(n) {
        var i, t = n._a;
        return t && o(n).overflow === -2 && (i = t[kt] < 0 || t[kt] > 11 ? kt : t[st] < 1 || t[st] > ne(t[k], t[kt]) ? st : t[a] < 0 || t[a] > 24 || t[a] === 24 && (t[d] !== 0 || t[dt] !== 0 || t[ci] !== 0) ? a : t[d] < 0 || t[d] > 59 ? d : t[dt] < 0 || t[dt] > 59 ? dt : t[ci] < 0 || t[ci] > 999 ? ci : -1, o(n)._overflowDayOfYear && (i < k || i > st) && (i = st), o(n)._overflowWeeks && i === -1 && (i = cl), o(n)._overflowWeekday && i === -1 && (i = ll), o(n).overflow = i), n
    }

    function us(n) {
        r.suppressDeprecationWarnings === !1 && typeof console != "undefined" && console.warn && console.warn("Deprecation warning: " + n)
    }
    ...
    function fs(n) {
        var t, r, e = n._i, i = dl.exec(e) || gl.exec(e), s, f, u, h;
        if (i) {
            for (o(n).iso = !0, t = 0, r = wu.length; t < r; t++) if (wu[t][1].exec(i[1])) {
                f = wu[t][0];
                s = wu[t][2] !== !1;
                break
            }
            ...
            if (i[3]) {
                for (t = 0, r = ue.length; t < r; t++) if (ue[t][1].exec(i[3])) {
                    u = (i[2] || " ") + ue[t][0];
                    break
                }
                if (u == null) {
            ...
            if (i[4]) if (na.exec(i[4])) h = "Z"; else {
                n._isValid = !1;
                return
            }
            n._f = f + (u || "") + (h || "");
    ...
    function ku(n, t, i) {
        var r = 7 + t - i, u = (7 + bu(n, 0, r).getUTCDay() - t) % 7;
        return -u + r - 1
    }

    function os(n, t, i, r, u) {
        var s = (7 + i - r) % 7, h = ku(n, r, u), f = 1 + 7 * (t - 1) + s + h, e, o;
        return f <= 0 ? (e = n - 1, o = ar(e) + f) : f > ar(n) ? (e = n + 1, o = f - ar(n)) : (e = n, o = f), {
            year: e,
            dayOfYear: o
        }
    }
    ...
    function vr(n, t, i) {
        var e = ku(n.year(), t, i), r = Math.floor((n.dayOfYear() - e - 1) / 7) + 1, f, u;
        return r < 1 ? (u = n.year() - 1, f = r + li(u, t, i)) : r > li(n.year(), t, i) ? (f = r - li(n.year(), t, i), u = n.year() + 1) : (u = n.year(), f = r), {
            week: f,
            year: u
        }
    }
    ...
    function ha(n) {
        if (!n._d) {
            var t = so(n._i);
            n._a = io([t.year, t.month, t.day || t.date, t.hour, t.minute, t.second, t.millisecond], function (n) {
    ...
    function la(n) {
        var t = n._i;
        t === undefined ? n._d = new Date(r.now()) : uu(t) ? n._d = new Date(+t) : typeof t == "string" ? ia(n) : oi(t) ? (n._a = io(t.slice(0), function (n) {
            return parseInt(n, 10)
        }), ee(n)) : typeof t == "object" ? ha(n) : typeof t == "number" ? n._d = new Date(t) : r.createFromInputFallback(n)
    }

    function hs(n, t, i, r, u) {
        var f = {};
        return typeof i == "boolean" && (r = i, i = undefined), f._isAMomentObject = !0, f._useUTC = f._isUTC = u, f._l = i, f._i = n, f._f = t, f._strict = r, ca(f)
    }
    ...
    function as(n, t) {
        var r, i;
        if (t.length === 1 && oi(t[0]) && (t = t[0]), !t.length) return c();
    ...
    function du(n) {
        var t = so(n), i = t.year || 0, r = t.quarter || 0, u = t.month || 0, f = t.week || 0, e = t.day || 0,
    ...
    function he(n, t) {
        var r = (t || "").match(n) || [], f = r[r.length - 1] || [], i = (f + "").match(ps) || ["-", 0, 0],
            u = +(i[1] * 60) + e(i[2]);
        return i[0] === "+" ? u : -u
    }
    ...
    function ce(n, t) {
        var i, u;
        return t._isUTC ? (i = t.clone(), u = (ni(n) || uu(n) ? +n : +c(n)) - +i, i._d.setTime(+i._d + u), r.updateOffset(i, !1), i) : c(n).local()
    }
    ...
    function ba(n) {
        return this._isUTC && (this.utcOffset(0, n), this._isUTC = !1, n && this.subtract(le(this), "m")), this
    }

    function ka() {
        return this._tzm ? this.utcOffset(this._tzm) : typeof this._i == "string" && this.utcOffset(he(el, this._i)), this
    }
    ...
    function nv() {
        var n, t;
        return y(this._isDSTShifted) ? (n = {}, vf(n, this), n = ss(n), n._a ? (t = n._isUTC ? ki(n._a) : c(n._a), this._isDSTShifted = this.isValid() && ro(n._a, t.toArray()) > 0) : this._isDSTShifted = !1, this._isDSTShifted) : this._isDSTShifted
    }
    ...
    function ti(n, t) {
        var i = n, r = null, u, f, o;
        return se(n) ? i = {
            ms: n._milliseconds,
            d: n._days,
            M: n._months
        } : typeof n == "number" ? (i = {}, t ? i[t] = n : i.milliseconds = n) : (r = bs.exec(n)) ? (u = r[1] === "-" ? -1 : 1, i = {
            y: 0,
            d: e(r[st]) * u,
            h: e(r[a]) * u,
            m: e(r[d]) * u,
    ...
    function rv(n, t) {
        var i;
        return (n.isValid() && t.isValid()) ? (t = ce(t, n), n.isBefore(t) ? i = ds(n, t) : (i = ds(t, n), i.milliseconds = -i.milliseconds, i.months = -i.months), i) : {
            milliseconds: 0,
            months: 0
        }
    }
    ...
    function gs(n, t) {
        return function (i, r) {
            var u, f;
            return r === null || isNaN(+r) || (kl(t, "moment()." + t + "(period, number) is deprecated. Please use moment()." + t + "(number, period)."), f = i, i = r, r = f), i = typeof i == "string" ? +i : i, u = ti(i, r), nh(this, u, n), this
        }
    }
    ...
    function uv(n, t) {
        var u = n || c(), f = ce(u, this).startOf("day"), i = this.diff(f, "days", !0),
    ...
    function ev(n, t) {
        var i = ni(n) ? n : c(n);
        return (this.isValid() && i.isValid()) ? (t = b(y(t) ? "millisecond" : t), t === "millisecond" ? +this > +i : +i < +this.clone().startOf(t)) : !1
    }

    function ov(n, t) {
        var i = ni(n) ? n : c(n);
        return (this.isValid() && i.isValid()) ? (t = b(y(t) ? "millisecond" : t), t === "millisecond" ? +this < +i : +this.clone().endOf(t) < +i) : !1
    }
    ...
    function av(n, t, i) {
        var f, e, u, r;
        return this.isValid() ? (f = ce(n, this), !f.isValid()) ? NaN : (e = (f.utcOffset() - this.utcOffset()) * 6e4, t = b(t), t === "year" || t === "month" || t === "quarter" ? (r = vv(this, f), t === "quarter" ? r = r / 3 : t === "year" && (r = r / 12)) : (u = this - f, r = t === "second" ? u / 1e3 : t === "minute" ? u / 6e4 : t === "hour" ? u / 36e5 : t === "day" ? (u - e) / 864e5 : t === "week" ? (u - e) / 6048e5 : u), i ? r : p(r)) : NaN
    }
    ...
    function pv() {
        ...
        return 0 < n.year() && n.year() <= 9999 ? wt(Date.prototype.toISOString) ? this.toDate().toISOString() : wf(n, "YYYY-MM-DD[T]HH:mm:ss.SSS[Z]") : wf(n, "YYYYYY-MM-DD[T]HH:mm:ss.SSS[Z]")
    }

    function wv(n) {
        var t = wf(this, n || r.defaultFormat);
        return this.localeData().postformat(t)
    }

    function bv(n, t) {
        return this.isValid() && (ni(n) && n.isValid() || c(n).isValid()) ? ti({
            to: this,
            from: n
    ...
    function rh(n) {
        var t;
        return n === undefined ? this._locale._abbr : (t = hi(n), t != null && (this._locale = t), this)
    }
    ...
    function ty(n) {
        return (n = b(n), n === undefined || n === "millisecond") ? this : this.startOf(n).add(1, n === "isoWeek" ? "week" : n).subtract(1, "ms")
    }
    ...
    function ay(n) {
        return fh.call(this, n, this.week(), this.weekday(), this.localeData()._week.dow, this.localeData()._week.doy)
    }

    function vy(n) {
        return fh.call(this, n, this.isoWeek(), this.isoWeekday(), 1, 4)
    }
    ...
    function py() {
        ...
        return li(this.year(), n.dow, n.doy)
    }

    function fh(n, t, i, r, u) {
        var f;
        return n == null ? vr(this, r, u).year : (f = li(n, r, u), t > f && (t = f), wy.call(this, n, t, i, r, u))
    }

    function wy(n, t, i, r, u) {
        var e = os(n, t, i, r, u), f = bu(e.year, 0, e.dayOfYear);
    ...
    function ky(n) {
        return vr(n, this._week.dow, this._week.doy).week
    }
    ...
    function rp(n, t) {
        return oi(this._weekdays) ? this._weekdays[n.day()] : this._weekdays[this._weekdays.isFormat.test(t) ? "format" : "standalone"][n.day()]
    }
    ...
    function op(n) {
        ...
        return n != null ? (n = ip(n, this.localeData()), this.add(n - t, "d")) : t
    }
    ...
    function rc(n, t, i, r) {
        var u = hi(), f = ki().set(r, t);
        return u[i](f, n)
    }

    function yr(n, t, i, r, u) {
        if (typeof n == "number" && (t = n, n = undefined), n = n || "", t != null) return rc(n, t, i, u);
        for (var e = [], f = 0; f < r; f++) e[f] = rc(n, f, i, u);
        return e
    }

    function uw(n, t) {
        return yr(n, t, "months", 12, "month")
    }

    function fw(n, t) {
        return yr(n, t, "monthsShort", 12, "month")
    }

    function ew(n, t) {
        return yr(n, t, "weekdays", 7, "day")
    }

    function ow(n, t) {
        return yr(n, t, "weekdaysShort", 7, "day")
    }

    function sw(n, t) {
        return yr(n, t, "weekdaysMin", 7, "day")
    }
    ...
    function lb(n, t, i, r, u) {
        return u.relativeTime(t || 1, !!i, n, r)
    }

    function ab(n, t, i) {
        var r = ti(n).abs(), h = yi(r.as("s")), f = yi(r.as("m")), e = yi(r.as("h")), o = yi(r.as("d")),
            s = yi(r.as("M")), c = yi(r.as("y")),
    ...
    function yb(n) {
        var t = this.localeData(), i = ab(this, !n, t);
        return n && (i = t.pastFuture(+this, i)), t.postformat(i)
    }

    function tf() {
        var t = nf(this._milliseconds) / 1e3, a = nf(this._days), i = nf(this._months), n, e, o;
        n = p(t / 60);
        e = p(n / 60);
        t %= 60;
        n %= 60;
    ...
    function pi(n, t, i) {
        ...
        return i === "m" ? t ? "хвіліна" : "хвіліну" : i === "h" ? t ? "гадзіна" : "гадзіну" : n + " " + rk(r[i], +n)
    }

    function be(n, t, i) {
        return n + " " + lk({mm: "munutenn", MM: "miz", dd: "devezh"}[i], n)
    }
    ...
    function tt(n, t, i, r) {
        ...
        switch (i) {
            ...
            case"d":
                return t || r ? "den" : "dnem";
            case"dd":
                return t || r ? u + (pr(n) ? "dny" : "dní") : u + "dny";
            case"M":
                return t || r ? "měsíc" : "měsícem";
            case"MM":
                return t || r ? u + (pr(n) ? "měsíce" : "měsíců") : u + "měsíci";
            case"y":
    ...
    function yc(n) {
        return (n ? "" : "[múlt] ") + "[" + vc[this.day()] + "] LT[-kor]"
    }
    ...
    function lt(n, t, i, r) {
        ...
        switch (i) {
            ...
            case"mm":
                return br(n) ? u + (t || r ? "mínútur" : "mínútum") : t ? u + "mínúta" : u + "mínútu";
            case"hh":
                return br(n) ? u + (t || r ? "klukkustundir" : "klukkustundum") : u + "klukkustund";
            case"d":
                return t ? "dagur" : r ? "dag" : "degi";
            case"dd":
                return br(n) ? t ? u + "dagar" : u + (r ? "daga" : "dögum") : t ? u + "dagur" : u + (r ? "dag" : "degi");
            case"M":
                return t ? "mánuður" : r ? "mánuð" : "mánuði";
            case"MM":
                return br(n) ? t ? u + "mánuðir" : u + (r ? "mánuði" : "mánuðum") : t ? u + "mánuður" : u + (r ? "mánuð" : "mánuði");
            case"y":
                return t || r ? "ár" : "ári";
            case"yy":
                return br(n) ? u + (t || r ? "ár" : "árum") : u + (t || r ? "ár" : "ári")
        }
    }
    ...
    function bg(n) {
        ...
        return tr(t) ? "a " + n : "an " + n
    }

    function kg(n) {
        var t = n.substr(0, n.indexOf(" "));
        return tr(t) ? "viru " + n : "virun " + n
    }
    ...
    function ir(n, t, i, r) {
        return t ? ei(i)[0] : r ? ei(i)[1] : ei(i)[2]
    }
    ...
    function dr(n, t, i, r) {
        var u = n + " ";
        return n === 1 ? u + ir(n, t, i[0], r) : t ? u + (wc(n) ? ei(i)[1] : ei(i)[0]) : r ? u + ei(i)[1] : u + (wc(n) ? ei(i)[1] : ei(i)[2])
    }
    ...
    function rr(n, t, i) {
        ...
        switch (i) {
            ...
            case"MM":
                return r + (of(n) ? "miesiące" : "miesięcy");
            case"yy":
    ...
    function ur(n, t, i) {
        ...
        return i === "m" ? t ? "минута" : "минуту" : n + " " + itt(r[i], +n)
    }
    ...
    function ft(n, t, i, r) {
        ...
        switch (i) {
            ...
            case"mm":
                return t || r ? u + (iu(n) ? "minúty" : "minút") : u + "minútami";
            case"h":
                return t ? "hodina" : r ? "hodinu" : "hodinou";
            case"hh":
                return t || r ? u + (iu(n) ? "hodiny" : "hodín") : u + "hodinami";
            case"d":
                return t || r ? "deň" : "dňom";
            case"dd":
                return t || r ? u + (iu(n) ? "dni" : "dní") : u + "dňami";
            case"M":
    ...
    function fr(n, t, i) {
        ...
        return i === "m" ? t ? "хвилина" : "хвилину" : i === "h" ? t ? "година" : "годину" : n + " " + fit(r[i], +n)
    }
    ...
    var to, af = r.momentProperties = [], yf = !1, si = {}, ou, hr = {},
        ...
        hu = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, pf = {}, gi = {}, vo = /\d/, w = /\d\d/, yo = /\d{3}/,
        bf = /\d{4}/, cu = /[+-]?\d{6}/, l = /\d\d?/, po = /\d\d\d\d?/, wo = /\d\d\d\d\d\d?/, lu = /\d{1,3}/,
        kf = /\d{1,4}/, au = /[+-]?\d{1,6}/, vu = /[+-]?\d+/, el = /Z|[+-]\d\d:?\d\d/gi, yu = /Z|[+-]\d\d(?::?\d\d)?/gi,
        cr = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i,
        df = {}, gf = {}, k = 0, kt = 1, st = 2, a = 3, d = 4, dt = 5, ci = 6, cl = 7, ll = 8, te, bo, ko, ts, is, re,
        fe, cs, ls, vs, ps, bs, ks, th, ih, ae, eh, ve, oh, sh, hh, ah, vh, yh, ph, ii, wh, t, pe, bh, kh, dh, gh, nc,
        ic, f, ht, yi, gt, nf, s, n, pb, wb, db, rf, ik, uk, fk, vk, yk, pk, uf, ff, wk, bk, kk, dk, gk, nd, td, id, rd,
        ud, fd, ed, od, cd, ld, wr, ac, pd, wd, bd, kd, dd, tg, ig, fg, vc, eg, og, sg, hg, cg, lg, ag, vg, ef, yg, pg,
        wg, dg, gg, pc, tn, ke, un, at, fn, en, on, kc, dc, sn, hn, cn, vn, kn, de, ge, dn, gn, ntt, ttt, sf, rtt, utt,
        ftt, gc, nl, ett, ott, stt, vt, htt, yt, ctt, ltt, att, ptt, wtt, btt, hf, nit, cf, tit, iit, rit, uit, oit,
        sit, hit, cit, lit, no;
    ...
    var dl = /^\s*((?:[+-]\d{6}|\d{4})-(?:\d\d-\d\d|W\d\d-\d|W\d\d|\d\d\d|\d\d))(?:(T| )(\d\d(?::\d\d(?::\d\d(?:[.,]\d+)?)?)?)([\+\-]\d\d(?::?\d\d)?|\s*Z)?)?/,
        ...
        na = /Z|[+-]\d\d(?::?\d\d)?/,
        wu = [["YYYYYY-MM-DD", /[+-]\d{6}-\d\d-\d\d/], ["YYYY-MM-DD", /\d{4}-\d\d-\d\d/], ["GGGG-[W]WW-E", /\d{4}-W\d\d-\d/], ["GGGG-[W]WW", /\d{4}-W\d\d/, !1], ["YYYY-DDD", /\d{4}-\d{3}/], ["YYYY-MM", /\d{4}-\d\d/, !1], ["YYYYYYMMDD", /[+-]\d{10}/], ["YYYYMMDD", /\d{8}/], ["GGGG[W]WWE", /\d{4}W\d{3}/], ["GGGG[W]WW", /\d{4}W\d{2}/, !1], ["YYYYDDD", /\d{7}/]],
        ...
        ta = /^\/?Date\((\-?\d+)/i;
    for (r.createFromInputFallback = g("moment construction falls back to js Date. This is discouraged and will be removed in upcoming major release. Please refer to https://github.com/moment/moment/issues/1407 for more info.", function (n) {
    ...
    }), u(0, ["YYYY", 4], 0, "year"), u(0, ["YYYYY", 5], 0, "year"), u(0, ["YYYYYY", 6, !0], 0, "year"), v("year", "y"), i("Y", vu), i("YY", l, w), i("YYYY", kf, bf), i("YYYYY", au, cu), i("YYYYYY", au, cu), h(["YYYYY", "YYYYYY"], k), h("YYYY", function (n, t) {
        t[k] = n.length === 2 ? r.parseTwoDigitYear(n) : e(n)
    }), h("YY", function (n, t) {
        t[k] = r.parseTwoDigitYear(n)
    }), h("Y", function (n, t) {
        t[k] = parseInt(n, 10)
    }), r.parseTwoDigitYear = function (n) {
        return e(n) + (e(n) > 68 ? 1900 : 2e3)
    }, fe = di("FullYear", !1), r.ISO_8601 = function () {
    }, cs = g("moment().min is deprecated, use moment.min instead. https://github.com/moment/moment/issues/1548", function () {
        var n = c.apply(null, arguments);
        return this.isValid() && n.isValid() ? n < this ? this : n : eu()
    }), ls = g("moment().max is deprecated, use moment.max instead. https://github.com/moment/moment/issues/1548", function () {
        var n = c.apply(null, arguments);
        return this.isValid() && n.isValid() ? n > this ? this : n : eu()
    }), vs = function () {
        return Date.now ? Date.now() : +new Date
    }, ys("Z", ":"), ys("ZZ", ""), i("Z", yu), i("ZZ", yu), h(["Z", "ZZ"], function (n, t, i) {
        i._useUTC = !0;
        i._tzm = he(yu, n)
    }), ps = /([\+\-]|\d\d)/gi, r.updateOffset = function () {
    }, bs = /^(\-)?(?:(\d*)[. ])?(\d+)\:(\d+)(?:\:(\d+)\.?(\d{3})?\d*)?$/, ks = /^(-)?P(?:(?:([0-9,.]*)Y)?(?:([0-9,.]*)M)?(?:([0-9,.]*)D)?(?:T(?:([0-9,.]*)H)?(?:([0-9,.]*)M)?(?:([0-9,.]*)S)?)?|([0-9,.]*)W)$/, ti.fn = du.prototype, th = gs(1, "add"), ih = gs(-1, "subtract"), r.defaultFormat = "YYYY-MM-DDTHH:mm:ssZ", ae = g("moment().lang() is deprecated. Instead, use moment().localeData() to get the language configuration. Use moment().locale() to change languages.", function (n) {
        return n === undefined ? this.localeData() : this.locale(n)
    }), u(0, ["gg", 2], 0, function () {
        return this.weekYear() % 100
    }), u(0, ["GG", 2], 0, function () {
        return this.isoWeekYear() % 100
    }), gu("gggg", "weekYear"), gu("ggggg", "weekYear"), gu("GGGG", "isoWeekYear"), gu("GGGGG", "isoWeekYear"), v("weekYear", "gg"), v("isoWeekYear", "GG"), i("G", vu), i("g", vu), i("GG", l, w), i("gg", l, w), i("GGGG", kf, bf), i("gggg", kf, bf), i("GGGGG", au, cu), i("ggggg", au, cu), lr(["gggg", "ggggg", "GGGG", "GGGGG"], function (n, t, i, r) {
        t[r.substr(0, 2)] = e(n)
    }), lr(["gg", "GG"], function (n, t, i, u) {
        t[u] = r.parseTwoDigitYear(n)
    }), u("Q", 0, "Qo", "quarter"), v("quarter", "Q"), i("Q", vo), h("Q", function (n, t) {
        t[kt] = (e(n) - 1) * 3
    }), u("w", ["ww", 2], "wo", "week"), u("W", ["WW", 2], "Wo", "isoWeek"), v("week", "w"), v("isoWeek", "W"), i("w", l), i("ww", l, w), i("W", l), i("WW", l, w), lr(["w", "ww", "W", "WW"], function (n, t, i, r) {
        t[r.substr(0, 1)] = e(n)
    }), eh = {
        dow: 0,
        doy: 6
    }, u("D", ["DD", 2], "Do", "date"), v("date", "D"), i("D", l), i("DD", l, w), i("Do", function (n, t) {
        return n ? t._ordinalParse : t._ordinalParseLenient
    }), h(["D", "DD"], st), h("Do", function (n, t) {
        t[st] = e(n.match(l)[0], 10)
    }), ve = di("Date", !0), u("d", 0, "do", "day"), u("dd", 0, 0, function (n) {
    ...
    }), u("e", 0, 0, "weekday"), u("E", 0, 0, "isoWeekday"), v("day", "d"), v("weekday", "e"), v("isoWeekday", "E"), i("d", l), i("e", l), i("E", l), i("dd", cr), i("ddd", cr), i("dddd", cr), lr(["dd", "ddd", "dddd"], function (n, t, i, r) {
        var u = i._locale.weekdaysParse(n, r, i._strict);
        u != null ? t.d = u : o(i).invalidWeekday = n
    }), lr(["d", "e", "E"], function (n, t, i, r) {
        t[r] = e(n)
    }), oh = "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), sh = "Sun_Mon_Tue_Wed_Thu_Fri_Sat".split("_"), hh = "Su_Mo_Tu_We_Th_Fr_Sa".split("_"), u("DDD", ["DDDD", 3], "DDDo", "dayOfYear"), v("dayOfYear", "DDD"), i("DDD", lu), i("DDDD", yo), h(["DDD", "DDDD"], function (n, t, i) {
        i._dayOfYear = e(n)
    }),u("H", ["HH", 2], 0, "hour"),u("h", ["hh", 2], 0, ye),u("hmm", 0, 0, function () {
        return "" + ye.apply(this) + bt(this.minutes(), 2)
    }),u("hmmss", 0, 0, function () {
        return "" + ye.apply(this) + bt(this.minutes(), 2) + bt(this.seconds(), 2)
    }),u("Hmm", 0, 0, function () {
        return "" + this.hours() + bt(this.minutes(), 2)
    }),u("Hmmss", 0, 0, function () {
        return "" + this.hours() + bt(this.minutes(), 2) + bt(this.seconds(), 2)
    }),ch("a", !0),ch("A", !1),v("hour", "h"),i("a", lh),i("A", lh),i("H", l),i("h", l),i("HH", l, w),i("hh", l, w),i("hmm", po),i("hmmss", wo),i("Hmm", po),i("Hmmss", wo),h(["H", "HH"], a),h(["a", "A"], function (n, t, i) {
        ...
        t[d] = e(n.substr(i, 2));
        t[dt] = e(n.substr(r))
    }),ah = /[ap]\.?m?\.?/i,vh = di("Hours", !0),u("m", ["mm", 2], 0, "minute"),v("minute", "m"),i("m", l),i("mm", l, w),h(["m", "mm"], d),yh = di("Minutes", !1),u("s", ["ss", 2], 0, "second"),v("second", "s"),i("s", l),i("ss", l, w),h(["s", "ss"], dt),ph = di("Seconds", !1),u("S", 0, 0, function () {
    ...
    }),v("millisecond", "ms"),i("S", lu, vo),i("SS", lu, w),i("SSS", lu, yo),ii = "SSSS"; ii.length <= 9; ii += "S") i(ii, /\d+/);
    ...
    sr("en", {
        ordinalParse: /\d{1,2}(th|st|nd|rd)/, ordinal: function (n) {
            var t = n % 10, i = e(n % 100 / 10) === 1 ? "th" : t === 1 ? "st" : t === 2 ? "nd" : t === 3 ? "rd" : "th";
            return n + i
        }
    });
    ...
    ht = Math.abs;
    var pw = ri("ms"), ww = ri("s"), bw = ri("m"), kw = ri("h"), dw = ri("d"), gw = ri("w"), nb = ri("M"), tb = ri("y");
    var rb = vi("milliseconds"), ub = vi("seconds"), fb = vi("minutes"), eb = vi("hours"), ob = vi("days"),
        sb = vi("months"), hb = vi("years");
    yi = Math.round;
...
//! Native plural forms: forabi https://github.com/forabi
    var gb = {"1": "١", "2": "٢", "3": "٣", "4": "٤", "5": "٥", "6": "٦", "7": "٧", "8": "٨", "9": "٩", "0": "٠"},
        nk = {"١": "1", "٢": "2", "٣": "3", "٤": "4", "٥": "5", "٦": "6", "٧": "7", "٨": "8", "٩": "9", "٠": "0"},
        oc = function (n) {
            ...
            return function (t, i) {
                var u = oc(t), r = tk[n][oc(t)];
                return u === 2 && (r = r[i ? 0 : 1]), r.replace(/%d/i, t)
            }
        },
        sc = ["كانون الثاني يناير", "شباط فبراير", "آذار مارس", "نيسان أبريل", "أيار مايو", "حزيران يونيو", "تموز يوليو", "آب أغسطس", "أيلول سبتمبر", "تشرين الأول أكتوبر", "تشرين الثاني نوفمبر", "كانون الأول ديسمبر"],
        vit = n.defineLocale("ar", {
            months: sc,
            monthsShort: sc,
            weekdays: "الأحد_الإثنين_الثلاثاء_الأربعاء_الخميس_الجمعة_السبت".split("_"),
            weekdaysShort: "أحد_إثنين_ثلاثاء_أربعاء_خميس_جمعة_سبت".split("_"),
            ...
            preparse: function (n) {
                return n.replace(/\u200f/g, "").replace(/[١٢٣٤٥٦٧٨٩٠]/g, function (n) {
                    return nk[n]
                }).replace(/،/g, ",")
            },
            postformat: function (n) {
    ...
    uk = n.defineLocale("be", {
        ...
        ordinal: function (n, t) {
            switch (t) {
                ...
                case"w":
                case"W":
                    return (n % 10 == 2 || n % 10 == 3) && n % 100 != 12 && n % 100 != 13 ? n + "-і" : n + "-ы";
                case"D":
                    return n + "-га";
                default:
                    return n
...
//! author : Kaushik Gandhi : https://github.com/kaushikgandhi
    var ek = {"1": "১", "2": "২", "3": "৩", "4": "৪", "5": "৫", "6": "৬", "7": "৭", "8": "৮", "9": "৯", "0": "০"},
        ok = {"১": "1", "২": "2", "৩": "3", "৪": "4", "৫": "5", "৬": "6", "৭": "7", "৮": "8", "৯": "9", "০": "0"},
        yit = n.defineLocale("bn", {
...
//! author : Thupten N. Chakrishar : https://github.com/vajradog
    var sk = {"1": "༡", "2": "༢", "3": "༣", "4": "༤", "5": "༥", "6": "༦", "7": "༧", "8": "༨", "9": "༩", "0": "༠"},
        hk = {"༡": "1", "༢": "2", "༣": "3", "༤": "4", "༥": "5", "༦": "6", "༧": "7", "༨": "8", "༩": "9", "༠": "0"},
        pit = n.defineLocale("bo", {
...
//! author : petrbela : https://github.com/petrbela
    uf = "leden_únor_březen_duben_květen_červen_červenec_srpen_září_říjen_listopad_prosinec".split("_");
    ff = "led_úno_bře_dub_kvě_čvn_čvc_srp_zář_říj_lis_pro".split("_");
    wk = n.defineLocale("cs", {
        ...
        shortMonthsParse: function (n) {
            for (var i = [], t = 0; t < 12; t++) i[t] = new RegExp("^" + n[t] + "$", "i");
            return i
        }(ff),
...
//! author : Jawish Hameed : https://github.com/jawish
    var cc = ["ޖެނުއަރީ", "ފެބްރުއަރީ", "މާރިޗު", "އޭޕްރީލު", "މޭ", "ޖޫން", "ޖުލައި", "އޯގަސްޓު", "ސެޕްޓެމްބަރު", "އޮކްޓޯބަރު", "ނޮވެމްބަރު", "ޑިސެމްބަރު"],
        lc = ["އާދިއްތަ", "ހޯމަ", "އަންގާރަ", "ބުދަ", "ބުރާސްފަތި", "ހުކުރު", "ހޮނިހިރު"], wit = n.defineLocale("dv", {
            months: cc,
            monthsShort: cc,
            weekdays: lc,
            weekdaysShort: lc,
...
//! author : Aggelos Karalias : https://github.com/mehiel
    td = n.defineLocale("el", {
        ...
        calendar: function (n, t) {
            ...
            return wt(i) && (i = i.apply(t)), i.replace("{}", r % 12 == 1 ? "στη" : "στις")
        },
        relativeTime: {
            future: "σε %s",
            past: "%s πριν",
...
//! author : Julio Napurí : https://github.com/julionc
    var sd = "ene._feb._mar._abr._may._jun._jul._ago._sep._oct._nov._dic.".split("_"),
        hd = "ene_feb_mar_abr_may_jun_jul_ago_sep_oct_nov_dic".split("_"), bit = n.defineLocale("es", {
            months: "enero_febrero_marzo_abril_mayo_junio_julio_agosto_septiembre_octubre_noviembre_diciembre".split("_"),
            monthsShort: function (n, t) {
...
//! author : Ebrahim Byagowi : https://github.com/ebraminio
    var ad = {"1": "۱", "2": "۲", "3": "۳", "4": "۴", "5": "۵", "6": "۶", "7": "۷", "8": "۸", "9": "۹", "0": "۰"},
        vd = {"۱": "1", "۲": "2", "۳": "3", "۴": "4", "۵": "5", "۶": "6", "۷": "7", "۸": "8", "۹": "9", "۰": "0"},
        kit = n.defineLocale("fa", {
...
//! author : Tarmo Aidantausta : https://github.com/bleadof
    wr = "nolla yksi kaksi kolme neljä viisi kuusi seitsemän kahdeksan yhdeksän".split(" ");
    ac = ["nolla", "yhden", "kahden", "kolmen", "neljän", "viiden", "kuuden", wr[7], wr[8], wr[9]];
    pd = n.defineLocale("fi", {
...
//! author : Robin van der Vliet : https://github.com/robin0van0der0v
    var gd = "jan._feb._mrt._apr._mai_jun._jul._aug._sep._okt._nov._des.".split("_"),
        ng = "jan_feb_mrt_apr_mai_jun_jul_aug_sep_okt_nov_des".split("_"), dit = n.defineLocale("fy", {
            months: "jannewaris_febrewaris_maart_april_maaie_juny_july_augustus_septimber_oktober_novimber_desimber".split("_"),
            monthsShort: function (n, t) {
                return /-MMM-/.test(t) ? ng[n.month()] : gd[n.month()]
            },
...
//! author : Mayank Singhal : https://github.com/mayanksinghal
    var rg = {"1": "१", "2": "२", "3": "३", "4": "४", "5": "५", "6": "६", "7": "७", "8": "८", "9": "९", "0": "०"},
        ug = {"१": "1", "२": "2", "३": "3", "४": "4", "५": "5", "६": "6", "७": "7", "८": "8", "९": "9", "०": "0"},
        nrt = n.defineLocale("hi", {
...
//! author : Adam Brunner : https://github.com/adambrunner
    vc = "vasárnap hétfőn kedden szerdán csütörtökön pénteken szombaton".split(" ");
    eg = n.defineLocale("hu", {
        ...
        calendar: {
            sameDay: "[ma] LT[-kor]", nextDay: "[holnap] LT[-kor]", nextWeek: function () {
                return yc.call(this, !0)
            }, lastDay: "[tegnap] LT[-kor]", lastWeek: function () {
                return yc.call(this, !1)
            }, sameElse: "L"
        },
        relativeTime: {
            future: "%s múlva",
...
//! author : Miodrag Nikač <miodrag@restartit.me> : https://github.com/miodragnikac
    at = {
        words: {
            ...
            var r = at.words[i];
            return i.length === 1 ? t ? r[0] : r[1] : n + " " + at.correctGrammaticalCase(n, r)
        }
    };
...
//! author : Vivek Athalye : https://github.com/vnathalye
    kc = {"1": "१", "2": "२", "3": "३", "4": "४", "5": "५", "6": "६", "7": "७", "8": "८", "9": "९", "0": "०"};
    dc = {"१": "1", "२": "2", "३": "3", "४": "4", "५": "5", "६": "6", "७": "7", "८": "8", "९": "9", "०": "0"};
    sn = n.defineLocale("mr", {
...
//! author : Squar team, mysquar.com
    var ln = {"1": "၁", "2": "၂", "3": "၃", "4": "၄", "5": "၅", "6": "၆", "7": "၇", "8": "၈", "9": "၉", "0": "၀"},
        an = {"၁": "1", "၂": "2", "၃": "3", "၄": "4", "၅": "5", "၆": "6", "၇": "7", "၈": "8", "၉": "9", "၀": "0"},
        trt = n.defineLocale("my", {
...
//! author : suvash : https://github.com/suvash
    var yn = {"1": "१", "2": "२", "3": "३", "4": "४", "5": "५", "6": "६", "7": "७", "8": "८", "9": "९", "0": "०"},
        pn = {"१": "1", "२": "2", "३": "3", "४": "4", "५": "5", "६": "6", "७": "7", "८": "8", "९": "9", "०": "0"},
        irt = n.defineLocale("ne", {
...
//! author : Joris Röling : https://github.com/jjupiter
    var wn = "jan._feb._mrt._apr._mei_jun._jul._aug._sep._okt._nov._dec.".split("_"),
        bn = "jan_feb_mrt_apr_mei_jun_jul_aug_sep_okt_nov_dec".split("_"), rrt = n.defineLocale("nl", {
            months: "januari_februari_maart_april_mei_juni_juli_augustus_september_oktober_november_december".split("_"),
            monthsShort: function (n, t) {
                return /-MMM-/.test(t) ? bn[n.month()] : wn[n.month()]
            },
...
//! author : Rafal Hirsz : https://github.com/evoL
    de = "styczeń_luty_marzec_kwiecień_maj_czerwiec_lipiec_sierpień_wrzesień_październik_listopad_grudzień".split("_");
    ge = "stycznia_lutego_marca_kwietnia_maja_czerwca_lipca_sierpnia_września_października_listopada_grudnia".split("_");
    dn = n.defineLocale("pl", {
        months: function (n, t) {
            return t === "" ? "(" + ge[n.month()] + "|" + de[n.month()] + ")" : /D MMMM/.test(t) ? ge[n.month()] : de[n.month()]
        },
...
//! Author : Menelion Elensúle : https://github.com/Oire
    sf = [/^янв/i, /^фев/i, /^мар/i, /^апр/i, /^ма[й|я]/i, /^июн/i, /^июл/i, /^авг/i, /^сен/i, /^окт/i, /^ноя/i, /^дек/i];
...
//! based on work of petrbela : https://github.com/petrbela
    gc = "január_február_marec_apríl_máj_jún_júl_august_september_október_november_december".split("_");
    nl = "jan_feb_mar_apr_máj_jún_júl_aug_sep_okt_nov_dec".split("_");
...
//! author : Milan Janačković<milanjanackovic@gmail.com> : https://github.com/milan-j
    vt = {
        words: {
            ...
            var r = vt.words[i];
            return i.length === 1 ? t ? r[0] : r[1] : n + " " + vt.correctGrammaticalCase(n, r)
        }
    };
...
//! author : Milan Janačković<milanjanackovic@gmail.com> : https://github.com/milan-j
    yt = {
        words: {
            ...
            var r = yt.words[i];
            return i.length === 1 ? t ? r[0] : r[1] : n + " " + yt.correctGrammaticalCase(n, r)
        }
    };
...
//! author : Arjunkumar Krishnamoorthy : https://github.com/tk120404
    var vtt = {"1": "௧", "2": "௨", "3": "௩", "4": "௪", "5": "௫", "6": "௬", "7": "௭", "8": "௮", "9": "௯", "0": "௦"},
        ytt = {"௧": "1", "௨": "2", "௩": "3", "௪": "4", "௫": "5", "௬": "6", "௭": "7", "௮": "8", "௯": "9", "௦": "0"},
        urt = n.defineLocale("ta", {
...
//! author : Dominika Kruk : https://github.com/amaranthrose
    hf = "pagh_wa’_cha’_wej_loS_vagh_jav_Soch_chorgh_Hut".split("_");
    nit = n.defineLocale("tlh", {
        ...
        calendar: {
            ...
            lastWeek: function () {
                switch (this.day()) {
                    ...
                    case 5:
                    case 6:
                        return er("[Минулої] dddd [").call(this);
                    case 1:
                    case 2:
                    case 4:
                        return er("[Минулого] dddd [").call(this)
                }
            },
            sameElse: "L"
        },
...
//! author : Ben : https://github.com/ben-lin
    ...
    typeof define == "function" && define.amd ? define(["moment"], function (i) {
        return n.moment = t(i), n.moment
    }) : typeof exports == "object" ? module.exports = t(require("moment")) : n.moment = t(n.moment)
}(this, function (n) {
    function ft(n, t) {
        return function (i) {
    ...
    function l(n) {
        return n ? yt[n] || n.toLowerCase().replace(/(.)s$/, "$1") : n
    }
    ...
    function kt(n) {
        for (var i = n.match(v), u = i.length, t = 0; t < u; t += 1) r[i[t]] && (i[t] = r[i[t]]);
        return function (r) {
            var f = "";
            for (t = 0; t < u; t += 1) f += i[t] instanceof Function ? "[" + i[t].call(r, n) + "]" : i[t];
            return f
        }
    }
    ...
    function gt(n) {
        var i, o, u = n._a[0], f = n._a[1], r = n._a[2];
    ...
    function ht(n, i, r) {
        ...
        return u > e && (u -= 7), u < e - 7 && (u += 7), f = t(n).add(u, "d"), {
            week: Math.ceil(f.iDayOfYear() / 7),
            year: f.iYear()
        }
    }

    function a(i, r, f, e) {
        var o = {_i: i, _f: r, _l: f}, s, h, c;
        if (r) {
    ...
    function ri(n, t, i) {
        var r = ct(n, t), u = i + o.ummalquraData[r - 1] - 1;
        return u + 24e5
    }

    function ui(n) {
        var t = n - 24e5, i = oi(t), r = i + 16260, u = Math.floor((r - 1) / 12), f = u + 1, e = r - 12 * u,
            s = t - o.ummalquraData[i - 1] + 1;
        return {hy: f, hm: e, hd: s}
    }

    function fi(n, t, r) {
        var u = i((n + i(t - 8, 6) + 100100) * 1461, 4) + i(153 * c(t + 9, 12) + 2, 5) + r - 34840408;
        return u - i(i(n + 100100 + i(t - 8, 6), 100) * 3, 4) + 752
    }

    function ei(n) {
        var t, r, f, u, e;
        return t = 4 * n + 139361631, t = t + i(i(4 * n + 183187720, 146097) * 3, 4) * 4 - 3908, r = i(c(t, 1461), 4) * 5 + 308, f = i(c(r, 153), 5) + 1, u = c(i(r, 153), 12) + 1, e = i(t, 1461) - 100100 + i(8 - u, 6), {
            gy: e,
            gm: u,
            gd: f
        }
    ...
    function ct(n, t) {
        var i = n - 1, r = i * 12 + 1 + (t - 1);
        return r - 16260
    }

    function oi(n) {
        for (var t = 0; t < o.ummalquraData.length; t = t + 1) if (o.ummalquraData[t] > n) return t
    }
    ...
    }, v = /(\[[^\[]*\])|(\\)?i(Mo|MM?M?M?|Do|DDDo|DD?D?D?|w[o|w]?|YYYYY|YYYY|YY|gg(ggg?)?)|(\\)?(Mo|MM?M?M?|Do|DDDo|DD?D?D?|ddd?d?|do?|w[o|w]?|W[o|W]?|YYYYY|YYYY|YY|gg(ggg?)?|GG(GGG?)?|e|E|a|A|hh?|HH?|mm?|ss?|SS?S?|X|zz?|ZZ?|.)/g, b = /(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, k = /\d\d?/, d = /\d{1,3}/, g = /\d{3}/, nt = /\d{1,4}/, tt = /[+\-]?\d{1,6}/, it = /[0-9]*['a-z\u00A0-\u05FF\u0700-\uD7FF\uF900-\uFDCF\uFDF0-\uFFEF]+(\.?)|[\u0600-\u06FF\/]+(\s*?[\u0600-\u06FF]+){1,2}/i, lt = /Z|[\+\-]\d\d:?\d\d/i, at = /T/i, vt = /[\+\-]?\d+(\.\d{1,3})?/, yt = {
        hd: "idate",
        hm: "imonth",
        hy: "iyear"
    }, y = {}, rt = "DDD w M D".split(" "), ut = "M D w".split(" "), r = {
        iM: function () {
            return this.iMonth() + 1
        }, iMMM: function (n) {
            return this.localeData().iMonthsShort(this, n)
        }, iMMMM: function (n) {
            return this.localeData().iMonths(this, n)
        }, iD: function () {
            return this.iDate()
        }, iDDD: function () {
            ...
            return u(this.iYear() % 100, 2)
        }, iYYYY: function () {
            return u(this.iYear(), 4)
        }, iYYYYY: function () {
            return u(this.iYear(), 5)
        }, igg: function () {
            return u(this.iWeekYear() % 100, 2)
        }, igggg: function () {
            return this.iWeekYear()
        }, iggggg: function () {
            return u(this.iWeekYear(), 5)
        }
    }, f; rt.length;) f = rt.pop(), r["i" + f + "o"] = pt(r["i" + f], f);
    ...
    return r.iDDDD = ft(r.iDDD, 3), p(bt(n.localeData()), {
        ...
        iMonths: function (n) {
            return this._iMonths[n.iMonth()]
        },
        _iMonthsShort: ["Muh", "Saf", "Rab-I", "Rab-II", "Jum-I", "Jum-II", "Raj", "Sha", "Ram", "Shw", "Dhu-Q", "Dhu-H"],
        iMonthsShort: function (n) {
            return this._iMonthsShort[n.iMonth()]
        },
        iMonthsParse: function (n) {
            var i, r, u;
            for (this._iMonthsParse || (this._iMonthsParse = []), i = 0; i < 12; i += 1) if (this._iMonthsParse[i] || (r = t([2e3, (2 + i) % 12, 25]), u = "^" + this.iMonths(r, "") + "$|^" + this.iMonthsShort(r, "") + "$", this._iMonthsParse[i] = new RegExp(u.replace(".", ""), "i")), this._iMonthsParse[i].test(n)) return i
        }
    }), w = {
    ...
    }, typeof n.updateLocale == "function" ? n.updateLocale("ar-sa", w) : (ot = n.locale(), n.defineLocale("ar-sa", w), n.locale(ot)), p(t, n), t.fn = et(n.fn), t.utc = function (n, t, i) {
        return a(n, t, i, !0)
    }, t.fn.format = function (t) {
        var i, r, u = this;
        if (t) {
            for (i = 5, r = function (n) {
                return u.localeData().longDateFormat(n) || n
            }; i > 0 && b.test(t);) i -= 1, t = t.replace(b, r);
            y[t] || (y[t] = kt(t));
            t = y[t](this)
        }
        return n.fn.format.call(this, t)
    }, t.fn.iYear = function (i) {
        var f, u, r;
        return typeof i == "number" ? (u = e(this.year(), this.month(), this.date()), f = Math.min(u.hd, t.iDaysInMonth(i, u.hm)), r = h(i, u.hm, f), s(this, r.gy, r.gm, r.gd), (this.month() !== r.gm || this.date() !== r.gd || this.year() !== r.gy) && s(this, r.gy, r.gm, r.gd), n.updateOffset(this), this) : e(this.year(), this.month(), this.date()).hy
    }, t.fn.iMonth = function (r) {
        var o, f, u;
        if (r != null) {
            if (typeof r == "string") if (r = this.localeData().iMonthsParse(r), r >= 0) r -= 1; else return this;
    ...
    }, t.fn.iDate = function (t) {
        var r, i;
        return typeof t == "number" ? (r = e(this.year(), this.month(), this.date()), i = h(r.hy, r.hm, t), s(this, i.gy, i.gm, i.gd), (this.month() !== i.gm || this.date() !== i.gd || this.year() !== i.gy) && s(this, i.gy, i.gm, i.gd), n.updateOffset(this), this) : e(this.year(), this.month(), this.date()).hd
    }, t.fn.iDayOfYear = function (n) {
        var i = Math.round((t(this).startOf("day") - t(this).startOf("iYear")) / 864e5) + 1;
        return n == null ? i : this.add(n - i, "d")
    }, t.fn.iDaysInMonth = function () {
        return parseInt(t(this).endOf("iMonth").format("iDD"))
    }, t.fn.iWeek = function (n) {
        var t = ht(this, this.localeData()._week.dow, this.localeData()._week.doy).week;
        return n == null ? t : this.add((n - t) * 7, "d")
    }, t.fn.iWeekYear = function (n) {
        var t = ht(this, this.localeData()._week.dow, this.localeData()._week.doy).year;
        return n == null ? t : this.add(n - t, "y")
    }, t.fn.add = function (t, i) {
        var r;
        return i === null || isNaN(+i) || (r = t, t = i, i = r), i = l(i), i === "iyear" ? this.iYear(this.iYear() + t) : i === "imonth" ? this.iMonth(this.iMonth() + t) : i === "idate" ? this.iDate(this.iDate() + t) : n.fn.add.call(this, t, i), this
    }, t.fn.subtract = function (t, i) {
        var r;
        return i === null || isNaN(+i) || (r = t, t = i, i = r), i = l(i), i === "iyear" ? this.iYear(this.iYear() - t) : i === "imonth" ? this.iMonth(this.iMonth() - t) : i === "idate" ? this.iDate(this.iDate() - t) : n.fn.subtract.call(this, t, i), this
    }, t.fn.startOf = function (t) {
        return t = l(t), t === "iyear" || t === "imonth" ? (t === "iyear" && this.iMonth(0), this.iDate(1), this.hours(0), this.minutes(0), this.seconds(0), this.milliseconds(0), this) : n.fn.startOf.call(this, t)
    }, t.fn.endOf = function (n) {
        return (n = l(n), n === undefined || n === "milisecond") ? this : this.startOf(n).add(1, n === "isoweek" ? "week" : n).subtract(1, "milliseconds")
    }, t.fn.clone = function () {
        return t(this)
    }, t.fn.iYears = t.fn.iYear, t.fn.iMonths = t.fn.iMonth, t.fn.iDates = t.fn.iDate, t.fn.iWeeks = t.fn.iWeek, t.iDaysInMonth = function (n, t) {
        var i = ct(n, t + 1);
        return o.ummalquraData[i] - o.ummalquraData[i - 1]
    }, t.iConvert = {toHijri: e, toGregorian: h}, t
});
/*! version : 4.17.37
 =========================================================
...
(function (n) {
    "use strict";
    if (typeof define == "function" && define.amd) define(["jquery", "moment"], n); else if (typeof exports == "object") n(require("jquery"), require("moment")); else {
    ...
    var i = function (i, r) {
        var u = {}, o, f, k = !0, c, l = !1, e = !1, d, nt = 0, y, g, b,
            ht = [{clsName: "days", navFnc: r.hijri ? "iMonth" : "Month", navStep: 1}, {
                clsName: "months",
                navFnc: r.hijri ? "iYear" : "y",
                navStep: 1
            }, {clsName: "years", navFnc: r.hijri ? "iYear" : "y", navStep: 10}, {
                clsName: "decades",
                navFnc: r.hijri ? "iYear" : "y",
                navStep: 100
            }], yt = ["days", "months", "years", "decades"], bt = ["top", "bottom", "auto"],
            kt = ["left", "right", "auto"], dt = ["default", "top", "bottom"], gt = {
                up: 38,
                38: "up",
                down: 40,
                40: "down",
                ...
                }).append(n("<span>").html(r.icons.today)))), !r.sideBySide && ft() && lt() && t.push(n("<td>").append(n("<a>").attr({
                ...
                }).append(n("<span>").html(r.icons.clear)))), r.showClose && t.push(n("<td>").append(n("<a>").attr({
                    "data-action": "close",
                    title: r.tooltips.close
                }).append(n("<span>").html(r.icons.close)))), r.showSwitcher && t.push(n("<td>").append(n("<a>").attr({
                    "data-action": "switchDate",
                    title: r.tooltips.close
                }).append(n("<span>").html("هجري/ميلادي")))), n("<table>").addClass("table-condensed").append(n("<tbody>").append(n("<tr>").append(t)))
            }, ai = function () {
                var t = n("<div>").addClass("bootstrap-datetimepicker-widget dropdown-menu"),
                    f = n("<div>").addClass("datepicker").append(si()), e = n("<div>").addClass("timepicker").append(ci()),
                ...
                var o = (l || i).position(), s = (l || i).offset(), u = r.widgetPositioning.vertical,
                    f = r.widgetPositioning.horizontal, t;
                if (r.widgetParent) t = r.widgetParent.append(e); else if (i.is("input")) t = i.after(e).parent(); else {
                    if (r.inline) {
                        t = i.append(e);
                        return
                    }
                ...
                if (u === "auto" && (u = s.top + e.height() * 1.5 >= n(window).height() + n(window).scrollTop() && e.height() + i.outerHeight() < s.top ? "top" : "bottom"), f === "auto" && (f = t.width() < s.left + e.outerWidth() / 2 && s.left + e.outerWidth() > n(window).width() ? "right" : "left"), u === "top" ? e.addClass("top").removeClass("bottom") : e.addClass("bottom").removeClass("top"), f === "right" ? e.addClass("pull-right") : e.removeClass("pull-right"), t.css("position") !== "relative" && (t = t.parents().filter(function () {
                ...
                e.css({
                    ...
                    left: f === "left" ? t === i ? 0 : o.left : "auto",
                    right: f === "left" ? "auto" : t.outerWidth() - i.outerWidth() - (t === i ? 0 : o.left)
                })
            }, et = function (n) {
                ...
                e && (n && (b = Math.max(nt, Math.min(2, b + n))), e.find(".datepicker > div").hide().filter(".datepicker-" + ht[b].clsName).show())
            }, yi = function () {
                var t = n("<tr>"), i = f.clone().startOf("w").startOf("day");
                ...
                if (!t.isValid() || r.disabledDates && i === "d" && pi(t) || r.enabledDates && i === "d" && !wi(t) || r.minDate && t.isBefore(r.minDate, i) || r.maxDate && t.isAfter(r.maxDate, i) || r.daysOfWeekDisabled && i === "d" && r.daysOfWeekDisabled.indexOf(t.day()) !== -1 || r.disabledHours && (i === "h" || i === "m" || i === "s") && bi(t) || r.enabledHours && (i === "h" || i === "m" || i === "s") && !ki(t)) return !1;
                ...
                var i = e.find(".datepicker-months"), t = i.find("th"), u = i.find("tbody").find("span");
                ...
                u.each(function (t) {
                    h(f.clone().month(t), "M") || n(this).addClass("disabled")
                })
            }, gi = function () {
                var i = e.find(".datepicker-months"), t = i.find("th"), u = i.find("tbody").find("span");
                t.eq(0).find("span").attr("title", r.tooltips.prevYear);
                ...
                var u = e.find(".datepicker-years"), t = u.find("th"), n = f.clone().subtract(5, "hy"),
                    i = f.clone().add(6, "hy"), s = "", c, l;
                ...
                var i = e.find(".datepicker-years"), t = i.find("th"), n = f.clone().subtract(5, "y"),
                    u = f.clone().add(6, "y"), s = "";
                ...
                var u = e.find(".datepicker-decades"), i = u.find("th"), n = t({y: f.year() - f.year() % 100 - 1}),
                    s = n.clone().add(100, "y"), l = n.clone(), c = "";
                ...
                var c = e.find(".datepicker-days"), u = c.find("th"), t, a = [], s, i, l;
                if (ft()) {
                ...
                var l = e.find(".datepicker-days"), s = l.find("th"), i, v = [], c, u, a;
                if (ft()) {
                ...
                var u = e.find(".timepicker-hours table"), t = f.clone().startOf("day"), r = [], i = n("<tr>");
                ...
                h(n) ? (o = n, f = o.clone(), c.val(o.format(y)), i.data("date", o.format(y)), k = !1, a(), et({
                    type: "dp.change",
                    date: o.clone(),
                    oldDate: t
                })) : (r.keepInvalid || c.val(k ? "" : o.format(y)), et({type: "dp.error", date: n}))
            }, v = function () {
                var t = !1;
                return e ? (e.find(".collapse").each(function () {
                    var i = n(this).data("collapse");
                    return i && i.transitioning ? (t = !0, !1) : !0
                }), t) ? u : (l && l.hasClass("btn") && l.toggleClass("active"), e.hide(), n(window).off("resize", pt), e.off("click", "[data-action]"), e.off("mousedown", !1), e.remove(), e = !1, et({
                    type: "dp.hide",
                    date: o.clone()
                }), c.blur(), u) : u
            }, ii = function () {
                ...
                next: function () {
                    ...
                    s(o.clone().add(o.hours() >= 12 ? -12 : 12, "h"))
                }, togglePicker: function (t) {
                    var u = n(t.target), e = u.closest("ul"), i = e.find(".in"), o = e.find(".collapse:not(.in)"), f;
                    if (i && i.length) {
                    ...
                    vt.showPicker.call(u)
                }, clear: ii, today: function () {
                    var n = tt();
                    h(n, "d") && s(n)
                }, close: v, switchDate: function () {
                    r.hijri ? (r.hijri = !1, ut(), ni(), st()) : (r.hijri = !0, at(), ti(), st())
                }
            }, er = function (t) {
                return n(t.currentTarget).is(".disabled") ? !1 : (vt[n(t.currentTarget).data("action")].apply(u, arguments), !1)
            }, w = function () {
                var t, i = {
                    year: function (n) {
                ...
                var o = null, t, f, c = [], l = {}, s = n.which, i, h, a = "p";
                ct[s] = a;
                for (t in ct) ct.hasOwnProperty(t) && ct[t] === a && (c.push(t), parseInt(t, 10) !== s && (l[t] = !0));
                for (t in r.keyBinds) if (r.keyBinds.hasOwnProperty(t) && typeof r.keyBinds[t] == "function" && (i = t.split(" "), i.length === c.length && gt[s] === i[i.length - 1])) {
                    for (h = !0, f = i.length - 2; f >= 0; f--) if (!(gt[i[f]] in l)) {
                        h = !1;
                        break
                    }
                    if (h) {
                ...
                y = n.replace(/(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, function (n) {
                    var t = o.localeData().longDateFormat(n) || n;
                    return t.replace(/(\[[^\[]*\])|(\\)?(LTS|LT|LL?L?L?|l{1,4})/g, function (n) {
                        return o.localeData().longDateFormat(n) || n
                    })
                });
        ...
        if (u.destroy = function () {
            ...
            return v(), l && l.hasClass("btn") && l.addClass("disabled"), c.prop("disabled", !0), u
        }, u.enable = function () {
            return l && l.hasClass("btn") && l.removeClass("disabled"), c.prop("disabled", !1), u
            ...
            return n.extend(!0, r, t), n.each(r, function (n, t) {
                if (u[n] !== undefined) u[n](t); else throw new TypeError("option " + n + " is not recognized!");
            }), u
        }, u.date = function (n) {
            if (arguments.length === 0) return k ? null : o.clone();
            ...
            return r.format = n, y && st(), u
        }, u.hijriFormat = function () {
        ...
        }, u.hijriDayViewHeaderFormat = function () {
            ...
            return r.extraFormats = n, g && st(), u
            ...
            return r.disabledDates = ei(t), r.enabledDates = !1, a(), u
            ...
            return r.enabledDates = ei(t), r.disabledDates = !1, a(), u
            ...
            if (arguments.length === 0) return r.hijri && (r.viewModes = ["days", "months", "years"]), r.hijri;
            if (typeof n != "boolean") throw new TypeError("hijri() expects a boolean parameter");
            return r.hijri = n, r.hijri && (r.viewModes = ["days", "months", "years"]), u
        }, u.isRTL = function () {
            return r.isRTL && (r.icons.next = ">>", r.icons.previous = "<<"), r.isRTL
        }, u.locale = function (n) {
            ...
            return r.locale = n, o.locale(r.locale), f.locale(r.locale), y && st(), e && (v(), w()), u
            ...
            if (yt.indexOf(n) === -1) throw new TypeError("viewMode() parameter must be one of (" + yt.join(", ") + ") value");
            return r.viewMode = n, b = Math.max(yt.indexOf(n), nt), ot(), u
            ...
            return r.toolbarPlacement = n, e && (v(), w()), u
            ...
            return r.showTodayButton = n, e && (v(), w()), u
            ...
            return r.widgetParent = t, e && (v(), w()), u
        ...
        }, u.showSwitcher = function (n) {
            if (arguments.length === 0) return r.showSwitcher;
            if (typeof n != "boolean") throw new TypeError("showClose() expects a boolean parameter");
            return r.showSwitcher = n, u
            ...
            if (arguments.length === 0) return f.clone();
            if (!n) return f = o.clone(), u;
            ...
            return f = rt(n), it(), u
        }, i.is("input")) c = i; else if (c = i.find(r.datepickerInput), c.size() === 0) c = i.find("input"); else if (!c.is("input")) throw new Error('CSS class "' + r.datepickerInput + '" cannot be applied to non input element');
