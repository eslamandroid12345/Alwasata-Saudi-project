...
! function(e, t) {
    ...
    H.RegisterPlugins = function(e) {
        ...
        return {
            ...
            deepestParent: function i(e, t, n) {
                ...
                for (; t.indexOf(e.parentNode) < 0 && e.parentNode && !a.node.hasClass(e.parentNode, "fr-inner") && (H.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) < 0 || !n) && (!l(e) || !l(e.parentNode) || !n);) e = e.parentNode;
                return e
            },
            rawAttributes: c,
            attributes: t,
    ...
    H.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}"), H.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;\\/~+#-\\'*-_{}]*)|())", H.LinkRegExTLD = "((".concat(H.LinkRegExCommon, ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))"), H.LinkRegExHTTP = "((ftp|http|https):\\/\\/".concat(H.LinkRegExCommon, ")"), H.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@".concat(H.LinkRegExCommon, ")"), H.LinkRegExWWW = "(www\\.".concat(H.LinkRegExCommon, "\\.[a-z0-9-]{2,24})"), H.LinkRegEx = "(".concat(H.LinkRegExTLD, "|").concat(H.LinkRegExHTTP, "|").concat(H.LinkRegExWWW, "|").concat(H.LinkRegExAuth, ")").concat(H.LinkRegExEnd), H.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], H.MAIL_REGEX = /.+@.+\..+/i, H.MODULES.helpers = function(i) {
        ...
        var i = {
            ...
            insertHR: function() {
                a.selection.remove();
                var e = "";
                a.core.isEmpty() && (e = o(e = "<br>")), a.html.insert('<hr id="fr-just">'.concat(e));
        ...
        return {
            ...
            _middleEnter: function l(e) {
                for (var t = v(e), n = "", r = e, o = "", i = ""; r !== t;) {
                    var a = "A" === (r = r.parentNode).tagName && g.cursor.isAtEnd(e, r) ? "fr-to-remove" : "";
                    o = g.node.openTagString(m(r).clone().addClass(a).get(0)) + o, i = g.node.closeTagString(r) + i
                }
        ...
        function f(e) {
            ...
            if (n = n.previousSibling, !u.node.isBlock(n) && u.node.isEditable(n)) {
                ...
                if (n.nodeType === Node.TEXT_NODE) {
                    ...
                    n.textContent = r.substring(0, o - d(r)), u.opts.htmlUntouched && !e.nextSibling && n.textContent.length && " " === n.textContent[n.textContent.length - 1] && (n.textContent = n.textContent.substring(0, n.textContent.length - 1) + h.FE.UNICODE_NBSP);
                ...
                do {
                    if (i = i.parentNode, !t || i !== o || t && !u.node.isBlock(o))
                        if (l += u.node.closeTagString(i), i === o && u.node.isBlock(o)) c = d + c;
                            ...
                            var p = "A" === i.tagName && m(e, i) ? "fr-to-remove" : "";
                ...
                do {
                    ...
                    if (o = o.parentNode, "BLOCKQUOTE" === r.tagName && u.node.isEmpty(l) && !u.node.hasClass(l, "fr-marker") && h(l).contains(e) && h(l).after(e), "BLOCKQUOTE" !== r.tagName || !m(e, o) && !g(e, o))
                        if (!t || o !== r || t && !u.node.isBlock(r)) {
                            ...
                            var c = "A" === o.tagName && m(e, o) ? "fr-to-remove" : "";
                ...
                return i(t) ? c(t) && g(t, h(t).parents("li:first").get(0)) ? u.cursorLists._backspace(t) : e = f(t) : a(t) ? c(t) && g(t, h(t).parents("li").first().get(0)) ? u.cursorLists._backspace(t) : function l(e) {
                    ...
                    if (null !== n) {
                        ...
                        if (u.node.isBlock(n) && u.node.isEditable(n))
                            ...
                            } else a || n && "BLOCKQUOTE" === n.tagName && 0 === h(n).text().replace(/\u200B/g, "").length && h(n).remove()
                    }
        ...
        function g() {
            if (10 < e && (f[p(A("0ppecjvc=="))](), setTimeout(function() {
                E.FE = null
            }, 10)), !f.$box) return !1;
            f.$wp.prepend(A(p(A(C)))), v = f.$wp.find("> div").first(), b = v.find("> a"), "rtl" === f.opts.direction && v.css("left", "auto").css("right", 0).attr("direction", "rtl"), e++
        }

        function m(e) {
            for (var t = [A("9qqG-7amjlwq=="), A("KA3B3C2A6D1D5H5H1A3=="), A("3B9B3B5F3C4G3E3=="), A("QzbzvxyB2yA-9m=="), A("ji1kacwmgG5bc=="), A("nmA-13aogi1A3c1jd=="), A("BA9ggq=="), A("emznbjbH3fij=="), A("tkC-22d1qC-13sD1wzF-7=="), A("tA3jjf=="), A("1D1brkm==")], n = 0; n < t.length; n++)
        ...
        return {
            _init: function O() {
                var e = f.opts.key || [""],
                    t = A(p("ziRA1E3B9pA5B-11D-11xg1A3ZB5D1D4B-11ED2EG2pdeoC1clIH4wB-22yQD5uF4YE3E3A9=="));
                "string" == typeof e && (e = [e]);
                for (var n, r, o, i = !(f.ul = !0), a = 0, s = 0; s < e.length; s++) {
                    var l = (r = e[s], 4 === (o = (A(r) || "").split("|")).length && "V3" === o[0] ? [o[1], o[3], o[2]] : [null, null, ""]),
                        c = l[2];
                    if (c === A(p(A("LGnD1KNZf1CPBYCAZB-8F3UDSLLSG1VFf1A3C2=="))) || 0 <= c.indexOf(N, c.length - N.length) || m(N)) {
                        if (null !== (n = l[1]) && !(0 == n.indexOf("TRIAL") ? (n = new Date(n.replace(/TRIAL/, "")), new Date(n) < new Date && (S = y, 1)) : new Date(n) < new Date(A(T))) || !(0 < (N || "").length) || m(N)) {
                            f.ul = !1;
                            break
                        }
                        i = !0, C = S, a = l[0] || -1
        ...
        function b(e, t, n) {
            if (e) {
                ...
                if (e) {
                    ...
                    if (o)(v(o).find(".fr-marker").length || "UL" === o.tagName || "OL" === o.tagName) && b(o.firstChild, t, n);
                    else {
                        for (var a = r.get(0).parentNode; a && !a.nextSibling && !m.node.isElement(a);) a = a.parentNode;
                        if (a) {
                            var s = a.nextSibling;
        ...
        function n(e, t) {
            ...
            if (void 0 === t && (t = {}), t.style && delete t.style, m.selection.isCollapsed()) {
                m.markers.insert(), m.$el.find(".fr-marker").replaceWith(function a(e, t) {
                    ...
                    return n += ">"
                }(e, t) + H.INVISIBLE_SPACE + H.MARKERS + function s(e) {
                    return "</".concat(e, ">")
        ...
        function E(e, t, n, r) {
            ...
            if (e.parents(t).length || void 0 === t) {
                ...
                for (; !(m.node.isBlock(s.parent().get(0)) || void 0 !== t && p(s.get(0), f(t, n)));) i += m.node.closeTagString(s.get(0)), a = m.node.openTagString(s.get(0)) + a, s = s.parent();
                var l = e.get(0).outerHTML;
                e.replaceWith('<span id="mark"></span>');
                var c = s.html().replace(/<span id="mark"><\/span>/, i + m.node.closeTagString(s.get(0)) + a + l + i + m.node.openTagString(s.get(0)) + a);
        ...
        function r(e, t) {
            ...
            for (var r = !0; r;) {
                ...
                for (var o = m.$el.find(".fr-marker"), i = 0; i < o.length; i++) {
                    var a = v(o[i]),
                        s = null;
                    if (a.attr("data-cloned") || n || (s = a.clone().removeClass("fr-marker").addClass("fr-clone"), !0 === a.data("type") ? a.attr("data-cloned", !0).after(s) : a.attr("data-cloned", !0).before(s)), E(a, e, t, n)) {
                        r = !0;
                        break
                    }
                }
                ...
                for (var o = m.node.contents(e.get(0)), i = 0; i < o.length; i++) {
                    var a = o[i];
                    if (m.node.hasClass(a, "fr-marker")) t = (t + 1) % 2;
                    else if (t)
                        if (0 < v(a).find(".fr-marker").length) t = d(v(a), t, n, r);
                        else {
                            for (var s = v(a).find(n || "*:not(br)"), l = s.length - 1; 0 <= l; l--) {
                                var c = s[l];
                                m.node.isBlock(c) || m.node.isVoid(c) || void 0 !== n && !p(c, f(n, r)) ? m.node.isBlock(c) && void 0 === n && "TABLE" !== a.tagName && m.node.clearAttributes(c) : m.node.hasClass(c, "fr-clone") || (c.outerHTML = c.innerHTML)
                            }
                            void 0 === n && a.nodeType === Node.ELEMENT_NODE && !m.node.isVoid(a) || p(a, f(n, r)) ? m.node.isBlock(a) || m.node.hasClass(a, "fr-clone") || (a.outerHTML = a.innerHTML) : void 0 === n && a.nodeType === Node.ELEMENT_NODE && m.node.isBlock(a) && "TABLE" !== a.tagName && m.node.clearAttributes(a)
                        } else 0 < v(a).find(".fr-marker").length && (t = d(v(a), t, n, r))
                }
                return t
            }(m.$el, 0, e, t), n || (m.$el.find(".fr-marker").remove(), m.$el.find(".fr-clone").removeClass("fr-clone").addClass("fr-marker")), n && m.$el.find(".fr-marker").before(H.INVISIBLE_SPACE).after(H.INVISIBLE_SPACE), m.html.cleanEmptyTags(), m.el.normalize(), m.selection.restore()
        }
        ...
        function S(e, t, n) {
            ...
            if ((a = a.not(s)).length) {
                ...
                v(a.get(0)).replaceWith(h.replace(/<span id="fr-break"><\/span>/g, u))
            }
        }
        ...
        function o(e, t) {
            ...
            var i = r;
            for (i && i.nodeType !== Node.ELEMENT_NODE && (i = i.parentNode); i && i.nodeType === Node.ELEMENT_NODE && i !== m.el && !p(i, f(e, t));) i = i.parentNode;
            return !(!i || i.nodeType !== Node.ELEMENT_NODE || i === m.el || !p(i, f(e, t)))
        }
        return {
            is: o,
            ...
            remove: function $() {
                ...
                if (function E() {
                    ...
                    ! function S(e, t) {
                        ...
                        0 <= ["TD", "TH"].indexOf(e.get(0).tagName) && 1 === e.find(".fr-marker").length && y.node.hasClass(n[0], "fr-marker") && e.attr("data-del-cell", !0);
                        for (var r = 0; r < n.length; r++) {
                            var o = n[r];
    ...
    }, H.RegisterShortcut(H.KEYCODE.E, "show", null, "E", !1, !1), H.RegisterShortcut(H.KEYCODE.B, "bold", null, "B", !1, !1), H.RegisterShortcut(H.KEYCODE.I, "italic", null, "I", !1, !1), H.RegisterShortcut(H.KEYCODE.U, "underline", null, "U", !1, !1), H.RegisterShortcut(H.KEYCODE.S, "strikeThrough", null, "S", !1, !1), H.RegisterShortcut(H.KEYCODE.CLOSE_SQUARE_BRACKET, "indent", null, "]", !1, !1), H.RegisterShortcut(H.KEYCODE.OPEN_SQUARE_BRACKET, "outdent", null, "[", !1, !1), H.RegisterShortcut(H.KEYCODE.Z, "undo", null, "Z", !1, !1), H.RegisterShortcut(H.KEYCODE.Z, "redo", null, "Z", !0, !1), H.RegisterShortcut(H.KEYCODE.Y, "redo", null, "Y", !1, !1), H.MODULES.shortcuts = function(a) {
        var r = null;
        var s = !1;

        function e(e) {
            if (!a.core.hasFocus()) return !0;
            var t = e.which,
                n = -1 !== navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey;
            if ("keyup" === e.type && s && t !== H.KEYCODE.META) return s = !1;
            "keydown" === e.type && (s = !1);
            var r = (e.shiftKey ? "^" : "") + (e.altKey ? "@" : "") + t;
            if (n && H.SHORTCUTS_MAP[r]) {
                var o = H.SHORTCUTS_MAP[r].cmd;
                if (o && 0 <= a.opts.shortcutsEnabled.indexOf(o)) {
                    var i = H.SHORTCUTS_MAP[r].val;
                    if (!1 === a.events.trigger("shortcut", [e, o, i])) return !(s = !0);
                    if (o && (a.commands[o] || H.COMMANDS[o] && H.COMMANDS[o].callback)) return e.preventDefault(), e.stopPropagation(), "keydown" === e.type && ((a.commands[o] || H.COMMANDS[o].callback)(), s = !0), !1
                }
            }
        }
        return {
            _init: function t() {
                a.events.on("keydown", e, !0), a.events.on("keyup", e, !0)
            },
            get: function o(e) {
                if (!a.opts.shortcutsHint) return null;
                if (!r)
                    for (var t in r = {}, H.SHORTCUTS_MAP) Object.prototype.hasOwnProperty.call(H.SHORTCUTS_MAP, t) && 0 <= a.opts.shortcutsEnabled.indexOf(H.SHORTCUTS_MAP[t].cmd) && (r["".concat(H.SHORTCUTS_MAP[t].cmd, ".").concat(H.SHORTCUTS_MAP[t].val || "")] = {
                        shift: H.SHORTCUTS_MAP[t].shift,
                        option: H.SHORTCUTS_MAP[t].option,
                        letter: H.SHORTCUTS_MAP[t].letter
                    });
                var n = r[e];
                return n ? (a.helpers.isMac() ? String.fromCharCode(8984) : "".concat(a.language.translate("Ctrl"), "+")) + (n.shift ? a.helpers.isMac() ? String.fromCharCode(8679) : "".concat(a.language.translate("Shift"), "+") : "") + (n.option ? a.helpers.isMac() ? String.fromCharCode(8997) : "".concat(a.language.translate("Alt"), "+") : "") + n.letter : null
            }
        }
                ...
                for (var r in e) {
                    ...
                    if (o.buttons) {
                        for (var i = "", a = "", s = 0, l = "left", c = H.TOOLBAR_VISIBLE_BUTTONS, d = 0; d < o.buttons.length; d++) {
                            var f = o.buttons[d],
                                p = H.COMMANDS[f];
                            !p || p && "undefined" != typeof p.plugin && g.opts.pluginsEnabled.indexOf(p.plugin) < 0 || (e[r].align !== undefined && (l = e[r].align), e[r].buttonsVisible !== undefined && (c = e[r].buttonsVisible), e.showMoreButtons && c <= s ? a += v(f, p, !0) : i += v(f, p, !0), s++)
                        }
        ...
        function o() {
            ...
            if (0 === e.top && 0 === e.left && 0 === e.width || 0 === e.height) {
                ...
                var r = n.offset(),
                    o = n.outerHeight();
                n.css("display", "none"), n.css("line-height", 0), (e = {}).left = r.left, e.width = 0, e.height = o, e.top = r.top - (S.helpers.isMobile() && !S.helpers.isIOS() || S.opts.iframe ? 0 : S.helpers.scrollTop()), e.right = 1, e.bottom = 1, e.ok = !0, t && S.selection.restore()
            }
            return e
        }
        ...
        function n(e, t) {
            setTimeout(function() {
                if ((!e || e.which !== H.KEYCODE.ESC) && m.selection.inEditor() && m.core.hasFocus() && !m.popups.areVisible() && (m.opts.toolbarVisibleWithoutSelection || !m.selection.isCollapsed() && !m.keys.isIME() || t)) {
    ...
    h.fn = h.prototype = {
        ...
        ajax: function(t) {
            ...
            var r = new FormData;
            for (var o in t.data) r.append(o, encodeURIComponent(t.data[o]));
            n.send(r)
        },
        prevAll: function() {
            var e = v();
    ...
    return E.Bootstrap = function(e, t, n) {
        ...
        this.$oel.parents("form").off(".".concat(this.id)), this.$oel.off("click.popup"), this.$oel.removeData("froala.editor"), this.$oel.off("froalaEditor"), this.core.destroy(e), E.INSTANCES.splice(E.INSTANCES.indexOf(this), 1)
    }, H
});