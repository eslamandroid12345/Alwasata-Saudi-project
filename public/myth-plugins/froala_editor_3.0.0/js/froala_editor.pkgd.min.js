...
! function(e, t) {
    ...
    function Fe(e, t, n) {
        if ("string" != typeof e) return new Fe.Bootstrap(e, t, n);
        var r = document.querySelectorAll(e);
        t && t.iframe_document && (r = t.iframe_document.querySelectorAll(e));
        for (var a = [], o = 0; o < r.length; o++) {
            var i = r[o]["data-froala.editor"];
            i ? a.push(i) : a.push(new Fe.Bootstrap(r[o], t, n))
        }
        return 1 == a.length ? a[0] : a
    }
    Fe.RegisterPlugins = function(e) {
        for (var t = 0; t < e.length; t++) e[t].call(Fe)
    }, Object.assign(Fe, {
        DEFAULTS: {
            initOnClick: !1,
            pluginsEnabled: null
        ...
        function l(e) {
            return !!e && (e.nodeType === Node.ELEMENT_NODE && 0 <= Fe.BLOCK_TAGS.indexOf(e.tagName.toLowerCase()))
        }
        ...
        return {
            ...
            isEmpty: function d(e, t) {
                ...
                return !(e.querySelectorAll(Fe.VOID_ELEMENTS.join(",")).length - e.querySelectorAll("br").length || e.querySelector("".concat(i.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),"), ":not(.fr-marker)")) || 1 < e.querySelectorAll(Fe.BLOCK_TAGS.join(",")).length || e.querySelector("".concat(i.opts.htmlDoNotWrapTags.join(":not(.fr-marker),"), ":not(.fr-marker)")))
            },
            ...
            deepestParent: function o(e, t, n) {
                if (void 0 === t && (t = []), void 0 === n && (n = !0), t.push(i.el), 0 <= t.indexOf(e.parentNode) || e.parentNode && i.node.hasClass(e.parentNode, "fr-inner") || e.parentNode && 0 <= Fe.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) && n) return null;
                for (; t.indexOf(e.parentNode) < 0 && e.parentNode && !i.node.hasClass(e.parentNode, "fr-inner") && (Fe.SIMPLE_ENTER_TAGS.indexOf(e.parentNode.tagName) < 0 || !n) && (!l(e) || !l(e.parentNode) || !n);) e = e.parentNode;
                return e
            },
            rawAttributes: c,
            attributes: t,
            ...
            contents: s,
            isVoid: function b(e) {
                return e && e.nodeType === Node.ELEMENT_NODE && 0 <= Fe.VOID_ELEMENTS.indexOf((e.tagName || "").toLowerCase())
            },
        ...
        function T(e) {
            ...
            ! function c(e) {
                ...
                if (e.nodeType === Node.ELEMENT_NODE && Fe.HTML5Map[e.tagName] && "" === f.node.attributes(e)) {
                    var t = Fe.HTML5Map[e.tagName],
        ...
        return {
            ...
            toHTML5: function r() {
                var e = f.el.querySelectorAll(Object.keys(Fe.HTML5Map).join(","));
                if (e.length) {
                    var t = !1;
                    f.el.querySelector(".fr-marker") || (f.selection.save(), t = !0);
                    for (var n = 0; n < e.length; n++) "" === f.node.attributes(e[n]) && g(e[n]).replaceWith("<".concat(Fe.HTML5Map[e[n].tagName], ">").concat(e[n].innerHTML, "</").concat(Fe.HTML5Map[e[n].tagName], ">"));
    ...
    Fe.LinkRegExCommon = "[".concat("a-z\\u0080-\\u009f\\u00a1-\\uffff0-9-_\\.", "]{1,}"), Fe.LinkRegExEnd = "((:[0-9]{1,5})|)(((\\/|\\?|#)[a-z\\u00a1-\\uffff0-9@?\\|!^=%&amp;\\/~+#-\\'*-_{}]*)|())", Fe.LinkRegExTLD = "((".concat(Fe.LinkRegExCommon, ")(\\.(com|net|org|edu|mil|gov|co|biz|info|me|dev)))"), Fe.LinkRegExHTTP = "((ftp|http|https):\\/\\/".concat(Fe.LinkRegExCommon, ")"), Fe.LinkRegExAuth = "((ftp|http|https):\\/\\/[\\u0021-\\uffff]{1,}@".concat(Fe.LinkRegExCommon, ")"), Fe.LinkRegExWWW = "(www\\.".concat(Fe.LinkRegExCommon, "\\.[a-z0-9-]{2,24})"), Fe.LinkRegEx = "(".concat(Fe.LinkRegExTLD, "|").concat(Fe.LinkRegExHTTP, "|").concat(Fe.LinkRegExWWW, "|").concat(Fe.LinkRegExAuth, ")").concat(Fe.LinkRegExEnd), Fe.LinkProtocols = ["mailto", "tel", "sms", "notes", "data"], Fe.MAIL_REGEX = /.+@.+\..+/i, Fe.MODULES.helpers = function(o) {
        var i, s = o.$;
        ...
        return {
            ...
            isEmail: function u(e) {
                return !/^(https?:|ftps?:|)\/\//i.test(e) && Fe.MAIL_REGEX.test(e)
            },
            ...
            sanitizeURL: function v(e) {
                return /^(https?:|ftps?:|)\/\//i.test(e) ? e : /^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i.test(e) ? e : new RegExp("^(".concat(Fe.LinkProtocols.join("|"), "):\\/\\/"), "i").test(e) ? e : e = encodeURIComponent(e).replace(/%23/g, "#").replace(/%2F/g, "/").replace(/%25/g, "%").replace(/mailto%3A/gi, "mailto:").replace(/file%3A/gi, "file:").replace(/sms%3A/gi, "sms:").replace(/tel%3A/gi, "tel:").replace(/notes%3A/gi, "notes:").replace(/data%3Aimage/gi, "data:image").replace(/blob%3A/gi, "blob:").replace(/%3A(\d)/gi, ":$1").replace(/webkit-fake-url%3A/gi, "webkit-fake-url:").replace(/%3F/g, "?").replace(/%3D/g, "=").replace(/%26/g, "&").replace(/&amp;/g, "&").replace(/%2C/g, ",").replace(/%3B/g, ";").replace(/%2B/g, "+").replace(/%40/g, "@").replace(/%5B/g, "[").replace(/%5D/g, "]").replace(/%7B/g, "{").replace(/%7D/g, "}")
            },
            isArray: function b(e) {
                return e && !Object.prototype.propertyIsEnumerable.call(e, "length") && "object" === Be(e) && "number" == typeof e.length
            },
            ...
            isURL: function A(e) {
                return !!/^(https?:|ftps?:|)\/\//i.test(e) && (e = String(e).replace(/</g, "%3C").replace(/>/g, "%3E").replace(/"/g, "%22").replace(/ /g, "%20"), new RegExp("^".concat(Fe.LinkRegExHTTP).concat(Fe.LinkRegExEnd, "$"), "gi").test(e))
            },
        ...
        function c(e) {
            ...
            if (l.selection.info(l.el).atStart && l.selection.isCollapsed() && null !== l.html.defaultTag()) {
                ...
                if (n && !l.node.blockParent(n)) {
                    ...
                    r && (o(r).prepend(Fe.MARKERS), l.selection.restore())
                } else n && o(n).remove()
            }
        }
        var d = !1;
                ...
                l.shared.$_events = l.shared.$_events || [], l.shared._events = {},
                    ...
                    function t() {
                        s(l.$el, "click mouseup mousedown touchstart touchend dragenter dragover dragleave dragend drop dragstart", function(e) {
                            ...
                            for (var e = 0; e < Fe.INSTANCES.length; e++) Fe.INSTANCES[e] !== l && Fe.INSTANCES[e].popups && Fe.INSTANCES[e].popups.areVisible() && Fe.INSTANCES[e].$el.find(".fr-marker").remove()
                        })
                    }(),
                    function n() {
    ...
    }, Fe.RegisterCommand = function(e, t) {
        Fe.COMMANDS[e] = t
    }, Fe.MODULES.commands = function(i) {
        var s = i.$;
        ...
        var o = {
            ...
            insertHR: function() {
                ...
                n.prev().is("hr") ? t = i.selection.setAfter(n.get(0), !1) : n.next().is("hr") ? t = i.selection.setBefore(n.get(0), !1) : i.selection.setAfter(n.get(0), !1) || i.selection.setBefore(n.get(0), !1), t || void 0 === t || (e = a(e = "".concat(Fe.MARKERS, "<br>")), n.after(e)), i.selection.restore()
            },
        ...
        function r(e) {
            ...
            for (var t = i.selection.blocks(), n = 0; n < t.length; n++)
                if ("LI" !== t[n].tagName && "LI" !== t[n].parentNode.tagName) {
                    var r = s(t[n]),
                        a = "rtl" === i.opts.direction || "rtl" === r.css("direction") ? "margin-right" : "margin-left",
                ...
                i.events.on("keydown", function(e) {
                    ...
                    if (t && "HR" === t.tagName)
                        if (e.which === Fe.KEYCODE.ARROW_LEFT || e.which === Fe.KEYCODE.ARROW_UP) {
                            if (t.previousSibling) return i.node.isBlock(t.previousSibling) ? i.selection.setAtEnd(t.previousSibling) : s(t).before(Fe.MARKERS), i.selection.restore(), !1
                        } else if ((e.which === Fe.KEYCODE.ARROW_RIGHT || e.which === Fe.KEYCODE.ARROW_DOWN) && t.nextSibling) return i.node.isBlock(t.nextSibling) ? i.selection.setAtStart(t.nextSibling) : s(t).after(Fe.MARKERS), i.selection.restore(), !1
                    ...
                    e === i.selection.endElement() && e && "HR" === e.tagName && (e.nextSibling && (i.node.isBlock(e.nextSibling) ? i.selection.setAtStart(e.nextSibling) : s(e).after(Fe.MARKERS)), i.selection.restore())
                })
            }
        })
    }, Fe.MODULES.cursorLists = function(g) {
        var m = g.$;
        ...
        return {
            _startEnter: function E(e) {
                ...
                if (g.node.isEmpty(n, !0) && r) {
                    ...
                    var c = "";
                    for (c = l.parentNode && "LI" === l.parentNode.tagName ? "".concat(s, "<li>").concat(Fe.MARKERS, "<br>").concat(i) : o ? "".concat(s, "<").concat(o, ">").concat(Fe.MARKERS, "<br></").concat(o, ">").concat(i) : "".concat(s + Fe.MARKERS, "<br>").concat(i);
                    ...
                    t = b(n);
                    for (var u = "".concat(Fe.MARKERS, "<br>"), h = e.parentNode; h && "LI" !== h.tagName;) u = g.node.openTagString(h) + u + g.node.closeTagString(h), h = h.parentNode;
                ...
                } else(t = b(n)).parentNode && "LI" === t.parentNode.tagName ? r ? m(t.parentNode).before("".concat(g.node.openTagString(n) + Fe.MARKERS, "<br></li>")) : m(t.parentNode).after("".concat(g.node.openTagString(n) + Fe.MARKERS, "<br></li>")) : o ? m(t).before("<".concat(o, ">").concat(Fe.MARKERS, "<br></").concat(o, ">")) : m(t).before("".concat(Fe.MARKERS, "<br>")), m(n).remove()
            },
            _middleEnter: function l(e) {
                for (var t = v(e), n = "", r = e, a = "", o = ""; r !== t;) {
                    var i = "A" === (r = r.parentNode).tagName && g.cursor.isAtEnd(e, r) ? "fr-to-remove" : "";
                    a = g.node.openTagString(m(r).clone().addClass(i).get(0)) + a, o = g.node.closeTagString(r) + o
                }
                n = o + n + a + Fe.MARKERS + (g.opts.keepFormatOnDelete ? Fe.INVISIBLE_SPACE : ""), m(e).replaceWith('<span id="fr-break"></span>');
                var s = g.node.openTagString(t) + m(t).html() + g.node.closeTagString(t);
                s = s.replace(/<span id="fr-break"><\/span>/g, n), m(t).replaceWith(s)
            },
            _endEnter: function c(e) {
                for (var t = v(e), n = Fe.MARKERS, r = "", a = e, o = !1; a !== t;) {
                    var i = "A" === (a = a.parentNode).tagName && g.cursor.isAtEnd(e, a) ? "fr-to-remove" : "";
                    o || a === t || g.node.isBlock(a) || (o = !0, r += Fe.INVISIBLE_SPACE), r = g.node.openTagString(m(a).clone().addClass(i).get(0)) + r, n += g.node.closeTagString(a)
                }
                var s = r + n;
            ...
            _backspace: function d(e) {
                var t = v(e),
                    n = t.previousSibling;
                if (n) {
                    n = m(n).find(g.html.blockTagsQuery()).get(-1) || n, m(e).replaceWith(Fe.MARKERS);
                    ...
                    var i = b(t);
                    if (m(e).replaceWith(Fe.MARKERS), i.parentNode && "LI" === i.parentNode.tagName) {
            ...
            _del: function f(e) {
                ...
                if (r) {
                    ...
                    m(e).replaceWith(Fe.MARKERS), m(r).remove()
                } else {
                    for (var s = n; !s.nextSibling && s !== g.el;) s = s.parentNode;
                    if (s === g.el) return !1;
                    if (s = s.nextSibling, g.node.isBlock(s)) Fe.NO_DELETE_TAGS.indexOf(s.tagName) < 0 && (m(e).replaceWith(Fe.MARKERS), (t = g.node.contents(n)).length && "BR" === t[t.length - 1].tagName && m(t[t.length - 1]).remove(), m(n).append(m(s).html()), m(s).remove());
                    else
                        for ((t = g.node.contents(n)).length && "BR" === t[t.length - 1].tagName && m(t[t.length - 1]).remove(), m(e).replaceWith(Fe.MARKERS); s && !g.node.isBlock(s) && "BR" !== s.tagName;) m(n).append(m(s)), s = s.nextSibling
                }
            }
        }
    }, Fe.NO_DELETE_TAGS = ["TH", "TD", "TR", "TABLE", "FORM"], Fe.SIMPLE_ENTER_TAGS = ["TH", "TD", "LI", "DL", "DT", "FORM"], Fe.MODULES.cursor = function(u) {
        var h = u.$;
        ...
        function f(e) {
            ...
            if (n = n.previousSibling, !u.node.isBlock(n) && u.node.isEditable(n)) {
                ...
                if (n.nodeType === Node.TEXT_NODE) {
                    ...
                    if (u.opts.tabSpaces && r.length >= u.opts.tabSpaces) 0 === r.substr(r.length - u.opts.tabSpaces, r.length - 1).replace(/ /g, "").replace(new RegExp(Fe.UNICODE_NBSP, "g"), "").length && (a = r.length - u.opts.tabSpaces + 1);
                    n.textContent = r.substring(0, a - d(r)), u.opts.htmlUntouched && !e.nextSibling && n.textContent.length && " " === n.textContent[n.textContent.length - 1] && (n.textContent = n.textContent.substring(0, n.textContent.length - 1) + h.FE.UNICODE_NBSP);
                    var o = r.length !== n.textContent.length;
                    if (0 === n.textContent.length)
                        if (o && u.opts.keepFormatOnDelete) h(n).after(Fe.INVISIBLE_SPACE + Fe.MARKERS);
                        else if (0 !== r.length && u.node.isBlock(n.parentNode)) h(n).after(Fe.MARKERS);
                            ...
                            for (; !u.node.isElement(n.parentNode) && u.node.isEmpty(n.parentNode) && Fe.NO_DELETE_TAGS.indexOf(n.parentNode.tagName) < 0;) {
                                var i = n;
                                n = n.parentNode, i.parentNode.removeChild(i)
                            }
                            h(n).after(Fe.MARKERS), u.node.isElement(n.parentNode) && !e.nextSibling && n.previousSibling && "BR" === n.previousSibling.tagName && h(e).after("<br>"), n.parentNode.removeChild(n)
                        } else h(n.parentNode).after(Fe.MARKERS), h(n.parentNode).remove();
                    else h(n).after(Fe.MARKERS)
                } else u.node.isDeletable(n) ? (h(n).after(Fe.MARKERS), h(n).remove()) : e.nextSibling && "BR" === e.nextSibling.tagName && u.node.isVoid(n) && "BR" !== n.tagName ? (h(e.nextSibling).remove(), h(e).replaceWith(Fe.MARKERS)) : !1 !== u.events.trigger("node.remove", [h(n)]) && (h(n).after(Fe.MARKERS), h(n).remove())
            } else if (Fe.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n)))
                if (u.node.isDeletable(n)) h(e).replaceWith(Fe.MARKERS), h(n).remove();
                else if (u.node.isEmpty(n) && !u.node.isList(n)) h(n).remove(), h(e).replaceWith(Fe.MARKERS);
                else {
        ...
        function s(e) {
            ...
            if (null !== n) {
                ...
                if (u.node.isBlock(n) && (u.node.isEditable(n) || u.node.isDeletable(n)) && o && Fe.NO_DELETE_TAGS.indexOf(o.tagName) < 0)
                    if (u.node.isDeletable(o)) h(o).remove(), h(e).replaceWith(Fe.MARKERS);
                    else if (u.node.isBlock(o) && u.node.isEditable(o))
                        if (u.node.isList(o))
                            if (u.node.isEmpty(n, !0)) h(n).remove(), h(o).find("li").first().prepend(Fe.MARKERS);
                            else {
                                var i = h(o).find("li").first();
                                "BLOCKQUOTE" === n.tagName && (a = u.node.contents(n)).length && u.node.isBlock(a[a.length - 1]) && (n = a[a.length - 1]), 0 === i.find("ul, ol").length && (h(e).replaceWith(Fe.MARKERS), i.find(u.html.blockTagsQuery()).not("ol, ul, table").each(function() {
                            ...
                            h(e).replaceWith(Fe.MARKERS), h(n).append(o.innerHTML), h(o).remove()
                        } else {
                        for (h(e).replaceWith(Fe.MARKERS); o && "BR" !== o.tagName && !u.node.isBlock(o) && u.node.isEditable(o);) {
                            var s = o;
        ...
        function n(e) {
            ...
            if ("BR" === (n = n.nextSibling).tagName && u.node.isEditable(n))
                if (n.nextSibling) {
                    if (u.node.isBlock(n.nextSibling) && u.node.isEditable(n.nextSibling)) {
                        if (!(Fe.NO_DELETE_TAGS.indexOf(n.nextSibling.tagName) < 0)) return void h(n).remove();
                        n = n.nextSibling, h(n.previousSibling).remove()
                    }
                } else if (o(n)) {
                    if (c(e)) u.cursorLists._del(e);
                    else u.node.deepestParent(n) && ((!u.node.isEmpty(u.node.blockParent(n)) || (u.node.blockParent(n).nextSibling && Fe.NO_DELETE_TAGS.indexOf(u.node.blockParent(n).nextSibling.tagName)) < 0) && h(n).remove(), s(e));
                    return
                }
            if (!u.node.isBlock(n) && u.node.isEditable(n)) {
                ...
                n.nodeType === Node.TEXT_NODE ? (h(n).before(Fe.MARKERS), n.textContent.length && (n.textContent = n.textContent.substring(d(n.textContent, !0), n.textContent.length))) : u.node.isDeletable(n) ? (h(n).before(Fe.MARKERS), h(n).remove()) : !1 !== u.events.trigger("node.remove", [h(n)]) && (h(n).before(Fe.MARKERS), h(n).remove()), h(e).remove()
            } else if (Fe.NO_DELETE_TAGS.indexOf(n.tagName) < 0 && (u.node.isEditable(n) || u.node.isDeletable(n)))
                if (u.node.isDeletable(n)) h(e).replaceWith(Fe.MARKERS), h(n).remove();
                else if (u.node.isList(n)) e.previousSibling ? (h(n).find("li").first().prepend(e), u.cursorLists._backspace(e)) : (h(n).find("li").first().prepend(Fe.MARKERS), h(e).remove());
                else if ((t = u.node.contents(n)) && "BR" === t[0].tagName && h(t[0]).remove(), t && "BLOCKQUOTE" === n.tagName) {
                    var r = t[0];
                    for (h(e).before(Fe.MARKERS); r && "BR" !== r.tagName;) {
                        var a = r;
                        r = r.nextSibling, h(e).before(a)
                    }
                    r && "BR" === r.tagName && h(r).remove()
                } else h(e).after(h(n).html()).after(Fe.MARKERS), h(n).remove()
        }
        ...
        function l(e, t, n) {
            ...
            if (a && "BLOCKQUOTE" === a.tagName) return m(e, a) ? (r = u.html.defaultTag(), t ? h(e).replaceWith("<br>" + Fe.MARKERS) : r ? h(a).after("<".concat(r, ">").concat(Fe.MARKERS, "<br></").concat(r, ">")) : h(a).after("".concat(Fe.MARKERS, "<br>")), h(e).remove()) : v(e, t, n), !1;
            if (null === a)(r = u.html.defaultTag()) && u.node.isElement(e.parentNode) ? h(e).replaceWith("<".concat(r, ">").concat(Fe.MARKERS, "<br></").concat(r, ">")) : !e.previousSibling || h(e.previousSibling).is("br") || e.nextSibling ? h(e).replaceWith("<br>".concat(Fe.MARKERS)) : h(e).replaceWith("<br>".concat(Fe.MARKERS, "<br>"));
            else {
                var o = e,
                    i = "";
                ...
                do {
                    if (o = o.parentNode, !t || o !== a || t && !u.node.isBlock(a))
                        if (l += u.node.closeTagString(o), o === a && u.node.isBlock(a)) c = d + c;
                            ...
                            var p = "A" === o.tagName && m(e, o) ? "fr-to-remove" : "";
        ...
        function v(e, t, n) {
            ...
            if (null === r) u.html.defaultTag() && e.parentNode === u.el ? h(e).replaceWith("<".concat(u.html.defaultTag(), ">").concat(Fe.MARKERS, "<br></").concat(u.html.defaultTag(), ">")) : (e.nextSibling && !u.node.isBlock(e.nextSibling) || h(e).after("<br>"), h(e).replaceWith("<br>".concat(Fe.MARKERS)));
            else {
                var a = e,
                    o = "";
                ...
                do {
                    ...
                    if (a = a.parentNode, "BLOCKQUOTE" === r.tagName && u.node.isEmpty(l) && !u.node.hasClass(l, "fr-marker") && h(l).contains(e) && h(l).after(e), "BLOCKQUOTE" !== r.tagName || !m(e, a) && !g(e, a))
                        if (!t || a !== r || t && !u.node.isBlock(r)) {
                            ...
                            var c = "A" === a.tagName && m(e, a) ? "fr-to-remove" : "";
                ...
                if ("BLOCKQUOTE" === r.tagName)
                    if (e.previousSibling && u.node.isBlock(e.previousSibling) && e.nextSibling && "BR" === e.nextSibling.tagName && (h(e.nextSibling).after(e), e.nextSibling && "BR" === e.nextSibling.tagName && h(e.nextSibling).remove()), t) o = i + o + Fe.MARKERS + s;
                    else {
                        var f = u.html.defaultTag();
                        o = "".concat(i + o + (f ? "<".concat(f, ">") : "") + Fe.MARKERS, "<br>").concat(f ? "</".concat(f, ">") : "").concat(s)
                    } else o = i + o + s + (d ? "" : Fe.INVISIBLE_SPACE) + Fe.MARKERS;
        ...
        return {
            enter: function b(e) {
                ...
                for (var n = t.parentNode; n && !u.node.isElement(n);) {
                    if ("false" === n.getAttribute("contenteditable")) return h(t).replaceWith(Fe.MARKERS), u.selection.restore(), !1;
                ...
                0 < h(t).parentsUntil(u.$el, "BLOCKQUOTE").length && (r = !0), h(t).parentsUntil(u.$el, "TD, TH").length && (r = !1), o(t) ? !c(t) || e || r ? l(t, e, r) : u.cursorLists._endEnter(t) : i(t) ? !c(t) || e || r ? function s(e, t, n) {
                    ...
                    if (a && "BLOCKQUOTE" === a.tagName)
                        if (g(e, a)) {
                            if (!t) return (r = u.html.defaultTag()) ? h(a).before("<".concat(r, ">").concat(Fe.MARKERS, "<br></").concat(r, ">")) : h(a).before("".concat(Fe.MARKERS, "<br>")), h(e).remove(), !1
                        } else m(e, a) ? l(e, t, !0) : v(e, t, !0);
                    if (null === a)(r = u.html.defaultTag()) && u.node.isElement(e.parentNode) ? h(e).replaceWith("<".concat(r, ">").concat(Fe.MARKERS, "<br></").concat(r, ">")) : h(e).replaceWith("<br>".concat(Fe.MARKERS));
                    else {
                        if (u.node.isBlock(a))
                            if ("PRE" === a.tagName && (t = !0), t) h(e).remove(), h(a).prepend("<br>".concat(Fe.MARKERS));
                            else {
                                if (u.node.isEmpty(a, !0)) return l(e, t, n);
                                if (u.opts.keepFormatOnDelete) {
                                    for (var o = e, i = Fe.INVISIBLE_SPACE; o !== a && !u.node.isElement(o);) o = o.parentNode, i = u.node.openTagString(o) + i + u.node.closeTagString(o);
                                    h(a).before(i)
            ...
            backspace: function E() {
                ...
                return o(t) ? c(t) && g(t, h(t).parents("li:first").get(0)) ? u.cursorLists._backspace(t) : e = f(t) : i(t) ? c(t) && g(t, h(t).parents("li").first().get(0)) ? u.cursorLists._backspace(t) : function l(e) {
                    for (var t = 0 < h(e).parentsUntil(u.$el, "BLOCKQUOTE").length, n = u.node.deepestParent(e, [], !t), r = n; n && !n.previousSibling && "BLOCKQUOTE" !== n.tagName && n.parentElement !== u.el && !u.node.hasClass(n.parentElement, "fr-inner") && Fe.SIMPLE_ENTER_TAGS.indexOf(n.parentElement.tagName) < 0;) n = n.parentElement;
                    if (n && "BLOCKQUOTE" === n.tagName) {
                    ...
                    if (null !== n) {
                        ...
                        if (u.node.isBlock(n) && u.node.isEditable(n))
                            if (i && Fe.NO_DELETE_TAGS.indexOf(i.tagName) < 0) {
                                if (u.node.isDeletable(i)) h(i).remove(), h(e).replaceWith(Fe.MARKERS);
                                else if (u.node.isEditable(i))
                                    if (u.node.isBlock(i))
                                        if (u.node.isEmpty(i) && !u.node.isList(i)) h(i).remove(), h(e).after(u.opts.keepFormatOnDelete ? Fe.INVISIBLE_SPACE : "");
                                        else {
                                        ...
                                        } else h(e).replaceWith(Fe.MARKERS), "BLOCKQUOTE" === n.tagName && i.nodeType === Node.ELEMENT_NODE ? h(i).remove() : (h(i).after(u.node.isEmpty(n) ? "" : h(n).html()), h(n).remove(), "BR" === i.tagName && h(i).remove())
                            } else i || n && "BLOCKQUOTE" === n.tagName && 0 === h(n).text().replace(/\u200B/g, "").length && h(n).remove()
                    }
        ...
        function b(e, t, n) {
            if (e) {
                ...
                if (e) {
                    if (m.node.isBlock(e) && "HR" !== e.tagName) return b(e.firstChild, t, n), !1;
                    ...
                    if (a)(v(a).find(".fr-marker").length || "UL" === a.tagName || "OL" === a.tagName) && b(a.firstChild, t, n);
                    else {
                        for (var i = r.get(0).parentNode; i && !i.nextSibling && !m.node.isElement(i);) i = i.parentNode;
                        if (i) {
                            var s = i.nextSibling;
                            s && (m.node.isBlock(s) ? "HR" === s.tagName ? b(s.nextSibling, t, n) : b(s.firstChild, t, n) : b(s, t, n))
                        }
                    }
                    r.is(":empty") && r.remove()
                }
        ...
        function n(e, t) {
            ...
            if (void 0 === t && (t = {}), t.style && delete t.style, m.selection.isCollapsed()) {
                m.markers.insert(), m.$el.find(".fr-marker").replaceWith(function i(e, t) {
                    var n = "<".concat(e);
                    for (var r in t) Object.prototype.hasOwnProperty.call(t, r) && (n += " ".concat(r, '="').concat(t[r], '"'));
                    return n += ">"
                }(e, t) + Fe.INVISIBLE_SPACE + Fe.MARKERS + function s(e) {
                    return "</".concat(e, ">")
                }(e)), m.selection.restore()
            } else {
                var r;
                m.selection.save(), b(m.$el.find('.fr-marker[data-type="true"]').get(0).nextSibling, e, t);
                do {
                    for (r = m.$el.find("".concat(f(e, t), " > ").concat(f(e, t))), n = 0; n < r.length; n++) r[n].outerHTML = r[n].innerHTML
                } while (r.length);
                m.el.normalize();
                var a = m.el.querySelectorAll(".fr-marker");
                for (n = 0; n < a.length; n++) {
                    var o = v(a[n]);
                    !0 === o.data("type") ? p(o.get(0).nextSibling, f(e, t)) && o.next().prepend(o) : p(o.get(0).previousSibling, f(e, t)) && o.prev().append(o)
                }
                m.selection.restore()
            }
        }
        ...
        function E(e, t, n, r) {
            ...
            if (e.parents(t).length || void 0 === t) {
                ...
                for (; !(m.node.isBlock(s.parent().get(0)) || void 0 !== t && p(s.get(0), f(t, n)));) o += m.node.closeTagString(s.get(0)), i = m.node.openTagString(s.get(0)) + i, s = s.parent();
        ...
        function r(e, t) {
            ...
            for (var r = !0; r;) {
                ...
                for (var a = m.$el.find(".fr-marker"), o = 0; o < a.length; o++) {
                    var i = v(a[o]),
                        s = null;
                    if (i.attr("data-cloned") || n || (s = i.clone().removeClass("fr-marker").addClass("fr-clone"), !0 === i.data("type") ? i.attr("data-cloned", !0).after(s) : i.attr("data-cloned", !0).before(s)), E(i, e, t, n)) {
                        r = !0;
                        break
                    }
                }
                    ...
                    if (m.node.hasClass(i, "fr-marker")) t = (t + 1) % 2;
                        ...
                        if (0 < v(i).find(".fr-marker").length) t = d(v(i), t, n, r);
                            ...
                            for (var s = v(i).find(n || "*:not(br)"), l = s.length - 1; 0 <= l; l--) {
                                var c = s[l];
                                m.node.isBlock(c) || m.node.isVoid(c) || void 0 !== n && !p(c, f(n, r)) ? m.node.isBlock(c) && void 0 === n && "TABLE" !== i.tagName && m.node.clearAttributes(c) : m.node.hasClass(c, "fr-clone") || (c.outerHTML = c.innerHTML)
                            }
                            void 0 === n && i.nodeType === Node.ELEMENT_NODE && !m.node.isVoid(i) || p(i, f(n, r)) ? m.node.isBlock(i) || m.node.hasClass(i, "fr-clone") || (i.outerHTML = i.innerHTML) : void 0 === n && i.nodeType === Node.ELEMENT_NODE && m.node.isBlock(i) && "TABLE" !== i.tagName && m.node.clearAttributes(i)
                        } else 0 < v(i).find(".fr-marker").length && (t = d(v(i), t, n, r))
                }
                return t
            }(m.$el, 0, e, t), n || (m.$el.find(".fr-marker").remove(), m.$el.find(".fr-clone").removeClass("fr-clone").addClass("fr-marker")), n && m.$el.find(".fr-marker").before(Fe.INVISIBLE_SPACE).after(Fe.INVISIBLE_SPACE), m.html.cleanEmptyTags(), m.el.normalize(), m.selection.restore()
        }
        ...
        function t(e, t) {
            ...
            if (m.selection.isCollapsed()) {
                ...
                if (m.node.openTagString(l.get(0)) === '<span style="'.concat(e, ": ").concat(l.css(e), ';">')) {
                    if (m.node.isEmpty(l.get(0))) s = v(m.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(Fe.INVISIBLE_SPACE).concat(Fe.MARKERS)), l.replaceWith(s);
                    else {
                        var c = {};
                        c["style*"] = "".concat(e, ":"), E(r, "span", c, !0), r = m.$el.find(".fr-marker"), t ? (s = v(m.doc.createElement("span")).attr("style", "".concat(e, ": ").concat(t, ";")).html("".concat(Fe.INVISIBLE_SPACE).concat(Fe.MARKERS)), r.replaceWith(s)) : r.replaceWith(Fe.INVISIBLE_SPACE + Fe.MARKERS)
                    }
                    m.html.cleanEmptyTags()
                } else m.node.isEmpty(l.get(0)) && l.is("span") ? (r.replaceWith(Fe.MARKERS), l.css(e, t)) : (s = v('<span style="'.concat(e, ": ").concat(t, ';">').concat(Fe.INVISIBLE_SPACE).concat(Fe.MARKERS, "</span>")), r.replaceWith(s));
                s && T(s, e, t)
            } else {
        ...
        function T(e, t, n) {
            ...
            if ((i = i.not(s)).length) {
                ...
                v(i.get(0)).replaceWith(h.replace(/<span id="fr-break"><\/span>/g, u))
            }
        }
        ...
        function a(e, t) {
            ...
            for (var a = r; a && a.nodeType === Node.ELEMENT_NODE && !p(a, f(e, t));) a = a.firstChild;
            if (a && a.nodeType === Node.ELEMENT_NODE && p(a, f(e, t))) return !0;
            var o = r;
            for (o && o.nodeType !== Node.ELEMENT_NODE && (o = o.parentNode); o && o.nodeType === Node.ELEMENT_NODE && o !== m.el && !p(o, f(e, t));) o = o.parentNode;
            return !(!o || o.nodeType !== Node.ELEMENT_NODE || o === m.el || !p(o, f(e, t)))
        }
        return {
            is: a,
        ...
        function l() {
            ...
            try {
                ...
                var n = e.cloneRange(),
                    r = e.cloneRange();
                n.collapse(!0);
                var a = f(d.doc.createElement("SPAN")).addClass("fr-marker").attr("style", "display: none; line-height: 0;").html(Fe.INVISIBLE_SPACE).get(0);
            ...
            place: function p(e, t, n) {
                ...
                try {
                    ...
                    if (i.collapse(t), i.insertNode(function l(e, t) {
                        ...
                        return n.addClass("fr-marker").attr("data-id", t).attr("data-type", e).attr("style", "display: ".concat(d.browser.safari ? "none" : "inline-block", "; line-height: 0;")).html(Fe.INVISIBLE_SPACE), n.get(0)
                    }(t, n)), !0 === t)
    ...
    }, Fe.MODULES.selection = function(A) {
        var C = A.$;
        ...
        function o(e, t) {
            ...
            for (r.setAttribute("id", "fr-sel-markers"), r.innerHTML = Fe.MARKERS; e.parentNode && A.opts.htmlAllowedEmptyTags && 0 <= A.opts.htmlAllowedEmptyTags.indexOf(e.tagName.toLowerCase());) e = e.parentNode;
            e.appendChild(r);
        ...
        return {
            ...
            isFull: function i() {
                ...
                for (e = 0; e < t.length; e++) t[e].nextSibling && (t[e].innerHTML = '<span class="fr-mk">'.concat(Fe.INVISIBLE_SPACE, "</span>").concat(t[e].innerHTML));
                var n = !1,
                    r = a(A.el);
            ...
            remove: function N() {
                ...
                if (function E() {
                    ...
                    ! function T(e, t) {
                        ...
                        0 <= ["TD", "TH"].indexOf(e.get(0).tagName) && 1 === e.find(".fr-marker").length && A.node.hasClass(n[0], "fr-marker") && e.attr("data-del-cell", !0);
                        for (var r = 0; r < n.length; r++) {
                            var a = n[r];
                    ...
                    if (s.length) A.$el.find(".fr-marker").remove(), s.append(Fe.INVISIBLE_SPACE + Fe.MARKERS).removeAttr("data-first"), s.attr("data-text") && s.replaceWith(s.html());
                    else
            ...
            setBefore: function h(e, t) {
                ...
                return n ? (A.node.isBlock(n) ? o(n) : "BR" === n.tagName ? C(n).before(Fe.MARKERS) : C(n).after(Fe.MARKERS), !0) : !!t && (A.node.isBlock(e) ? r(e) : C(e).before(Fe.MARKERS), !0)
            },
            setAfter: function g(e, t) {
                void 0 === t && (t = !0);
                for (var n = e.nextSibling; n && n.nodeType === Node.TEXT_NODE && 0 === n.textContent.length;) n = n.nextSibling;
                return n ? (A.node.isBlock(n) ? r(n) : C(n).before(Fe.MARKERS), !0) : !!t && (A.node.isBlock(e) ? o(e) : C(e).after(Fe.MARKERS), !0)
            },
            rangeElement: f
        }
    }, Object.assign(Fe.DEFAULTS, {
        language: null
    }), Fe.LANGUAGE = {}, Fe.MODULES.language = function(e) {
        var t;
        return {
            _init: function n() {
                Fe.LANGUAGE && (t = Fe.LANGUAGE[e.opts.language]), t && t.direction && (e.opts.direction = t.direction)
            },
    ...
    }), Fe.MODULES.placeholder = function(f) {
        var p = f.$;
    ...
    }, Fe.UNICODE_NBSP = String.fromCharCode(160), Fe.VOID_ELEMENTS = ["area", "base", "br", "col", "embed", "hr", "img", "input", "keygen", "link", "menuitem", "meta", "param", "source", "track", "wbr"], Fe.BLOCK_TAGS = ["address", "article", "aside", "audio", "blockquote", "canvas", "details", "dd", "div", "dl", "dt", "fieldset", "figcaption", "figure", "footer", "form", "h1", "h2", "h3", "h4", "h5", "h6", "header", "hgroup", "hr", "li", "main", "nav", "noscript", "ol", "output", "p", "pre", "section", "table", "tbody", "td", "tfoot", "th", "thead", "tr", "ul", "video"], Object.assign(Fe.DEFAULTS, {
    ...
    }), Fe.MODULES.html = function(N) {
        var p = N.$;

        function d() {
            return N.opts.enter === Fe.ENTER_P ? "p" : N.opts.enter === Fe.ENTER_DIV ? "div" : N.opts.enter === Fe.ENTER_BR ? null : void 0
        }
        ...
        function o(e) {
            ...
            var l = u();
            for (l += ",".concat(Fe.VOID_ELEMENTS.join(",")), l += ", .fr-inner", l += ",".concat(N.opts.htmlAllowedEmptyTags.join(":not(.fr-marker),"), ":not(.fr-marker)"), t = r.length - 1; 0 <= t; t--)
        ...
        function e(e) {
            var t, n, r = p.merge([], Fe.VOID_ELEMENTS);
            r = p.merge(r, N.opts.htmlAllowedEmptyTags), r = void 0 === e ? p.merge(r, Fe.BLOCK_TAGS) : p.merge(r, Fe.NO_DELETE_TAGS), t = N.el.querySelectorAll("*:empty:not(".concat(r.join("):not("), "):not(.fr-marker)"));
            do {
                n = !1;
        ...
        function c(e) {
            ...
            if (t && (N.node.isBlock(t) || N.node.isElement(t)) && ["TD", "TH"].indexOf(t.tagName) < 0) {
                ...
                if (r) return !1;
                n && t && "BR" !== n.tagName && !N.node.isBlock(n) && !r && 0 < t.textContent.replace(/\u200B/g, "").length && 0 < n.textContent.length && !N.node.hasClass(n, "fr-marker") && (N.el === t && !r && N.opts.enter === Fe.ENTER_BR && N.browser.msie || e.parentNode.removeChild(e))
        ...
        return {
            ...
            emptyBlockTagsQuery: function A() {
                return "".concat(Fe.BLOCK_TAGS.join(":empty, "), ":empty")
            },
            blockTagsQuery: u,
            fillEmptyBlocks: function C(e) {
                var t = o(e);
                N.node.isEmpty(N.el) && N.opts.enter === Fe.ENTER_BR && t.push(N.el);
                ...
                if (N.browser.msie && N.opts.enter === Fe.ENTER_BR) {
    ...
    }, Fe.ENTER_P = 0, Fe.ENTER_DIV = 1, Fe.ENTER_BR = 2, Fe.KEYCODE = {
        BACKSPACE: 8,
        TAB: 9,
        ENTER: 13,
        SHIFT: 16,
        ...
        function a() {
            p.selection.isFull() && setTimeout(function() {
                ...
                e ? p.$el.html("<".concat(e, ">").concat(Fe.MARKERS, "<br/></").concat(e, ">")) : p.$el.html("".concat(Fe.MARKERS, "<br/>")), p.selection.restore(), p.placeholder.refresh(), p.button.bulkRefresh(), p.undo.saveStep()
            }, 0)
        }
        ...
        function g() {
            var e = p.html.defaultTag();
            e ? p.$el.html("<".concat(e, ">").concat(Fe.MARKERS, "<br/></").concat(e, ">")) : p.$el.html("".concat(Fe.MARKERS, "<br/>")), p.selection.restore()
        }
        ...
        function s(e) {
            ...
            var n = e.which;
            if (16 === n) return !0;
            if ((u = n) === Fe.KEYCODE.IME) return h = !0;
            h = !1;
            var r = b(n) && !m(e) && !e.altKey,
                a = n === Fe.KEYCODE.BACKSPACE || n === Fe.KEYCODE.DELETE;
            ...
            n === Fe.KEYCODE.ENTER ? e.shiftKey ? function o(e) {
            ...
            }(e) : n === Fe.KEYCODE.BACKSPACE && (e.metaKey || e.ctrlKey) ? function s() {
                setTimeout(function() {
                    p.events.disableBlur(), p.events.focus()
                }, 0)
            }() : n !== Fe.KEYCODE.BACKSPACE || m(e) || e.altKey ? n !== Fe.KEYCODE.DELETE || m(e) || e.altKey || e.shiftKey ? n === Fe.KEYCODE.SPACE ? function l(e) {
                var t = p.selection.element();
                if (!p.helpers.isMobile() && t && "A" === t.tagName) {
                    ...
                    if (n) {
                        ...
                        !n.nextSibling && n.parentNode && "A" === n.parentNode.tagName ? (n.parentNode.insertAdjacentHTML("afterend", "&nbsp;".concat(Fe.MARKERS)), n.parentNode.removeChild(n)) : (r && r.nodeType === Node.TEXT_NODE && 1 === r.textContent.length && 160 === r.textContent.charCodeAt(0) ? r.textContent += " " : n.insertAdjacentHTML("beforebegin", "&nbsp;"), n.outerHTML = Fe.MARKERS), p.selection.restore()
                    }
                }
            }(e) : n === Fe.KEYCODE.TAB ? function c(e) {
                ...
                e.preventDefault(), e.stopPropagation(), "" === p.selection.text() ? p.cursor.del() : p.selection.remove(), p.placeholder.refresh()
        ...
        function c(e) {
            ...
            if (h) return !1;
            if (e && p.helpers.isIOS() && e.which === Fe.KEYCODE.ENTER && p.doc.execCommand("undo"), !p.selection.isCollapsed()) return !0;
            if (e && (e.which === Fe.KEYCODE.META || e.which === Fe.KEYCODE.CTRL)) return !0;
            if (e && v(e.which)) return !0;
            if (e && !p.helpers.isIOS() && (e.which === Fe.KEYCODE.ENTER || e.which === Fe.KEYCODE.BACKSPACE || 37 <= e.which && e.which <= 40 && !p.browser.msie)) try {
                l()
            } catch (r) {}
        ...
        function v(e) {
            if (e >= Fe.KEYCODE.ARROW_LEFT && e <= Fe.KEYCODE.ARROW_DOWN) return !0
        }

        function b(e) {
            if (e >= Fe.KEYCODE.ZERO && e <= Fe.KEYCODE.NINE) return !0;
            if (e >= Fe.KEYCODE.NUM_ZERO && e <= Fe.KEYCODE.NUM_MULTIPLY) return !0;
        ...
        function d(e) {
            var t = e.which;
            if (m(e) || 37 <= t && t <= 40 || !b(t) && t !== Fe.KEYCODE.DELETE && t !== Fe.KEYCODE.BACKSPACE && t !== Fe.KEYCODE.ENTER && t !== Fe.KEYCODE.IME) return !0;
        ...
        function T(e) {
            var t = p.el.childNodes,
                n = p.html.defaultTag();
            return !(!e.target || e.target === p.el) || (0 === t.length || void(p.$el.outerHeight() - e.offsetY <= 10 ? E(t[t.length - 1]) && (n ? p.$el.append("<".concat(n, ">").concat(Fe.MARKERS, "<br></").concat(n, ">")) : p.$el.append("".concat(Fe.MARKERS, "<br>")), p.selection.restore(), l()) : e.offsetY <= 10 && E(t[0]) && (n ? p.$el.prepend("<".concat(n, ">").concat(Fe.MARKERS, "<br></").concat(n, ">")) : p.$el.prepend("".concat(Fe.MARKERS, "<br>")), p.selection.restore(), l())))
        }
        ...
        function t(e) {
            ...
            if (e && e.clipboardData && e.clipboardData.getData) {
                ...
                if (i = "", /text\/rtf/.test(t) && (s = e.clipboardData.getData("text/rtf")), /text\/html/.test(t) && !L.browser.safari ? i = e.clipboardData.getData("text/html") : /text\/rtf/.test(t) && L.browser.safari ? i = s : /public.rtf/.test(t) && L.browser.safari && (i = e.clipboardData.getData("text/rtf")), "" !== i) return c(), e.preventDefault && (e.stopPropagation(), e.preventDefault()), !1;
                i = null
            }
            return function a() {
            ...
            if (e.originalEvent && (e = e.originalEvent), e && e.dataTransfer && e.dataTransfer.getData) {
                ...
                if (i = "", /text\/rtf/.test(t) && (s = e.dataTransfer.getData("text/rtf")), /text\/html/.test(t) ? i = e.dataTransfer.getData("text/html") : /text\/rtf/.test(t) && L.browser.safari ? i = s : /text\/plain/.test(t) && !this.browser.mozilla && (i = L.html.escapeEntities(e.dataTransfer.getData("text/plain")).replace(/\n/g, "<br>")), "" !== i) {
                    ...
                    if (L.$el.find(".fr-marker").removeClass("fr-marker").addClass("fr-marker-placeholder"), L.$el.find(".fr-marker-helper").addClass("fr-marker").removeClass("fr-marker-helper"), L.selection.restore(), L.selection.remove(), L.$el.find(".fr-marker-placeholder").addClass("fr-marker").removeClass("fr-marker-placeholder"), !1 !== a) {
                        ...
                        return _(o).replaceWith(Fe.MARKERS), L.selection.restore(), c(), e.preventDefault && (e.stopPropagation(), e.preventDefault()), !1
                    }
                } else i = null
            }
        }
        ...
        function a(e, t, n) {
            ...
            if ("string" == typeof d && (e = d), "" !== e) {
                ...
                else if (L.opts.enter === Fe.ENTER_DIV)
                    for (r = (a = f.getElementsByTagName("p")).length - 1; 0 <= r; r--) 0 === (o = a[r]).attributes.length && (o.outerHTML = "<div>".concat(o.innerHTML, "</div>"));
                else L.opts.enter === Fe.ENTER_P && 1 === f.childNodes.length && "P" === f.childNodes[0].tagName && 0 === f.childNodes[0].attributes.length && (f.childNodes[0].outerHTML = f.childNodes[0].innerHTML);
                e = f.innerHTML, l && (e = function y(e) {
                    var t, n = L.o_doc.createElement("div");
                    n.innerHTML = e;
                    var r = n.querySelectorAll("*:empty:not(td):not(th):not(tr):not(iframe):not(svg):not(".concat(Fe.VOID_ELEMENTS.join("):not("), "):not(").concat(L.opts.htmlAllowedEmptyTags.join("):not("), ")"));
                    for (; r.length;) {
                        for (t = 0; t < r.length; t++) r[t].parentNode.removeChild(r[t]);
                        r = n.querySelectorAll("*:empty:not(td):not(th):not(tr):not(iframe):not(svg):not(".concat(Fe.VOID_ELEMENTS.join("):not("), "):not(").concat(L.opts.htmlAllowedEmptyTags.join("):not("), ")"))
                    }
                    return n.innerHTML
                }(e)), L.html.insert(e, !0)
            }! function R() {
        ...
        shortcutsEnabled: [],
        shortcutsHint: !0
    }), Fe.SHORTCUTS_MAP = {}, Fe.RegisterShortcut = function(e, t, n, r, a, o) {
        Fe.SHORTCUTS_MAP[(a ? "^" : "") + (o ? "@" : "") + e] = {
            cmd: t,
            val: n,
            letter: r,
            shift: a,
            option: o
        }, Fe.DEFAULTS.shortcutsEnabled.push(t)
    }, Fe.RegisterShortcut(Fe.KEYCODE.E, "show", null, "E", !1, !1), Fe.RegisterShortcut(Fe.KEYCODE.B, "bold", null, "B", !1, !1), Fe.RegisterShortcut(Fe.KEYCODE.I, "italic", null, "I", !1, !1), Fe.RegisterShortcut(Fe.KEYCODE.U, "underline", null, "U", !1, !1), Fe.RegisterShortcut(Fe.KEYCODE.S, "strikeThrough", null, "S", !1, !1), Fe.RegisterShortcut(Fe.KEYCODE.CLOSE_SQUARE_BRACKET, "indent", null, "]", !1, !1), Fe.RegisterShortcut(Fe.KEYCODE.OPEN_SQUARE_BRACKET, "outdent", null, "[", !1, !1), Fe.RegisterShortcut(Fe.KEYCODE.Z, "undo", null, "Z", !1, !1), Fe.RegisterShortcut(Fe.KEYCODE.Z, "redo", null, "Z", !0, !1), Fe.RegisterShortcut(Fe.KEYCODE.Y, "redo", null, "Y", !1, !1), Fe.MODULES.shortcuts = function(i) {
        var r = null;
        var s = !1;

        function e(e) {
            if (!i.core.hasFocus()) return !0;
            var t = e.which,
                n = -1 !== navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey;
            if ("keyup" === e.type && s && t !== Fe.KEYCODE.META) return s = !1;
            "keydown" === e.type && (s = !1);
            var r = (e.shiftKey ? "^" : "") + (e.altKey ? "@" : "") + t;
            if (n && Fe.SHORTCUTS_MAP[r]) {
                var a = Fe.SHORTCUTS_MAP[r].cmd;
                if (a && 0 <= i.opts.shortcutsEnabled.indexOf(a)) {
                    var o = Fe.SHORTCUTS_MAP[r].val;
                    if (!1 === i.events.trigger("shortcut", [e, a, o])) return !(s = !0);
                    if (a && (i.commands[a] || Fe.COMMANDS[a] && Fe.COMMANDS[a].callback)) return e.preventDefault(), e.stopPropagation(), "keydown" === e.type && ((i.commands[a] || Fe.COMMANDS[a].callback)(), s = !0), !1
                }
            }
        }
        return {
            _init: function t() {
                i.events.on("keydown", e, !0), i.events.on("keyup", e, !0)
            },
            get: function a(e) {
                if (!i.opts.shortcutsHint) return null;
                if (!r)
                    for (var t in r = {}, Fe.SHORTCUTS_MAP) Object.prototype.hasOwnProperty.call(Fe.SHORTCUTS_MAP, t) && 0 <= i.opts.shortcutsEnabled.indexOf(Fe.SHORTCUTS_MAP[t].cmd) && (r["".concat(Fe.SHORTCUTS_MAP[t].cmd, ".").concat(Fe.SHORTCUTS_MAP[t].val || "")] = {
                        shift: Fe.SHORTCUTS_MAP[t].shift,
                        option: Fe.SHORTCUTS_MAP[t].option,
                        letter: Fe.SHORTCUTS_MAP[t].letter
                    });
                var n = r[e];
                return n ? (i.helpers.isMac() ? String.fromCharCode(8984) : "".concat(i.language.translate("Ctrl"), "+")) + (n.shift ? i.helpers.isMac() ? String.fromCharCode(8679) : "".concat(i.language.translate("Shift"), "+") : "") + (n.option ? i.helpers.isMac() ? String.fromCharCode(8997) : "".concat(i.language.translate("Alt"), "+") : "") + n.letter : null
            }
        }
    }, Fe.MODULES.snapshot = function(l) {
        function n(e) {
    ...
    }, Fe.MODULES.undo = function(n) {
        function e(e) {
            var t = e.which;
            n.keys.ctrlKey(e) && (t === Fe.KEYCODE.Z && e.shiftKey && e.preventDefault(), t === Fe.KEYCODE.Z && e.preventDefault())
        }
        var t = null;
        ...
        return {
            _init: function a() {
                if (Fe.INSTANCES.push(i), function e() {
                    i.drag_support = {
        ...
        "text.edit": "[_EDIT_]"
    }, Fe.RegisterTemplate = function(e, t) {
        Fe.POPUP_TEMPLATES[e] = t
    }, Fe.MODULES.popups = function(f) {
        var d = f.$;
        ...
        function E(r) {
            ...
            return {
                ...
                _editorKeydown: function(e) {
                    var t = a.data("instance") || f;
                    t.keys.ctrlKey(e) || e.which === Fe.KEYCODE.ALT || e.which === Fe.KEYCODE.ESC || (g(r) && a.findVisible(".fr-back").length ? t.button.exec(a.findVisible(".fr-back").first()) : e.which !== Fe.KEYCODE.ALT && t.popups.hide(r))
                },
    ...
    }, Fe.MODULES.accessibility = function(f) {
        var p = f.$,
            o = !0;
        ...
        function e(e) {
            ...
            if (e.which !== Fe.KEYCODE.F10 || t || e.shiftKey || !e.altKey) return !0;
            f.shared.with_kb = !0;
        ...
        return {
            ...
            exec: function _(e, t) {
                var n = -1 !== navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey,
                    r = e.which,
                    a = !1;
                return r !== Fe.KEYCODE.TAB || n || e.shiftKey || e.altKey ? r !== Fe.KEYCODE.ARROW_RIGHT || n || e.shiftKey || e.altKey ? r !== Fe.KEYCODE.TAB || n || !e.shiftKey || e.altKey ? r !== Fe.KEYCODE.ARROW_LEFT || n || e.shiftKey || e.altKey ? r !== Fe.KEYCODE.ARROW_UP || n || e.shiftKey || e.altKey ? r !== Fe.KEYCODE.ARROW_DOWN || n || e.shiftKey || e.altKey ? r !== Fe.KEYCODE.ENTER && r !== Fe.KEYCODE.SPACE || n || e.shiftKey || e.altKey ? r !== Fe.KEYCODE.ESC || n || e.shiftKey || e.altKey ? r !== Fe.KEYCODE.F10 || n || e.shiftKey || !e.altKey || (a = c()) : a = function o(e) {
                    if (f.shared.$f_el) {
                        var t = d();
    ...
    }, Fe.TOOLBAR_VISIBLE_BUTTONS = 3, Fe.MODULES.button = function(g) {
        var h = g.$,
            i = [];
        ...
        function t(e) {
            ...
            if (0 === e.parents(".fr-popup").length && e.data("popup") && !e.hasClass("fr-btn-active-popup") && e.addClass("fr-btn-active-popup"), 0 !== e.parents(".fr-popup").length || e.data("popup") || t.popups.hideAll(), t.popups.areVisible() && !t.popups.areVisible(t)) {
                for (var n = 0; n < Fe.INSTANCES.length; n++) Fe.INSTANCES[n] !== t && Fe.INSTANCES[n].popups && Fe.INSTANCES[n].popups.areVisible() && Fe.INSTANCES[n].$el.find(".fr-marker").remove();
                t.popups.hideAll()
            }
            g.node.hasClass(e.get(0), "fr-dropdown") ? a(e) : (! function r(e) {
                o(e)
            }(e), Fe.COMMANDS[e.data("cmd")] && !1 !== Fe.COMMANDS[e.data("cmd")].refreshAfterCallback && t.button.bulkRefresh())
        }
        ...
        function e(a) {
            ...
            setTimeout(function() {
                for (var e = o.selection.inEditor() && o.core.hasFocus(), t = 0; t < a.length; t++) {
                    var n = h(a[t]),
                        r = n.data("cmd");
                    0 === n.parents(".fr-popup").length ? e || Fe.COMMANDS[r] && Fe.COMMANDS[r].forcedRefresh ? o.button.refresh(n) : g.node.hasClass(n.get(0), "fr-dropdown") || (n.removeClass("fr-active"), n.attr("aria-pressed") && n.attr("aria-pressed", !1)) : n.parents(".fr-popup").isVisible() && o.button.refresh(n)
                }
            }, 0)
        }
        ...
        return {
            ...
            buildGroup: function A(e) {
                ...
                for (var r in e) {
                    var a = e[r];
                    if (a.buttons) {
                        for (var o = "", i = "", s = 0, l = "left", c = Fe.TOOLBAR_VISIBLE_BUTTONS, d = 0; d < a.buttons.length; d++) {
                            var f = a.buttons[d],
                                p = Fe.COMMANDS[f];
            ...
            bindCommands: function C(t, e) {
                ...
                function a(e) {
                    (!e || e.type === g._mouseup && e.target !== h("html").get(0) || "keydown" === e.type && (g.keys.isCharacter(e.which) && !g.keys.ctrlKey(e) || e.which === Fe.KEYCODE.ESC)) && d(t)
                }
            ...
            refresh: function S(e) {
                var t, n = e.parents(".fr-popup, .fr-toolbar").data("instance") || g,
                    r = e.data("cmd");
                g.node.hasClass(e.get(0), "fr-dropdown") ? t = e.next() : (e.removeClass("fr-active"), e.attr("aria-pressed") && e.attr("aria-pressed", !1)), Fe.COMMANDS[r] && Fe.COMMANDS[r].refresh ? Fe.COMMANDS[r].refresh.apply(n, [e, t]) : g.refresh[r] && n.refresh[r](e, t)
            },
            bulkRefresh: n,
            exec: o,
            click: t,
        ...
        svg: '<svg class="fr-svg" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="[PATH]"/></svg>',
        empty: " "
    }, Fe.ICONS = {
        bold: {
            NAME: "bold",
    ...
    }, Fe.DefineIconTemplate = function(e, t) {
        Fe.ICON_TEMPLATES[e] = t
    }, Fe.DefineIcon = function(e, t) {
        Fe.ICONS[e] = t
    }, Object.assign(Fe.DEFAULTS, {
        iconsTemplate: "svg"
    }), Fe.MODULES.icon = function(a) {
        return {
            create: function o(n) {
                var e = null,
                    r = Fe.ICONS[n];
                if (void 0 !== r) {
                    var t = r.template || Fe.ICON_DEFAULT_TEMPLATE || a.opts.iconsTemplate;
                    t && t.apply && (t = t.apply(a)), r.FA5NAME || (r.FA5NAME = r.NAME), "svg" !== t || r.PATH || (r.PATH = Fe.SVG[r.SVG_KEY]), t && (t = Fe.ICON_TEMPLATES[t]) && (e = t.replace(/\[([a-zA-Z0-9]*)\]/g, function(e, t) {
            ...
            getTemplate: function r(e) {
                ...
                return void 0 !== t ? n = t.template || Fe.ICON_DEFAULT_TEMPLATE || a.opts.iconsTemplate : n
            }
        }
    }, Fe.SVG = {
                ...
                if (e = '<div class="fr-modal-head-line">'.concat(e, "</div>"), l.shared.$overlay || (l.shared.$overlay = i(l.doc.createElement("DIV")).addClass("fr-overlay"), i("body").first().append(l.shared.$overlay)), a = l.shared.$overlay, l.opts.theme && a.addClass("".concat(l.opts.theme, "-theme")), !c[n]) {
                    var r = function o(e, t) {
                        var n = '<div tabIndex="-1" class="fr-modal'.concat(l.opts.theme ? " ".concat(l.opts.theme, "-theme") : "", '"><div class="fr-modal-wrapper">'),
                            r = '<button title="'.concat(l.language.translate("Cancel"), '" class="fr-command fr-btn fr-modal-close"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" viewBox="0 0 24 24"><path d="').concat(Fe.SVG.close, '"/></svg></button>');
                    ...
                    c[n] = {
                        ...
                        var t = e.which;
                        return t === Fe.KEYCODE.ESC ? (s(n), l.accessibility.focusModalButton(r), !1) : !(!i(e.currentTarget).is("input[type=text], textarea") && t !== Fe.KEYCODE.ARROW_UP && t !== Fe.KEYCODE.ARROW_DOWN && !l.keys.isBrowserAction(e) && (e.preventDefault(), e.stopPropagation(), 1))
                    }, !0), s(n, !0)
                }
                return c[n]
            },
    ...
    }, Fe.MODULES.position = function(T) {
        var A = T.$;
        ...
        function a() {
            ...
            if (0 === e.top && 0 === e.left && 0 === e.width || 0 === e.height) {
                ...
                var r = n.offset(),
                    a = n.outerHeight();
                n.css("display", "none"), n.css("line-height", 0), (e = {}).left = r.left, e.width = 0, e.height = a, e.top = r.top - (T.helpers.isMobile() && !T.helpers.isIOS() || T.opts.iframe ? 0 : T.helpers.scrollTop()), e.right = 1, e.bottom = 1, e.ok = !0, t && T.selection.restore()
            }
            return e
        }
    ...
    }, Fe.TOOLBAR_BUTTONS_MD = null, (Fe.TOOLBAR_BUTTONS_SM = {}).moreText = Object.assign({}, Fe.TOOLBAR_BUTTONS.moreText, {
        buttonsVisible: 2
    }), Fe.TOOLBAR_BUTTONS_SM.moreParagraph = Object.assign({}, Fe.TOOLBAR_BUTTONS.moreParagraph, {
        buttonsVisible: 2
    }), Fe.TOOLBAR_BUTTONS_SM.moreRich = Object.assign({}, Fe.TOOLBAR_BUTTONS.moreRich, {
        buttonsVisible: 2
    }), Fe.TOOLBAR_BUTTONS_SM.moreMisc = Object.assign({}, Fe.TOOLBAR_BUTTONS.moreMisc, {
        buttonsVisible: 2
    }), (Fe.TOOLBAR_BUTTONS_XS = {}).moreText = Object.assign({}, Fe.TOOLBAR_BUTTONS.moreText, {
        buttonsVisible: 0
    }), Fe.TOOLBAR_BUTTONS_XS.moreParagraph = Object.assign({}, Fe.TOOLBAR_BUTTONS.moreParagraph, {
        buttonsVisible: 0
    }), Fe.TOOLBAR_BUTTONS_XS.moreRich = Object.assign({}, Fe.TOOLBAR_BUTTONS.moreRich, {
        buttonsVisible: 0
    }), Fe.TOOLBAR_BUTTONS_XS.moreMisc = Object.assign({}, Fe.TOOLBAR_BUTTONS.moreMisc, {
        buttonsVisible: 2
    }), Fe.POWERED_BY = '', Fe.MODULES.toolbar = function(m) {
        var v, b = m.$,
            t = [];
        ...
        function e(e) {
            ...
            } else "object" !== Be(e) || Array.isArray(e) || ((n = e).showMoreButtons = !0);
            return n
        }
        ...
        function n(e, t) {
            setTimeout(function() {
                if ((!e || e.which !== Fe.KEYCODE.ESC) && m.selection.inEditor() && m.core.hasFocus() && !m.popups.areVisible() && (m.opts.toolbarVisibleWithoutSelection || !m.selection.isCollapsed() && !m.keys.isIME() || t)) {
        ...
        function s() {
            m.events.on("window.mousedown", a), m.events.on("keydown", a), m.events.on("blur", a), m.events.$on(m.$tb, "transitionend", ".fr-more-toolbar", function() {
                ...
                e && e.which === Fe.KEYCODE.ESC && a()
            }), m.events.on("keydown", function(e) {
                if (e.which === Fe.KEYCODE.ALT) return e.stopPropagation(), !1
        ...
        return {
            _init: function p() {
                ...
                m.opts.toolbarInline || m.opts.toolbarBottom || (m.$second_tb = b(m.doc.createElement("div")).attr("class", "second-toolbar"), m.$box.append(m.$second_tb), (!1 !== m.ul || m.opts.attribution) && m.$second_tb.prepend(Fe.POWERED_BY)), m.opts.toolbarContainer ? (m.shared.$tb ? (m.$tb = m.shared.$tb, m.opts.toolbarInline && s()) : (m.shared.$tb = b(m.doc.createElement("DIV")), m.shared.$tb.addClass("fr-toolbar"), m.$tb = m.shared.$tb, b(m.opts.toolbarContainer).append(m.$tb), d(), m.$tb.data("instance", m)), m.opts.toolbarInline ? m.$box.addClass("fr-inline") : m.$box.addClass("fr-basic"), m.events.on("focus", function() {
    ...
    g.fn = g.prototype = {
        ...
        data: function(e, t) {
            if (void 0 !== t) {
                for (var n = 0; n < this.length; n++) "object" !== Be(this[n]["data-" + e] = t) && "function" != typeof t && this[n].setAttribute && this[n].setAttribute("data-" + e, t);
                return this
            }
        ...
        find: function(e) {
            ...
            var a = function a(e) {
                return "object" === ("undefined" == typeof HTMLElement ? "undefined" : Be(HTMLElement)) ? e instanceof HTMLElement : e && "object" === Be(e) && null !== e && 1 === e.nodeType && "string" == typeof e.nodeName
            };
            e = m(e);
    ...
    if (T.Bootstrap = function(e, t, n) {
        ...
        ], r.paragraphFormatSelection = !0, r.fontFamilySelection = !0, r.fontSizeSelection = !0, r.placeholderText = "", r.quickInsertEnabled = !1, r.charCounterCount = !1), this.opts = Object.assign({}, Object.assign({}, T.DEFAULTS, r, "object" === Be(t) && t));
        ...
        charCounterMax: -1,
        charCounterCount: !0
    }), Fe.PLUGINS.charCounter = function(n) {
        var r, t = n.$;
        ...
        function e(e) {
            ...
            var t = e.which;
            return !(!n.keys.ctrlKey(e) && n.keys.isCharacter(t) || t === Fe.KEYCODE.IME) || (e.preventDefault(), e.stopPropagation(), n.events.trigger("charCounter.exceeded"), !1)
        }
    ...
    }), Fe.PLUGINS.codeView = function(c) {
        var d, f, p = c.$;
        ...
        function g() {
            u() && (f && f.setSize(null, c.opts.height ? c.opts.height : "auto"), c.opts.heightMin || c.opts.height ? c.$box.find(".CodeMirror-scroll, .CodeMirror-gutters").css("min-height", c.opts.heightMin || c.opts.height) : c.$box.find(".CodeMirror-scroll, .CodeMirror-gutters").css("min-height", ""))
        }
        var m, v = !1;
                ...
                if (n || (n = function i(e) {
                    ...
                    return function o(h, g) {
                        m.events.on("popup.tab", function(e) {
                            ...
                            if (Fe.KEYCODE.TAB === n) {
                            ...
                            } else if (Fe.KEYCODE.ARROW_UP === n || Fe.KEYCODE.ARROW_DOWN === n || Fe.KEYCODE.ARROW_LEFT === n || Fe.KEYCODE.ARROW_RIGHT === n) {
                                if (t.is("span.fr-select-color")) {
                                    var o = t.parent().find("span.fr-select-color"),
                                        ...
                                        f = d * s + c,
                                        p = l * s;
                                    Fe.KEYCODE.ARROW_UP === n ? f = ((f - s) % p + p) % p : Fe.KEYCODE.ARROW_DOWN === n ? f = (f + s) % p : Fe.KEYCODE.ARROW_LEFT === n ? f = ((f - 1) % p + p) % p : Fe.KEYCODE.ARROW_RIGHT === n && (f = (f + 1) % p);
                                    var u = v(o.get(f));
                                    m.events.disableBlur(), u.focus(), r = !1
                                }
                            } else Fe.KEYCODE.ENTER === n && (m.button.exec(t), r = !1);
        ...
        dragInline: !0
    }), Fe.PLUGINS.draggable = function(d) {
        var f, p = d.$;
        ...
        function t(e) {
            e.originalEvent.dataTransfer.dropEffect = "move", d.opts.dragInline ? function n() {
                for (var e = null, t = 0; t < Fe.INSTANCES.length; t++)
                    if ((e = Fe.INSTANCES[t].$el.find(".fr-dragging")).length) return e.get(0)
                ...
                if (t && !d.node.isBlock(t) && (t = d.node.blockParent(t)), t && 0 <= ["TD", "TH", "TR", "THEAD", "TBODY"].indexOf(t.tagName) && (t = p(t).parents("table").get(0)), t && 0 <= ["LI"].indexOf(t.tagName) && (t = p(t).parents("UL, OL").get(0)), t && !p(t).hasClass("fr-drag-helper")) {
                    var i;
                    f || (Fe.$draggable_helper || (Fe.$draggable_helper = p(document.createElement("div")).attr("class", "fr-drag-helper")), f = Fe.$draggable_helper, d.events.on("shared.destroy", function() {
        ...
        function a(e) {
            var t, n;
            d.$el.attr("contenteditable", !0);
            for (var r = 0; r < Fe.INSTANCES.length; r++)
                if ((t = Fe.INSTANCES[r].$el.find(".fr-dragging")).length) {
                    n = Fe.INSTANCES[r];
                    break
                }
            if (t.length) {
                ...
                else d.$el.find(".fr-marker").replaceWith(Fe.MARKERS), d.selection.restore();
                if (n === d || d.undo.canDo() || d.undo.saveStep(), d.core.isEmpty()) d.$el.html(a);
                else {
                    var o = d.markers.insert();
                    0 === a.find(o).length ? p(o).replaceWith(a) : 0 === t.find(o).length && p(o).replaceWith(t), t.after(Fe.MARKERS), d.selection.restore()
                }
        ...
        return {
            _init: function i() {
                d.opts.enter === Fe.ENTER_BR && (d.opts.dragInline = !0), d.events.on("dragstart", e, !0), d.events.on("dragover", t, !0), d.events.on("dragenter", n, !0), d.events.on("document.dragend", r, !0), d.events.on("document.drop", r, !0), d.events.on("drop", a, !0), d.events.on("html.processGet", o)
            }
        }
    }, Object.assign(Fe.DEFAULTS, {
        editInPopup: !1
    }), Fe.MODULES.editInPopup = function(r) {
        function e() {
        ...
        emoticonsUseImage: !0
    }), Fe.PLUGINS.emoticons = function(m) {
        var v = m.$,
                ...
                return '\n        <div class="fr-icon-container fr-emoticon-container">\n            '.concat(function t(e) {
                    ...
                    return e.emoticons.forEach(function(e) {
                        var t = e.code.split("-").reduce(function(e, t) {
                                return e ? e + "&zwj;&#x" + t.toLowerCase() + ";" : "&#x" + t.toLowerCase() + ";"
                            }, ""),
                            n = {
                                image: e.code.toLowerCase(),
                ...
                n(), m.events.on("html.set", n), m.events.on("keydown", function(e) {
                    if (m.keys.isCharacter(e.which) && m.selection.inEditor()) {
                        var t = m.selection.ranges(0),
                            n = s();
                        m.node.hasClass(n, "fr-emoticon-img") && n && (0 === t.startOffset && m.selection.element() === n ? v(n).before(Fe.MARKERS + Fe.INVISIBLE_SPACE) : v(n).after(Fe.INVISIBLE_SPACE + Fe.MARKERS), m.selection.restore())
                    }
                    ...
                    if (!(e.which >= Fe.KEYCODE.ARROW_LEFT && e.which <= Fe.KEYCODE.ARROW_DOWN)) {
                        var r = s();
                        m.node.hasClass(r, "fr-emoticon-img") && (v(r).append(Fe.MARKERS), m.selection.restore())
                    }
                })
            },
                ...
                if (e || (e = function o() {
                    ...
                    return function n(g) {
                        m.events.on("popup.tab", function(e) {
                            ...
                            if (Fe.KEYCODE.TAB == o) {
                            ...
                            } else if (Fe.KEYCODE.ARROW_UP == o || Fe.KEYCODE.ARROW_DOWN == o || Fe.KEYCODE.ARROW_LEFT == o || Fe.KEYCODE.ARROW_RIGHT == o) {
                                if (t.is("span.fr-emoticon")) {
                                    ...
                                    var c = m.opts.emoticonsStep,
                                        ...
                                        u = p * c + f,
                                        h = d * c;
                                    Fe.KEYCODE.ARROW_UP == o ? u = ((u - c) % h + h) % h : Fe.KEYCODE.ARROW_DOWN == o ? u = (u + c) % h : Fe.KEYCODE.ARROW_LEFT == o ? u = ((u - 1) % h + h) % h : Fe.KEYCODE.ARROW_RIGHT == o && (u = (u + 1) % h), a = v(l.get(u)), m.events.disableBlur(), a.focus(), n = !1
                                }
                            } else Fe.KEYCODE.ENTER == o && (t.is("a") ? t[0].click() : m.button.exec(t), n = !1);
    ...
    }), Fe.PLUGINS.entities = function(a) {
        var o, i, s = a.$;
            ...
            if (t && t.files && t.files.length) {
                ...
                if (n && "undefined" != typeof n.type) {
                    if (n.type.indexOf("image") < 0) {
                        ...
                        d.markers.remove(), d.markers.insertAtPoint(e.originalEvent), d.$el.find(".fr-marker").replaceWith(Fe.MARKERS), d.popups.hideAll();
            ...
            _init: function L() {
                ! function e() {
                    d.events.on("drop", y), d.events.$on(d.$win, "keydown", function(e) {
                        ...
                        n && t === Fe.KEYCODE.ESC && n.trigger("abortUpload")
    ...
    }), Fe.PLUGINS.fontFamily = function(a) {
        var o = a.$;
        ...
        fontSizeUnit: "px"
    }), Fe.PLUGINS.fontSize = function(r) {
        var a = r.$;
        return {
            apply: function t(e) {
    ...
    }), Fe.PLUGINS.fullscreen = function(n) {
        var t, r, a, o, i = n.$;
        ...
        NAME: "question",
        SVG_KEY: "help"
    }), Fe.RegisterShortcut(Fe.KEYCODE.SLASH, "help", null, "/"), Fe.RegisterCommand("help", {
        title: "Help",
        icon: "help",
        undo: !1,
        focus: !1,
        ...
        function A(e) {
            ...
            var t = e.hasClass("fr-dib") ? "block" : e.hasClass("fr-dii") ? "inline" : null,
                n = e.hasClass("fr-fil") ? "left" : e.hasClass("fr-fir") ? "right" : he(e);
            ue(e, t, n), e.removeClass("fr-dib fr-dii fr-fir fr-fil")
        }

        function C() {
            for (var e, t = "IMG" == f.el.tagName ? [f.el] : f.el.querySelectorAll("img"), n = 0; n < t.length; n++) {
                var r = u(t[n]);
                !f.opts.htmlUntouched && f.opts.useClasses ? ((f.opts.imageDefaultAlign || f.opts.imageDefaultDisplay) && (0 < (e = r).parents(".fr-img-caption").length && (e = e.parents(".fr-img-caption").first()), e.hasClass("fr-dii") || e.hasClass("fr-dib") || (e.addClass("fr-fi" + he(e)[0]), e.addClass("fr-di" + ge(e)[0]), e.css("margin", ""), e.css("float", ""), e.css("display", ""), e.css("z-index", ""), e.css("position", ""), e.css("overflow", ""), e.css("vertical-align", ""))), f.opts.imageTextNear || (0 < r.parents(".fr-img-caption").length ? r.parents(".fr-img-caption").first().removeClass("fr-dii").addClass("fr-dib") : r.removeClass("fr-dii").addClass("fr-dib"))) : f.opts.htmlUntouched || f.opts.useClasses || (f.opts.imageDefaultAlign || f.opts.imageDefaultDisplay) && A(r), f.opts.iframe && r.on("load", f.size.syncIframe)
            }
        }
        ...
        function y() {
            if (l || function i() {
                ...
                f.events.on("shared.destroy", function() {
                    ...
                    p && !p.hasClass("fr-uploading") ? ce(!0) : p && (y(), me(), I(!1))
                });
                if (f.opts.imageResize) {
                    ...
                    f.events.on("keydown", function(e) {
                        if (p) {
                            var t = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey,
                                n = e.which;
                            (n !== a || 200 < e.timeStamp - o) && (r = 1), (n == Fe.KEYCODE.EQUALS || f.browser.mozilla && n == Fe.KEYCODE.FF_EQUALS) && t && !e.altKey ? r = J.call(this, e, 1, 1, r) : (n == Fe.KEYCODE.HYPHEN || f.browser.mozilla && n == Fe.KEYCODE.FF_HYPHEN) && t && !e.altKey ? r = J.call(this, e, 2, -1, r) : f.keys.ctrlKey(e) || n != Fe.KEYCODE.ENTER || (p.before("<br>"), D(p)), a = n, o = e.timeStamp
                        }
        ...
        function w(e) {
            ...
            L(o), d.show(), f.popups.hideAll(), pe()
        }
        ...
        function _(e) {
            ...
            if (c && p) {
                ...
                if ((c.hasClass("fr-hnw") || c.hasClass("fr-hsw")) && (r = 0 - r), f.opts.imageResizeWithPercent) {
                    ...
                    a = ((a + r) / u(o).outerWidth() * 100).toFixed(2), f.opts.imageRoundPercent && (a = Math.round(a)), L(a + "%"), (t = Te() ? (f.helpers.getPX(p.parents(".fr-img-caption").css("width")) / u(o).outerWidth() * 100).toFixed(2) : (f.helpers.getPX(p.css("width")) / u(o).outerWidth() * 100).toFixed(2)) === a || f.opts.imageRoundPercent || L(t + "%"), p.css("height", "").removeAttr("height")
                } else a + r >= f.opts.imageMinWidth && (L(a + r), t = Te() ? f.helpers.getPX(p.parents(".fr-img-caption").css("width")) : f.helpers.getPX(p.css("width"))), t !== a + r && L(t), ((p.attr("style") || "").match(/(^height:)|(; *height:)/) || p.attr("height")) && (p.css("height", c.data("start-height") * p.width() / c.data("start-width")), p.removeAttr("height"));
                y(), f.events.trigger("image.resize", [be()])
            }
        }
        ...
        function O(e) {
            ...
            if (c && p) {
                ...
                c = null, d.hide(), y(), o(), f.undo.saveStep(), f.events.trigger("image.resizeEnd", [be()])
            }
        }
        ...
        function N(e, t, n) {
            f.edit.on(), p && p.addClass("fr-error"),
                ...
                }(f.language.translate("Something went wrong. Please try again.")), !p && n && ee(n), f.events.trigger("image.error", [{
                code: e,
                message: a[e]
            }, t, n])
        }
        ...
        function I(e) {
            ...
            if (t || (t = G()), t.find(".fr-layer.fr-active").removeClass("fr-active").addClass("fr-pactive"), t.find(".fr-image-progress-bar-layer").addClass("fr-active"), t.find(".fr-buttons").hide(), p) {
                var n = Ee();
        ...
        function k(e) {
            ...
            if (t && (t.find(".fr-layer.fr-pactive").addClass("fr-active").removeClass("fr-pactive"), t.find(".fr-image-progress-bar-layer").removeClass("fr-active"), t.find(".fr-buttons").show(), e || f.$el.find("img.fr-error").length)) {
                if (f.events.focus(), f.$el.find("img.fr-error").length && (f.$el.find("img.fr-error").remove(), f.undo.saveStep(), f.undo.run(), f.undo.dropRedo()), !f.$wp && p) {
                    var n = p;
                    ce(!0), f.selection.setAfter(n.get(0)), f.selection.restore()
                }
        ...
        function B() {
            var e = u(this);
            f.popups.hide("image.insert"), e.removeClass("fr-uploading"), e.next().is("br") && e.next().remove(), D(e), f.events.trigger("image.loaded", [e])
        }

        function F(i, e, s, l, c) {
            ...
            t.onload = function() {
                ...
                if (l) {
                    ...
                    e.on("load", B), e.attr("src", i), f.edit.on(), S(!1), f.undo.saveStep(), f.events.disableBlur(), f.$el.blur(), f.events.trigger(n ? "image.replaced" : "image.inserted", [e, c])
                } else e = K(i, s, B), S(!1), f.undo.saveStep(), f.events.disableBlur(), f.$el.blur(), f.events.trigger("image.inserted", [e, c])
            }, t.onerror = function() {
                N(r)
        ...
        function K(e, t, n) {
            ...
            o && "auto" != o && (o = f.opts.imageResizeWithPercent ? "100%" : o + "px"), a.attr("style", o ? "width: " + o + ";" : ""), ue(a, f.opts.imageDefaultDisplay, f.opts.imageDefaultAlign), a.on("load", n), a.on("error", n), f.edit.on(), f.events.focus(!0), f.selection.restore(), f.undo.saveStep(), f.opts.imageSplitHTML ? f.markers.split() : f.markers.insert(), f.html.wrap();
                ...
                if (f.drag_support.formdata && (n = f.drag_support.formdata ? new FormData : null), n) {
                    ...
                    f.opts.imageUploadToS3 && (o = f.opts.imageUploadToS3.uploadURL ? f.opts.imageUploadToS3.uploadURL : "https://" + f.opts.imageUploadToS3.region + ".amazonaws.com/" + f.opts.imageUploadToS3.bucket),
                        function l(t, n, e, a) {
                            function o() {
                                var e = u(this);
                                e.off("load"), e.addClass("fr-uploading"), e.next().is("br") && e.next().remove(), f.placeholder.refresh(), D(e), y(), I(), f.edit.off(), t.onload = function() {
                                    $.call(t, e)
                                }, t.onerror = P, t.upload.onprogress = H, t.onabort = U, u(e.off("abortUpload")).on("abortUpload", function() {
                                    4 != t.readyState && (t.abort(), a ? (a.attr("src", a.data("fr-old-src")), a.removeClass("fr-uploading")) : e.remove(), ce(!0))
                                }), t.send(n)
                            }
                            var i = new FileReader;
                            i.onload = function() {
                                ...
                                a ? (a.on("load", o), a.on("error", function() {
                                    o(), u(this).off("error")
                                }), f.edit.on(), f.undo.saveStep(), a.data("fr-old-src", a.attr("src")), a.attr("src", e)) : K(e, null, o)
                            }, i.readAsDataURL(e)
        ...
        function z(e) {
            ...
            if (t && t.files && t.files.length) {
                ...
                if (n && n.type && -1 !== n.type.indexOf("image") && 0 <= f.opts.imageAllowedTypes.indexOf(n.type.replace(/image\//g, ""))) {
                    ...
                    f.markers.remove(), f.markers.insertAtPoint(e.originalEvent), f.$el.find(".fr-marker").replaceWith(Fe.MARKERS), 0 === f.$el.find(".fr-marker").length && f.selection.setAtEnd(f.el), f.popups.hideAll();
                    var r = f.popups.get("image.insert");
                    r || (r = G()), f.popups.setContainer("image.insert", f.$sc);
                    ...
                    return f.popups.show("image.insert", a, o), I(), 0 <= f.opts.imageAllowedTypes.indexOf(n.type.replace(/image\//g, "")) ? (ce(!0), W(t.files)) : N(b), e.preventDefault(), e.stopPropagation(), !1
                }
            }
        }
        ...
        function G(e) {
            ...
            return 1 <= f.opts.imageInsertButtons.length && (n = f.popups.create("image.insert", c)), f.$wp && f.events.$on(f.$wp, "scroll", function() {
                p && f.popups.isVisible("image.insert") && me()
            }),
                function d(r) {
        ...
        function j() {
            ...
            e || (e = q()), k(), f.popups.refresh("image.alt"), f.popups.setContainer("image.alt", f.$sc);
            var t = Ee();
        ...
        function q(e) {
            ...
            return f.$wp && f.events.$on(f.$wp, "scroll.image-alt", function() {
                p && f.popups.isVisible("image.alt") && j()
            }), n
        }
        ...
        function Z() {
            var e = f.popups.get("image.size");
            e || (e = Q()), k(), f.popups.refresh("image.size"), f.popups.setContainer("image.size", f.$sc);
            var t = Ee();
            Te() && (t = t.find(".fr-img-wrap"));
            var n = t.offset().left + t.outerWidth() / 2,
                r = t.offset().top + t.outerHeight();
        ...
        function Q(e) {
            ...
            return f.$wp && f.events.$on(f.$wp, "scroll.image-size", function() {
                p && f.popups.isVisible("image.size") && Z()
            }), n
        }
        ...
        function ee(e) {
            (e = e || Ee()) && !1 !== f.events.trigger("image.beforeRemove", [e]) && (f.popups.hideAll(), ve(), ce(!0), f.undo.canDo() || f.undo.saveStep(), e.get(0) == f.el ? e.removeAttr("src") : (e.get(0).parentNode && "A" == e.get(0).parentNode.tagName ? (f.selection.setBefore(e.get(0).parentNode) || f.selection.setAfter(e.get(0).parentNode) || e.parent().after(Fe.MARKERS), u(e.get(0).parentNode).remove()) : (f.selection.setBefore(e.get(0)) || f.selection.setAfter(e.get(0)) || e.after(Fe.MARKERS), e.remove()), f.html.fillEmptyBlocks(), f.selection.restore()), f.undo.saveStep())
        }

        function te(e) {
            var t = e.which;
            if (p && (t == Fe.KEYCODE.BACKSPACE || t == Fe.KEYCODE.DELETE)) return e.preventDefault(), e.stopPropagation(), ee(), !1;
            if (p && t == Fe.KEYCODE.ESC) {
                var n = p;
                return ce(!0), f.selection.setAfter(n.get(0)), f.selection.restore(), e.preventDefault(), !1
            }
            if (!p || t != Fe.KEYCODE.ARROW_LEFT && t != Fe.KEYCODE.ARROW_RIGHT) return p && t === Fe.KEYCODE.TAB ? (e.preventDefault(), e.stopPropagation(), ce(!0), !1) : p && t != Fe.KEYCODE.F10 && !f.keys.isBrowserAction(e) ? (e.preventDefault(), e.stopPropagation(), !1) : void 0;
            var r = p.get(0);
            return ce(!0), t == Fe.KEYCODE.ARROW_LEFT ? f.selection.setBefore(r) : f.selection.setAfter(r), f.selection.restore(), e.preventDefault(), !1
        }
        ...
        function ne(e) {
            if (e && "IMG" == e.tagName) {
                ...
                for (var r = e.querySelectorAll("img.fr-uploading, img.fr-error, img.fr-draggable"), a = 0; a < r.length; a++) ne(r[a])
        }

        function re(e) {
            if (!1 === f.events.trigger("image.beforePasteUpload", [e])) return !1;
            p = u(e), y(), o(), me(), I(), p.on("load", function() {
                y(), I(), u(this).off("load")
            });
            for (var t = u(e).attr("src").split(","), n = atob(t[1]), r = [], a = 0; a < n.length; a++) r.push(n.charCodeAt(a));
            W([new Blob([new Uint8Array(r)], {
        ...
        function ae() {
            f.opts.imagePaste ? f.$el.find("img[data-fr-image-pasted]").each(function(e, r) {
                if (f.opts.imagePasteProcess) {
                    ...
                    t && "auto" != t && (t += f.opts.imageResizeWithPercent ? "%" : "px"), u(r).css("width", t).removeClass("fr-dii fr-dib fr-fir fr-fil"), ue(u(r), f.opts.imageDefaultDisplay, f.opts.imageDefaultAlign)
                }
                if (0 === r.src.indexOf("data:")) re(r);
        ...
        function oe(e) {
            ...
            r && ue(r, f.opts.imageDefaultDisplay, f.opts.imageDefaultAlign), f.events.trigger("paste.after")
        }
        ...
        function le(e) {
            ...
            for (var t = 0; t < Fe.INSTANCES.length; t++) Fe.INSTANCES[t] != f && Fe.INSTANCES[t].events.trigger("image.hideResizer");
            f.toolbar.disable(), e && (e.stopPropagation(), e.preventDefault()), f.helpers.isMobile() && (f.events.disableBlur(), f.$el.blur(), f.events.enableBlur()), f.opts.iframe && f.size.syncIframe(), p = u(this), ve(), y(), o(), f.browser.msie ? (f.popups.areVisible() && f.events.disableBlur(), f.win.getSelection && (f.win.getSelection().removeAllRanges(), f.win.getSelection().addRange(f.doc.createRange()))) : f.selection.clear(), f.helpers.isIOS() && (f.events.disableBlur(), f.$el.blur()), f.button.bulkRefresh(), f.events.trigger("video.hideResizer")
        }

        function ce(e) {
            p && (function t() {
                return de
            }() || !0 === e) && (f.toolbar.enable(), l.removeClass("fr-active"), f.popups.hide("image.edit"), p = null, pe(), c = null, d && d.hide())
        }
        ...
        var de = !(a[8] = "Image file is corrupted.");
        ...
        function me() {
            ...
            e || (e = G()), f.popups.isVisible("image.insert") || (k(), f.popups.refresh("image.insert"), f.popups.setContainer("image.insert", f.$sc));
            var t = Ee();
            Te() && (t = t.find(".fr-img-wrap"));
            var n = t.offset().left + t.outerWidth() / 2,
                r = t.offset().top + t.outerHeight();
        ...
        return {
            _init: function Ae() {
                ...
                (function e() {
                    f.events.$on(f.$el, f._mousedown, "IMG" == f.el.tagName ? null : 'img:not([contenteditable="false"])', function(e) {
                        ...
                        if (e.shiftKey && "" === f.selection.text().replace(/\n/g, "") && f.keys.isArrow(e.which)) {
                            ...
                            t && "IMG" == t.tagName ? D(u(t)) : n && "IMG" == n.tagName && D(u(n))
                        }
                    }, !0), f.events.on("drop", z), f.events.on("element.beforeDrop", V), f.events.on("mousedown window.mousedown", fe), f.events.on("window.touchmove", pe), f.events.on("mouseup window.mouseup", function() {
                        if (p) return ce(), !1;
                        pe()
                        ...
                        p && (ve(), f.selection.clear())
                    }), f.events.on("image.resizeEnd", function() {
                        f.win.getSelection && D(p)
                        ...
                        f.node.isElement(t) && (f.opts.enter === Fe.ENTER_BR ? e.after("<br>") : u(f.node.blockParent(e.get(0))).after("<" + f.html.defaultTag() + "><br></" + f.html.defaultTag() + ">"))
                    })
                })(), "IMG" == f.el.tagName && f.$el.addClass("fr-view"), f.events.$on(f.$el, f.helpers.isMobile() && !f.helpers.isWindowsPhone() ? "touchend" : "click", "IMG" == f.el.tagName ? null : 'img:not([contenteditable="false"])', le), f.helpers.isMobile() && (f.events.$on(f.$el, "touchstart", "IMG" == f.el.tagName ? null : 'img:not([contenteditable="false"])', function() {
                    n = !1
                }), f.events.$on(f.$el, "touchmove", function() {
                    n = !0
                })), f.$wp ? (f.events.on("window.keydown keydown", te, !0), f.events.on("keyup", function(e) {
                    if (p && e.which == Fe.KEYCODE.ENTER) return !1
                }, !0), f.events.$on(f.$el, "keydown", function() {
                    var e = f.selection.element();
                    e.nodeType === Node.TEXT_NODE && (e = e.parentNode), f.node.hasClass(e, "fr-inner") || (f.node.hasClass(e, "fr-img-caption") || (e = u(e).parents(".fr-img-caption").get(0)), f.node.hasClass(e, "fr-img-caption") && (u(e).after(u.FE.INVISIBLE_SPACE + u.FE.MARKERS), f.selection.restore()))
                })) : f.events.$on(f.$win, "keydown", te), f.events.on("toolbar.esc", function() {
                    if (p) {
                        if (f.$wp) f.events.disableBlur(), f.events.focus();
                        else {
                            var e = p;
                            ce(!0), f.selection.setAfter(e.get(0)), f.selection.restore()
                        }
                        return !1
                    }
                    ...
                    if (p && f.popups.isVisible("image.edit") && !f.popups.get("image.edit").find(":focus").length) {
                        var t = Ee();
                        Te() ? (t.before(Fe.START_MARKER), t.after(Fe.END_MARKER), f.selection.restore(), f.paste.saveCopiedText(t.get(0).outerHTML, t.text())) : (ve(), f.paste.saveCopiedText(p.get(0).outerHTML, p.attr("alt"))), "copy" == e.type ? setTimeout(function() {
                            D(p)
                        }) : (ce(!0), f.undo.saveStep(), setTimeout(function() {
                            f.undo.saveStep()
                        }, 0))
                    }
                    ...
                    var t = e.which;
                    t == Fe.KEYCODE.C && f.keys.ctrlKey(e) ? f.events.trigger("window.copy") : t == Fe.KEYCODE.X && f.keys.ctrlKey(e) && f.events.trigger("window.cut")
                }), f.events.$on(u(f.o_win), "keydown", function(e) {
                    var t = e.which;
                    if (p && t == Fe.KEYCODE.BACKSPACE) return e.preventDefault(), !1
                }), f.events.$on(f.$win, "keydown", function(e) {
                    var t = e.which;
                    p && p.hasClass("fr-uploading") && t == Fe.KEYCODE.ESC && p.trigger("abortUpload")
                }), f.events.on("destroy", function() {
                    p && p.hasClass("fr-uploading") && p.trigger("abortUpload")
                }), f.events.on("paste.before", ie), f.events.on("paste.beforeCleanup", se), f.events.on("paste.after", ae), f.events.on("html.set", C), f.events.on("html.inserted", C), C(), f.events.on("destroy", function() {
                    s = []
                }), f.events.on("html.processGet", ne), f.opts.imageOutputSize && f.events.on("html.beforeGet", function() {
                ...
                }), x(!0), G(!0), Q(!0), q(!0), f.events.on("node.remove", function(e) {
                    if ("IMG" == e.get(0).tagName) return ee(e), !1
                })
            },
            showInsertPopup: function Ce() {
                var e = f.$tb.find('.fr-command[data-cmd="insertImage"]'),
                    t = f.popups.get("image.insert");
                if (t || (t = G()), k(), !t.hasClass("fr-active"))
            ...
            showLayer: function Se(e) {
                ...
                if (p || f.opts.toolbarInline) {
                    if (p) {
                        var a = Ee();
                        Te() && (a = a.find(".fr-img-wrap")), n = a.offset().top + a.outerHeight(), t = a.offset().left
                    }
                } else {
            ...
            refreshUploadButton: function ye(e) {
                var t = f.popups.get("image.insert");
            ...
            align: function we(e) {
                var t = Ee();
                t.removeClass("fr-fir fr-fil"), !f.opts.htmlUntouched && f.opts.useClasses ? "left" == e ? t.addClass("fr-fil") : "right" == e && t.addClass("fr-fir") : ue(t, ge(), e), ve(), y(), o(), f.selection.clear()
            },
            refreshAlign: function _e(e) {
                p && e.find("> *").first().replaceWith(f.icon.create("image-align-" + he()))
            },
            refreshAlignOnShow: function Oe(e, t) {
                p && t.find('.fr-command[data-param1="' + he() + '"]').addClass("fr-active").attr("aria-selected", !0)
            },
            display: function Ne(e) {
                var t = Ee();
                t.removeClass("fr-dii fr-dib"), !f.opts.htmlUntouched && f.opts.useClasses ? "inline" == e ? t.addClass("fr-dii") : "block" == e && t.addClass("fr-dib") : ue(t, e, he()), ve(), y(), o(), f.selection.clear()
            },
            refreshDisplayOnShow: function xe(e, t) {
                p && t.find('.fr-command[data-param1="' + ge() + '"]').addClass("fr-active").attr("aria-selected", !0)
            },
            replace: me,
            back: function e() {
                p ? (f.events.disableBlur(), u(".fr-popup input:focus").blur(), D(p)) : (f.events.disableBlur(), f.selection.restore(), f.events.enableBlur(), f.popups.hide("image.insert"), f.toolbar.showInline())
            },
            get: be,
            getEl: Ee,
            insert: F,
            ...
            applyStyle: function Ie(e, t, n) {
                ...
                "object" == Be(t[e]) ? (r.removeAttr("style"), r.css(t[e].style)) : r.toggleClass(e), D(p)
            },
            showAltPopup: j,
            showSizePopup: Z,
            setAlt: function ke(e) {
                if (p) {
                    ...
                    p.attr("alt", e || t.find("input").val() || ""), t.find("input:focus").blur(), D(p)
                }
            },
            setSize: function Me(e, t) {
                if (p) {
                    ...
                    var r = /^[\d]+((px)|%)*$/g;
                    p.removeAttr("width").removeAttr("height"), e.match(r) ? p.css("width", e) : p.css("width", ""), t.match(r) ? p.css("height", t) : p.css("height", ""), Te() && (p.parents(".fr-img-caption").removeAttr("width").removeAttr("height"), e.match(r) ? p.parents(".fr-img-caption").css("width", e) : p.parents(".fr-img-caption").css("width", ""), t.match(r) ? p.parents(".fr-img-caption").css("height", t) : p.parents(".fr-img-caption").css("height", "")), n && n.find("input:focus").blur(), D(p)
                }
            },
            toggleCaption: function De() {
                var e;
                if (p && !Te()) {
                    var t, n;
                    ...
                    e.wrap("<span " + (f.browser.mozilla ? "" : 'contenteditable="false"') + 'class="fr-img-caption ' + p.attr("class") + '" style="' + (f.opts.useClasses ? "" : e.attr("style")) + '" draggable="false"></span>'), e.wrap('<span class="fr-img-wrap"></span>'), p.after('<span class="fr-inner"' + (f.browser.mozilla ? "" : ' contenteditable="true"') + ">" + Fe.START_MARKER + f.language.translate("Image Caption") + Fe.END_MARKER + "</span>"), p.removeAttr("class").removeAttr("style").removeAttr("width"), p.parents(".fr-img-caption").css("width", r), ce(!0), f.selection.restore()
                } else e = Ee(), p.insertAfter(e), p.attr("class", e.attr("class").replace("fr-img-caption", "")).attr("style", e.attr("style")), e.remove(), D(p)
            },
            hasCaption: Te,
            exitEdit: ce,
            edit: D
        ...
        NAME: "image",
        SVG_KEY: "insertImage"
    }), Fe.RegisterShortcut(Fe.KEYCODE.P, "insertImage", null, "P"), Fe.RegisterCommand("insertImage", {
        title: "Insert Image",
        undo: !1,
        focus: !0,
        refreshAfterCallback: !1,
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = Fe.COMMANDS.imageAlign.options;
        ...
        html: function() {
            ...
            for (var n in t)
                if (t.hasOwnProperty(n)) {
                    var r = t[n];
                    "object" == Be(r) && (r = r.title), e += '<li role="presentation"><a class="fr-command" tabIndex="-1" role="option" data-cmd="imageStyle" data-param1="' + n + '">' + this.language.translate(r) + "</a></li>"
                }
            return e += "</ul>"
        },
        callback: function(e, t) {
    ...
    }), Fe.PLUGINS.imageManager = function(s) {
        ...
        return a[e] = "Image cannot be loaded from the passed link.", a[E] = "Error during load images request.", a[T] = "Missing imageManagerLoadURL option.", a[A] = "Parsing load response failed.", a[C] = "Missing image thumb.", a[S] = "Missing image URL.", a[n] = "Error during delete image request.", a[r] = "Missing imageManagerDeleteURL option.", {
            ...
            show: function H() {
                if (!l) {
                    var e, t = '<button class="fr-command fr-btn fr-modal-more fr-not-available" id="fr-modal-more-'.concat(s.sid, '"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24""><path d="').concat(Fe.SVG.tags, '"/></svg></button><h4 data-text="true">').concat(s.language.translate("Manage Images"), '</h4></div>\n      <div class="fr-modal-tags" id="fr-modal-tags">');
    ...
    }, !Fe.PLUGINS.image) throw new Error("Image manager plugin requires image plugin.");
    return Fe.DEFAULTS.imageInsertButtons.push("imageManager"), Fe.RegisterCommand("imageManager", {
        title: "Browse",
        undo: !1,
        focus: !1,
        modal: !0,
    ...
    }), Fe.PLUGINS.inlineClass = function(n) {
        var r = n.$;
        return {
            apply: function t(e) {
    ...
    }), Fe.PLUGINS.inlineStyle = function(a) {
        return {
            apply: function o(e) {
                if ("" !== a.selection.text())
                    ...
                    } else a.html.insert('<span style="' + e + '">' + Fe.INVISIBLE_SPACE + Fe.MARKERS + "</span>")
            }
        }
    ...
    }), Fe.PLUGINS.lineBreaker = function(h) {
        var g, t, a, m = h.$;
        ...
        function u(e) {
            ...
            var n = g.data("tag1"),
                r = g.data("tag2"),
                a = h.html.defaultTag();
            null == n ? a && "TD" != r.parent().get(0).tagName && 0 === r.parents(a).length ? r.before("<" + a + ">" + Fe.MARKERS + "<br></" + a + ">") : r.before(Fe.MARKERS + "<br>") : a && "TD" != n.parent().get(0).tagName && 0 === n.parents(a).length ? n.after("<" + a + ">" + Fe.MARKERS + "<br></" + a + ">") : n.after(Fe.MARKERS + "<br>"), t.selection.restore()
        }
        return {
            _init: function v() {
                if (!h.$wp) return !1;
    ...
    }), Fe.PLUGINS.lineHeight = function(a) {
        var o = a.$;
        return {
            _init: function e() {},
            apply: function r(e) {
                        ...
                        if (e && !t) {
                            if (p.image) {
                                ...
                                if (1 == n.length && "IMG" == n[0].tagName) {
                                    ...
                                    return 0 === r.startOffset && 0 === r.endOffset ? u(e).before(Fe.MARKERS) : u(e).after(Fe.MARKERS), p.selection.restore(), !1
                                }
                            }
        ...
        function c(e, t, n) {
            ...
            if ("" === p.opts.linkAutoPrefix || new RegExp("^(" + Fe.LinkProtocols.join("|") + "):.", "i").test(e) || /^data:image.*/i.test(e) || /^(https?:|ftps?:|file:|)\/\//i.test(e) || /^([A-Za-z]:(\\){1,2}|[A-Za-z]:((\\){1,2}[^\\]+)+)(\\)?$/i.test(e) || ["/", "{", "[", "#", "(", "."].indexOf((e || "")[0]) < 0 && (e = p.opts.linkAutoPrefix + p.helpers.sanitizeURL(e)), e = p.helpers.sanitizeURL(e), p.opts.linkAlwaysBlank && (n.target = "_blank"), p.opts.linkAlwaysNoFollow && (n.rel = "nofollow"), p.helpers.isEmail(a) && (n.target = null, n.rel = null), "_blank" == n.target ? (p.opts.linkNoOpener && (n.rel ? n.rel += " noopener" : n.rel = "noopener"), p.opts.linkNoReferrer && (n.rel ? n.rel += " noreferrer" : n.rel = "noreferrer")) : null == n.target && (n.rel ? n.rel = n.rel.replace(/noopener/, "").replace(/noreferrer/, "") : n.rel = null), t = t || "", e === p.opts.linkAutoPrefix) return p.popups.get("link.insert").find('input[name="href"]').addClass("fr-error"), p.events.trigger("link.bad", [a]), !1;
            var o, i = h();
            if (i) {
                ...
                r || o.prepend(Fe.START_MARKER).append(Fe.END_MARKER), o.attr(n), r || p.selection.restore()
            } else {
                r ? (r.wrap('<a href="' + e + '"></a>'), p.image.hasCaption() && r.parent().append(r.parents(".fr-img-caption").find(".fr-inner"))) : (p.format.remove("a"), p.selection.isCollapsed() ? (t = 0 === t.length ? a : t, p.html.insert('<a href="' + e + '">' + Fe.START_MARKER + t.replace(/&/g, "&amp;").replace(/</, "&lt;", ">", "&gt;") + Fe.END_MARKER + "</a>"), p.selection.restore()) : 0 < t.length && t != p.selection.text().replace(/\n/g, "") ? (p.selection.remove(), p.html.insert('<a href="' + e + '">' + Fe.START_MARKER + t.replace(/&/g, "&amp;") + Fe.END_MARKER + "</a>"), p.selection.restore()) : (! function f() {
                    if (!p.selection.isCollapsed()) {
                        p.selection.save();
                ...
                1 == l.length && p.$wp && !r && (u(l[0]).prepend(Fe.START_MARKER).append(Fe.END_MARKER), p.selection.restore())
            }
            if (r) {
        ...
        return {
            ...
            usePredefined: function b(e) {
                ...
                for (n = 0; n < o.length; n++) r[(t = u(o[n])).attr("name")] ? (t.val(r[t.attr("name")]), t.toggleClass("fr-not-empty", !0)) : "text" != t.attr("name") && t.val("");
        ...
        NAME: "link",
        SVG_KEY: "insertLink"
    }), Fe.RegisterShortcut(Fe.KEYCODE.K, "insertLink", null, "K"), Fe.RegisterCommand("insertLink", {
        title: "Insert Link",
        undo: !1,
        focus: !0,
        refreshOnCallback: !1,
        ...
        function e(e) {
            if ("indent" == e || "outdent" == e) {
                for (var t = !1, n = f.selection.blocks(), r = [], a = 0; a < n.length; a++) "LI" == n[a].tagName ? (t = !0, r.push(n[a])) : "LI" == n[a].parentNode.tagName && (t = !0, r.push(n[a].parentNode));
                t && ("indent" == e ? s(r) : l(r))
            }
        }
        return {
    ...
    }), Fe.PLUGINS.paragraphFormat = function(p) {
        var u = p.$;
    ...
    }), Fe.PLUGINS.paragraphStyle = function(s) {
        var l = s.$;
        return {
            _init: function e() {},
    ...
    }), Fe.QUICK_INSERT_BUTTONS = {}, Fe.DefineIcon("quickInsert", {
        SVG_KEY: "add",
        template: "svg"
    }), Fe.RegisterQuickInsertButton = function(e, t) {
        Fe.QUICK_INSERT_BUTTONS[e] = Object.assign({
            undo: !0
        }, t)
        ...
        function a(e) {
            s || function t() {
                ...
                s = i.shared.$quick_insert, i.tooltip.bind(i.$box, ".fr-quick-insert > a.fr-floating-btn"), i.events.on("destroy", function() {
                    ...
                    Fe.QUICK_INSERT_BUTTONS[t].callback.apply(i, [e.currentTarget]), Fe.QUICK_INSERT_BUTTONS[t].undo && i.undo.saveStep(), i.events.trigger("quickInsert.commands.after", [t]), i.quickInsert.hide()
        ...
        function r() {
            if (i.core.hasFocus()) {
                var e = i.selection.element();
                if (i.opts.enter == Fe.ENTER_BR || i.node.isBlock(e) || (e = i.node.blockParent(e)), i.opts.enter == Fe.ENTER_BR && !i.node.isBlock(e)) {
                    var t = i.node.deepestParent(e);
                    t && (e = t)
                }
                var n = function n() {
                        return i.opts.enter != Fe.ENTER_BR && i.node.isEmpty(e) && 0 <= i.opts.quickInsertTags.indexOf(e.tagName.toLowerCase())
                    },
                    r = function r() {
                        return i.opts.enter == Fe.ENTER_BR && ("BR" == e.tagName && (!e.previousSibling || "BR" == e.previousSibling.tagName || i.node.isBlock(e.previousSibling)) || i.node.isEmpty(e) && (!e.previousSibling || "BR" == e.previousSibling.tagName || i.node.isBlock(e.previousSibling)) && (!e.nextSibling || "BR" == e.nextSibling.tagName || i.node.isBlock(e.nextSibling)))
                    };
            ...
            if (e && e.preventDefault(), s.hasClass("fr-on") && !s.hasClass("fr-hidden")) f();
                ...
                if (!i.shared.$qi_helper) {
                    for (var t = i.opts.quickInsertButtons, n = '<div class="fr-qi-helper">', r = 0, a = 0; a < t.length; a++) {
                        var o = Fe.QUICK_INSERT_BUTTONS[t[a]];
                        o && (!o.requiredPlugin || Fe.PLUGINS[o.requiredPlugin] && 0 <= i.opts.pluginsEnabled.indexOf(o.requiredPlugin)) && (n += '<a class="fr-btn fr-floating-btn" role="button" title="' + i.language.translate(o.title) + '" tabIndex="-1" data-cmd="' + t[a] + '" style="transition-delay: ' + .025 * r++ + 's;">' + i.icon.create(o.icon) + "</a>")
                    }
    ...
    }, Fe.RegisterShortcut(Fe.KEYCODE.SINGLE_QUOTE, "quote", "increase", "'"), Fe.RegisterShortcut(Fe.KEYCODE.SINGLE_QUOTE, "quote", "decrease", "'", !0), Fe.RegisterCommand("quote", {
        title: "Quote",
        type: "dropdown",
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
    ...
    }), Fe.PLUGINS.specialCharacters = function(g) {
        var m = g.$,
                            ...
                            if (Fe.KEYCODE.TAB == o) {
                                ...
                                if (t.is("span.fr-icon")) {
                                    ...
                                    var c = Math.floor(l.length / 11),
                                        ...
                                        p = 11 * f + d,
                                        u = 11 * c;
                                    Fe.KEYCODE.ARROW_UP == o ? p = ((p - 11) % u + u) % u : Fe.KEYCODE.ARROW_DOWN == o ? p = (p + 11) % u : Fe.KEYCODE.ARROW_LEFT == o ? p = ((p - 1) % u + u) % u : Fe.KEYCODE.ARROW_RIGHT == o && (p = (p + 1) % u), a = m(l.get(p)), g.events.disableBlur(), a.focus(), n = !1
                                }
                            } else Fe.KEYCODE.ENTER == o && (t.is("a") ? t[0].click() : g.button.exec(t), n = !1);
                            return !1 === n && (e.preventDefault(), e.stopPropagation()), n
                        }, !0)
                    }(t), t
                }()), !e.hasClass("fr-active")) {
                    ...
                    return C.events.$on(C.$wp, "scroll.table-colors", function() {
                        ...
                        function o(h) {
                            C.events.on("popup.tab", function(e) {
                                ...
                                } else Fe.KEYCODE.ENTER == n && (C.button.exec(t), r = !1);
                                return !1 === r && (e.preventDefault(), e.stopPropagation()), r
                            }, !0)
                        }(r), r
                    ...
                    rows_columns: function o() {
                        for (var e = '<div class="fr-table-size"><div class="fr-table-size-info">1 &times; 1</div><div class="fr-select-table-size">', t = 1; t <= C.opts.tableInsertMaxSize; t++) {
                            for (var n = 1; n <= C.opts.tableInsertMaxSize; n++) {
                                ...
                                var a = "fr-table-cell ";
                                1 == t && 1 == n && (a += " hover"), e += '<span class="fr-command ' + a + '" tabIndex="-1" data-cmd="tableInsert" data-row="' + t + '" data-col="' + n + '" data-param1="' + t + '" data-param2="' + n + '" style="display: ' + r + ';" role="button"><span></span><span class="fr-sr-only">' + t + " &times; " + n + "&nbsp;&nbsp;&nbsp;</span></span>"
                            }
            ...
            return C.events.$on(r, "mouseover", ".fr-table-size .fr-select-table-size .fr-table-cell", function(e) {
                ...
                function a(e) {
                    C.events.$on(e, "focus", "[tabIndex]", function(e) {
                        ...
                        var n, r = e.which;
                        if (Fe.KEYCODE.ARROW_UP == r || Fe.KEYCODE.ARROW_DOWN == r || Fe.KEYCODE.ARROW_LEFT == r || Fe.KEYCODE.ARROW_RIGHT == r) {
                            if (t.is("span.fr-table-cell")) {
                                var a = t.parent().find("span.fr-table-cell"),
                                    ...
                                    s = o % i,
                                    l = Math.floor(o / i);
                                Fe.KEYCODE.ARROW_UP == r ? l = Math.max(0, l - 1) : Fe.KEYCODE.ARROW_DOWN == r ? l = Math.min(C.opts.tableInsertMaxSize - 1, l + 1) : Fe.KEYCODE.ARROW_LEFT == r ? s = Math.max(0, s - 1) : Fe.KEYCODE.ARROW_RIGHT == r && (s = Math.min(C.opts.tableInsertMaxSize - 1, s + 1));
                                var c = l * i + s,
                                    d = R(a.get(c));
                                f(d), C.events.disableBlur(), d.focus(), n = !1
                            }
                        } else Fe.KEYCODE.ENTER == r && (C.button.exec(t), n = !1);
                        return !1 === n && (e.preventDefault(), e.stopPropagation()), n
                    }, !0)
                }(r), r
        }
        ...
        function k(e) {
            var t = null,
                n = R(e.target);
            return "TD" == e.target.tagName || "TH" == e.target.tagName ? t = e.target : 0 < n.closest("td").length ? t = n.closest("td").get(0) : 0 < n.closest("th").length && (t = n.closest("th").get(0)), -1 === C.$el.html.toString().search(t) ? null : t
        }
        ...
        function n(e) {
            ...
            if (a || C.$tb.is(e.target) || C.$tb.is(R(e.target).closest(".fr-toolbar")) || (0 < Q().length && C.toolbar.enable(), A()), !(1 != e.which || 1 == e.which && C.helpers.isMac() && e.ctrlKey)) {
                if (o = !1, a) a = !1, k(e) || 1 != Q().length ? 0 < Q().length && (C.selection.isCollapsed() ? u() : A()) : A();
                if (y) {
                ...
                if (0 === Q().length) {
                    ...
                    if (t && ("HTML" == t.tagName || "BODY" == t.tagName || C.node.isElement(t)))
                        for (n = 1; n <= C.opts.tableInsertHelperOffset; n++) {
                            ...
                            if (r && ("TH" == r.tagName || "TD" == r.tagName || "TABLE" == r.tagName) && (R(r).parents(".fr-wrapper").length || C.opts.iframe)) return U(e, R(r).closest("table")), !0;
                            if (a = C.doc.elementFromPoint(e.pageX - C.win.pageXOffset + n, e.pageY - C.win.pageYOffset), R(a).hasClass("fr-tooltip")) return !0;
                            if (a && ("TH" == a.tagName || "TD" == a.tagName || "TABLE" == a.tagName) && (R(a).parents(".fr-wrapper").length || C.opts.iframe)) return W(e, R(a).closest("table")), !0
                        }
        ...
        function q(e) {
            C.node.isEmpty(e.get(0)) ? e.prepend(Fe.MARKERS) : e.prepend(Fe.START_MARKER).append(Fe.END_MARKER)
        }
        ...
        return {
                    ...
                    y = a = o = !1, C.events.$on(C.$el, "mousedown", e), C.popups.onShow("image.edit", function() {
                        ...
                        e.shiftKey ? !1 === function i(e) {
                            ...
                            if (null != t && 0 < t.length) {
                                ...
                                if (Fe.KEYCODE.ARROW_RIGHT == a) {
                                    if (o.col < r[0].length - 1) return I(n, r[o.row][o.col + 1]), !1
                                } else if (Fe.KEYCODE.ARROW_DOWN == a) {
                                    if (o.row < r.length - 1) return I(n, r[o.row + 1][o.col]), !1
                                } else if (Fe.KEYCODE.ARROW_LEFT == a) {
                                    if (0 < o.col) return I(n, r[o.row][o.col - 1]), !1
                                } else if (Fe.KEYCODE.ARROW_UP == a && 0 < o.row) return I(n, r[o.row - 1][o.col]), !1
                            }
                            ...
                            if (n.length && ("TD" == (n = n[0]).tagName || "TH" == n.tagName)) {
                                ...
                                if (r && "TABLE" == r.tagName && (Fe.KEYCODE.ARROW_LEFT == t || Fe.KEYCODE.ARROW_UP == t || Fe.KEYCODE.ARROW_RIGHT == t || Fe.KEYCODE.ARROW_DOWN == t) && (0 < Q().length && M(), C.browser.webkit && (Fe.KEYCODE.ARROW_UP == t || Fe.KEYCODE.ARROW_DOWN == t))) {
                                    ...
                                    var o = L(R(r)),
                                        i = w(n, o);
                                    return Fe.KEYCODE.ARROW_UP == t ? F(i, r, o) : Fe.KEYCODE.ARROW_DOWN == t && $(i, r, o), C.selection.restore(), !1
                                }
                            }
                        }(e)
                        ...
                        var t = Q();
                        if (0 < t.length) {
                            if (0 < t.length && C.keys.ctrlKey(e) && e.which == Fe.KEYCODE.A) return A(), C.popups.isVisible("table.edit") && C.popups.hide("table.edit"), t = [], !0;
                            if (e.which == Fe.KEYCODE.ESC && C.popups.isVisible("table.edit")) return A(), C.popups.hide("table.edit"), e.preventDefault(), e.stopPropagation(), e.stopImmediatePropagation(), !(t = []);
                            if (1 < t.length && (e.which == Fe.KEYCODE.BACKSPACE || e.which == Fe.KEYCODE.DELETE)) {
                                C.undo.saveStep();
                                for (var n = 0; n < t.length; n++) R(t[n]).html("<br>"), n == t.length - 1 && R(t[n]).prepend(Fe.MARKERS);
                                return C.selection.restore(), C.undo.saveStep(), !(t = [])
                            }
                            if (1 < t.length && e.which != Fe.KEYCODE.F10 && !C.keys.isBrowserAction(e)) return e.preventDefault(), !(t = [])
            ...
            insert: function te(e, t) {
                var n, r, a = "<table " + (C.opts.tableDefaultWidth ? 'style="width: ' + C.opts.tableDefaultWidth + ';" ' : "") + 'class="fr-inserted-table"><tbody>',
                    o = 100 / t;
                for (n = 0; n < e; n++) {
                    for (a += "<tr>", r = 0; r < t; r++) a += "<td" + (C.opts.tableDefaultWidth ? ' style="width: ' + o.toFixed(4) + '%;"' : "") + ">", 0 === n && 0 === r && (a += Fe.MARKERS), a += "<br></td>";
                    a += "</tr>"
                }
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = Fe.COMMANDS.tableRows.options;
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = Fe.COMMANDS.tableColumns.options;
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = Fe.COMMANDS.tableCells.options;
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = Fe.COMMANDS.tableCellVerticalAlign.options;
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = Fe.COMMANDS.tableCellHorizontalAlign.options;
        ...
        NAME: "eraser",
        SVG_KEY: "remove"
    }), Fe.URLRegEx = "(^| |\\u00A0)(" + Fe.LinkRegEx + "|([a-z0-9+-_.]{1,}@[a-z0-9+-_.]{1,}\\.[a-z0-9+-_]{1,}))$", Fe.PLUGINS.url = function(o) {
        var i = o.$,
            s = null;
        ...
        return {
            _init: function e() {
                o.events.on("keypress", function(e) {
                    ...
                    var t = e.which;
                    !o.selection.isCollapsed() || t != Fe.KEYCODE.ENTER && t != Fe.KEYCODE.SPACE || n()
        ...
        html: '<iframe width="640" height="360" src="{url}" frameborder="0" allowfullscreen></iframe>',
        provider: "vidyard"
    }], Fe.VIDEO_EMBED_REGEX = /^\W*((<iframe(.|\n)*>(\s|\n)*<\/iframe>)|(<embed(.|\n)*>))\W*$/i, Fe.PLUGINS.video = function(u) {
        var s, d, f, p, r, n, h = u.$,
            l = "https://i.froala.com/upload",
            g = 2,
            m = 3,
        ...
        function T(e) {
            ...
            var t = !1;
            p && (q(), t = !0), u.html.insert('<span contenteditable="false" draggable="true" class="fr-jiv fr-video">' + e + "</span>", !1, u.opts.videoSplitHTML), u.popups.hide("video.insert");
                ...
                if (u.shared.$video_resizer ? (f = u.shared.$video_resizer, s = u.shared.$vid_overlay, u.events.on("destroy", function() {
                    ...
                    u.events.on("keydown", function(e) {
                        if (p) {
                            var t = -1 != navigator.userAgent.indexOf("Mac OS X") ? e.metaKey : e.ctrlKey,
                                n = e.which;
                            (n !== a || 200 < e.timeStamp - o) && (r = 1), (n == Fe.KEYCODE.EQUALS || u.browser.mozilla && n == Fe.KEYCODE.FF_EQUALS) && t && !e.altKey ? r = B.call(this, e, 1, 1, r) : (n == Fe.KEYCODE.HYPHEN || u.browser.mozilla && n == Fe.KEYCODE.FF_HYPHEN) && t && !e.altKey && (r = B.call(this, e, 2, -1, r)), a = n, o = e.timeStamp
                        }
        ...
        function t(e) {
            ...
            for (var t = 0; t < Fe.INSTANCES.length; t++) Fe.INSTANCES[t] != u && Fe.INSTANCES[t].events.trigger("video.hideResizer");
        ...
        function U(e) {
            ...
            if (t && t.files && t.files.length) {
                ...
                if (n && n.type && -1 !== n.type.indexOf("video")) {
                    ...
                    u.markers.remove(), u.markers.insertAtPoint(e.originalEvent), u.$el.find(".fr-marker").replaceWith(Fe.MARKERS), u.popups.hideAll();
        ...
        function Q() {
            ...
            if (0 != e.length) {
                e.wrap(h(document.createElement("span")).attr("class", "fr-video").attr("contenteditable", "false")), u.$el.find("embed, iframe").filter(function() {
                    if (u.browser.safari && this.getAttribute("src") && this.setAttribute("src", this.src), 0 < h(this).parents("span.fr-video").length) return !1;
                    for (var e = h(this).attr("src"), t = 0; t < Fe.VIDEO_PROVIDERS.length; t++) {
                        var n = Fe.VIDEO_PROVIDERS[t];
        ...
        return a[1] = "Video cannot be loaded from the passed link.", a[g] = "No link in upload response.", a[m] = "Error during file upload.", a[v] = "Parsing response failed.", a[c] = "File is too large.", a[b] = "Video file type is invalid.", a[7] = "Files can be uploaded only to same domain in IE 8 and IE 9.", u.shared.vid_exit_flag = !1, {
            _init: function ee() {
                u.opts.videoResponsive && (u.opts.videoResize = !1),
                    ...
                    var t = e.which;
                    return !p || t != Fe.KEYCODE.BACKSPACE && t != Fe.KEYCODE.DELETE ? p && t == Fe.KEYCODE.ESC ? (P(!0), e.preventDefault(), !1) : p && t != Fe.KEYCODE.F10 && !u.keys.isBrowserAction(e) ? (e.preventDefault(), !1) : void 0 : (e.preventDefault(), q(), u.undo.saveStep(), !1)
            ...
            insertByURL: function ie(e) {
                ...
                if (/^http/.test(e) || (e = "https://" + e), u.helpers.isURL(e))
                    for (var n = 0; n < Fe.VIDEO_PROVIDERS.length; n++) {
                        var r = Fe.VIDEO_PROVIDERS[n];
            ...
            insertEmbed: function se(e) {
                void 0 === e && (e = u.popups.get("video.insert").find(".fr-video-embed-layer textarea").val() || ""), 0 !== e.length && Fe.VIDEO_EMBED_REGEX.test(e) ? T(e) : (L(u.language.translate("Something went wrong. Please try again.")), u.events.trigger("video.codeError", [e]))
            },
            insert: T,
            align: function le(e) {
        ...
        html: function() {
            var e = '<ul class="fr-dropdown-list" role="presentation">',
                t = Fe.COMMANDS.videoAlign.options;
    ...
    }), Fe.PLUGINS.wordPaste = function(A) {
        var s, a, u = A.$,
            l = "word_paste",
            h = {};
        ...
        function t(e) {
            ...
            e || (A.opts.wordAllowedStyleProps = []), 0 === a.indexOf("<colgroup>") && (a = "<table>" + a + "</table>"), a = function p(e, t) {
                ...
                g(a, function(e) {
                    if (e.nodeType === Node.TEXT_NODE && /\n|\u00a0|\r/.test(e.data)) {
                        if (!/\S| /.test(e.data) && !/[\u00a0]+/.test(e.data)) return e.data === Fe.UNICODE_NBSP ? (e.data = "\u200b", !0) : 1 === e.data.length && 10 === e.data.charCodeAt(0) ? (e.data = " ", !0) : (C(e), !1);
                ...
                g(a, function(e) {
                    ...
                    if (e.nodeType === Node.ELEMENT_NODE) {
                            ...
                            var t = e.parentNode,
                                ...
                                r = function v(e, t, n) {
                                    ...
                                    for (; e;) {
                                        ...
                                        if ((n = n || u) < u) d = v(e, t, u), p += d.el.outerHTML, e = d.currentNode;
                                        else {
                                            if (u < n) break;
                                            e.firstElementChild && e.firstElementChild.firstElementChild && e.firstElementChild.firstElementChild.firstChild && (r.lastIndex = 0, o = r.test(e.firstElementChild.firstElementChild.firstChild.data || "")), s && s.firstElementChild && s.firstElementChild.firstElementChild && s.firstElementChild.firstElementChild.firstChild && (r.lastIndex = 0, i = r.test(s.firstElementChild.firstElementChild.firstChild.data || "")), i === undefined || i === o ? (c = b(e, t), p += "<li>" + c + "</li>") : (d = v(e, t, u), p += d.el.outerHTML, e = d.currentNode);
                                            var h = e && e.nextElementSibling;
                                            h && (s = h.previousElementSibling), e && e.parentNode && e.parentNode.removeChild(e), e = h
                                        }
                                    }
                                    p += "</" + f + ">";
                                    var g = document.createElement("div");
                                    g.innerHTML = p;
                                    var m = g.firstElementChild;
                                    return {
                                        el: m,
                                        currentNode: e
                                    }
                        ...
                        return "FONT" === e.tagName && i["." + e.getAttribute("class")] && (e = E(e, "span")), T(e, i)
                    }
        ...
        function b(e, r) {
            ...
            g(o, function(e) {
                ...
                return e.nodeType === Node.ELEMENT_NODE && ("mso-list:Ignore" === e.getAttribute("style") && e.parentNode.removeChild(e), e.setAttribute("style", function a(e) {
                    ...
                    return ["line-height", "font-family", "font-size"].forEach(function(e) {
        ...
        function T(e, t) {
            ...
            if ("TD" !== n) {
                ...
                if (t && s) {
                    for (var l = (s = R(s)).split(" "), c = 0; c < l.length; c++) {
                        var d = [],
                            f = "." + l[c];
                        d.push(f), f = r + f, d.push(f);
                        for (var p = 0; p < d.length; p++) t[d[p]] && L(e, t[d[p]])
                    }
            ...
            if (-1 !== ["P", "H1", "H2", "H3", "H4", "H5", "H6", "PRE"].indexOf(n)) {
                ...
                if (u && (t && t[n.toLowerCase() + "." + u] && L(e, t[n.toLowerCase() + "." + u]), -1 !== u.toLowerCase().indexOf("mso"))) {
                    var h = R(u);
            ...
            if ("TR" === n && function T(e, t) {
                ...
                for (var n = e.firstElementChild, r = 0, a = !1, o = null; n;) {
                    n.firstElementChild && -1 !== n.firstElementChild.tagName.indexOf("W:") && (n.innerHTML = n.firstElementChild.innerHTML), (o = n.getAttribute("width")) || a || (a = !0), r += parseInt(o, 10), (!n.firstChild || n.firstChild && n.firstChild.data === Fe.UNICODE_NBSP) && (n.firstChild && C(n.firstChild), n.innerHTML = "<br>");
                    for (var i = n.firstElementChild, s = 1 === n.children.length; i;) "P" !== i.tagName || S(i) || s && y(i), i = i.nextElementSibling;
                    if (t) {
                        var l = n.getAttribute("class");
                        if (l) {
                            var c = (l = R(l)).match(/xl[0-9]+/gi);
                            if (c) {
                                var d = "." + c[0];
                                t[d] && L(n, t[d])
                            }
            ...
            if ("TD" !== n && "TH" !== n || e.innerHTML || (e.innerHTML = "<br>"), "TABLE" === n && (e.style.width = e.style.width || "100%"), e.getAttribute("lang") && e.removeAttribute("lang"), e.getAttribute("style") && -1 !== e.getAttribute("style").toLowerCase().indexOf("mso")) {
                var b = R(e.getAttribute("style"));
